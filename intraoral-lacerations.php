...
<head>
	...
	<meta name="description" content="<?= __t('Intra-oral lacerations form a small percentage of lacerations. Cosmocare provides treatments for intra oral lacerations to patients in Dubai. To book an appointment online: Cosmocare Medical Center Call now 043798747') ?>" />
	<meta name="keywords" content="<?= __t('intra oral laceration treatment, tmj specialist dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Intra Oral Laceration Treatments in Dubai | Specialist Intra Oral Laceration Treatment | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="intraoral-lacerations.php"><?= __t('Intraoral Lacerations') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Intra Oral Laceration Treatments in Dubai') ?></h1>
							<p><?= __t('Intra-oral lacerations form a small percentage of lacerations. However, in comparison to skin laceration repair, the repair of intra-oral lacerations has some significant differences.') ?></p>
							<p><?= __t('After ensuring that the patient does not have any serious airway damage, the surgeon will evaluate the concurrent oral injuries. The cause of intra oral lacerations is typically the impact of the teeth on oral mucosa because of accidents, car crashes, contact sports, personal violence, and industrial accidents.') ?> </p>
							<p><?= __t('In general, lacerations that do not open up usually heal properly without medical intervention. However, lacerations that are gaping require wound closure to minimize the chances of infection and complications due to bleeding. Cosmocare provides treatments for intra oral lacerations to patients in Dubai, UAE.') ?>
							</p>
							<div class="service-img">
								<img src="images/intraoral-lacerations-dubai.svg" width="100%" class="img-fluid" alt="Intra Oral Laceration Treatments in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare Oral + Facial Laceration would be happy to discuss the details of Intra Oral Laceration Treatments with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p></p>
								<p>
