...
<head>
	...
	<meta name="description" content="<?= __t('Meso Gold Treatment') ?> <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, <?= __t('Meso Gold Treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('Meso Gold Treatment Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="meso-gold.php"><?= __t('Meso Gold') ?></a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('MESO GOLD') ?></h1>
							<p><?= __t('Indulge in Luxurious Rejuvenation: Meso Gold, Chocolate Mask & Eye Care at Cosmocare Medical Center') ?>
							</p>
							<div class="service-img">
								<a href="meso-gold.php"><img src="images/mesoeyes.jpg"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Indulge in Luxurious Rejuvenation: Meso Gold, Chocolate Mask & Eye Care at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we\'ve curated a pampering and effective facial treatment experience designed to leave your skin feeling refreshed, revitalized, and undeniably radiant. Our Meso Gold facial, combined with a luxurious chocolate mask and targeted eye care, offers a multi-faceted approach to achieving a brighter, tighter, and more youthful complexion.') ?>
							</p>
							<h3><?= __t('Unveiling the Power of Meso Gold') ?></h3>
							<p><?= __t('Meso Gold utilizes innovative Dermapen technology to deliver a customized cocktail of rejuvenating ingredients directly into the deeper layers of your skin. This minimally invasive treatment offers several benefits:') ?>
							</p>
							<ul>
								<li><?= __t(' Enhanced Freshness: Meso Gold stimulates cell turnover, promoting the removal of dull surface skin and revealing a brighter, fresher complexion.') ?>
								</li>
								<li><?= __t(' Lightening and Tightening: The meso cocktail often contains ingredients like hyaluronic acid and vitamins, which can help improve skin hydration, elasticity, and overall tone, leading to a visibly tighter and more youthful appearance.') ?>
								</li>
								<li><?= __t(' Improved Dark Circles: Certain meso cocktails can target specific concerns like hyperpigmentation, potentially reducing the appearance of dark circles around the eyes.') ?>
								</li>
							</ul>
							<h3><?= __t('The Decadent Indulgence of Chocolate') ?></h3>
							<p><?= __t('Following the Meso Gold treatment, a luxurious chocolate mask is applied to further enhance the transformative experience:') ?>
							</p>
							<ul>
								<li><?= __t(' Antioxidant Powerhouse: Chocolate is rich in antioxidants, known to combat free radical damage and promote skin health.') ?>
								</li>
								<li><?= __t(' Hydration Boost: Chocolate masks often contain hydrating ingredients that leave your skin feeling plump, supple, and nourished.') ?>
								</li>
								<li><?= __t(' Soothing and Calming: The application of the mask provides a relaxing and spa-like experience, leaving you feeling pampered and rejuvenated.') ?>
								</li>
							</ul>
							<h3><?= __t('Targeted Eye Care for a Complete Transformation') ?></h3>
							<p><?= __t('MTo address the delicate under-eye area, our treatment incorporates specialized eye care:') ?>
							</p>
							<ul>
								<li><?= __t(' Targeted Ingredients: Eye creams or serums formulated for the sensitive under-eye area can help reduce puffiness, diminish dark circles, and provide essential hydration.') ?>
								</li>
								<li><?= __t(' Improved Appearance: By addressing specific concerns around the eyes, this treatment contributes to a brighter, more youthful overall look.') ?>
								</li>
							</ul>
							<h3><?= __t('Dermapen Technology: The Key to Enhanced Absorption') ?></h3>
							<p><?= __t('Dermapen technology plays a crucial role in this treatment:') ?></p>
							<ul>
								<li><?= __t(' Microneedling: The Dermapen creates tiny channels in the skin, enhancing the absorption of the beneficial ingredients delivered by the Meso Gold treatment and the eye care products.') ?>
								</li>
							</ul>
							<h3><?= __t('The Perfect combination with HydraFacial') ?></h3>
							<p><?= __t('For an even more comprehensive approach to achieving a radiant complexion, consider combining this treatment with a HydraFacial:') ?>
							</p>
							<ul>
								<li><?= __t(' Deep Cleansing and Exfoliation: HydraFacial gently removes dead skin cells and impurities, preparing the skin for optimal absorption of the Meso Gold cocktail and other treatment elements.') ?>
								</li>
								<li><?= __t(' Enhanced Results: The combination of these treatments can lead to even more dramatic improvements in skin texture, tone, and overall results.') ?>
								</li>
							</ul>
							<div class="service-img">
