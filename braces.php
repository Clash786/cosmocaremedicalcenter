...
<head>
	...
	<meta name="description" content="<?= __t('Up & Down dental braces') ?> <?php include 'price.php'; echo "$braces"; ?> <?= __t('in Dubai Cosmocare Medical Center. Cosmocare Medical Center is one of the most visited dental clinic in Dubai delivering best quality dental braces at lowest price') ?>" />
	...
	<title><?php include 'price.php'; echo "$braces"; ?> <?= __t('Up & Down Teeth Braces in Dubai Jumeirah Satwa, Hudaiba, Mankhool Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link"
												href="metal-braces.php"><?= __t('Metal Braces') ?></a></li>
										<li class="nav-item"><a class="nav-link"
												href="ceramic-braces.php"><?= __t('Ceramic Braces') ?></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
						...
						<div class="title-wrap">
							...
							<div class="service-img">
								<a href="tooth-colored-fillings.php">
									<img src="images/tooth-colored-fillings.svg" width="100%" class="img-fluid"
										alt="Tooth fillings in Dubai by Cosmocare Medical Center">
								</a>
							</div>
							<p></p>
							<p>
