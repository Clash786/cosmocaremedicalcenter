...
<head>
	...
	<meta name="description" content="<?= __t('We at Cosmocare Medical Center use IPL Intense Pulse Technology to provide treatment for, Age Spots, Rosacea, Acne, Sun spots, Acne Scars, Hair Removal, Skin Pigmentation, Thread veins. Our Certified and renowned dermatologist Dr Murtuza Bandukwala has used this technology to treat various patients and the results have been satisfactory.') ?>" />
	<meta name="keywords" content="<?= __t('IPL Intense Pulse Technology , ipl laser treatment dubai') ?>" />
	...
	<title><?= __t('IPL Intense Pulse Technology  in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="ipl.html"><?= __t('IPL ( Intense Pulse Light)') ?></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('IPL (Intense pulsed light) Therapy in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/ipl-dubai.png" class="img-fluid" alt="ipl (INTENSE PULSE  LIGHT ) THERAPY dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('The technology uses a high-powered, hand-held,  computer-controlled flashgun to deliver an intense, visible, broad-spectrum  pulse of light, generally in the visible spectral range of 400 to 1200&nbsp;nm.') ?> <br>
								<?= __t('IPL  light penetrates the skin in a range of wave lengths that targets red and brown  spots resulting in a beautiful even skin tone. IPL brightens the skin.  Depending on the severity of the symptoms results can be seen in 1-3  treatments.') ?></p>
							<p><?= __t('Our  Certified and renowned dermatologist Dr Murtuza Bandukwala has used this  technology to treat various patients and the results have been satisfactory.') ?><br>
								<?= __t('We at Cosmocare  Medical Center use IPL Intense Pulse Technology to provide treatment for:') ?></p>
							<ul>
								<li><?= __t('Age  Spots') ?></li>
								<li><?= __t('Rosacea') ?></li>
								<li><?= __t('Acne') ?></li>
								<li><?= __t('Sun  spots') ?></li>
								<li><?= __t('Acne Scars') ?></li>
								<li><?= __t('Hair  Removal') ?></li>
								<li><?= __t('Skin  Pigmentation') ?></li>
								<li><?= __t('Thread  veins') ?></li>
							</ul>
							<p><?= __t('IPL is commonly used on the face, neck, shoulders,  back and hands.') ?></p>
						</div>
					</div>
				</div>
			</div>
