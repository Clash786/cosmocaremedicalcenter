...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare Medical Center (sexual health clinic offer STI Hiv testing in Dubai. Having a test is simple and painless. If you have an STI? Our doctor will talk with you about the infection and if there is a need for further tests and the sort of treatments involved.') ?>" />
	<meta name="keywords" content="<?= __t('sti testing dubai, STD Testing dubai, sti screening dubai, pigmentation dubai, syphilis treatment,') ?>" />
	...
	<title><?= __t('249aed STD / HIV Testing and Treatment by Specialist Doctor in Dubai| by Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('STD / HIV Testing and Treatment in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/std-specialist-dubai.svg" width="100%" class="img-fluid" alt="STD / HIV Testing and Treatment in Dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Cosmocare Medical Center (sexual health clinic) offer STI Hiv testing in Dubai. Having a test is simple and painless. If you have an STI? Our doctor will talk with you about the infection and if there is a need for further tests and the sort of treatments involved.') ?></p>
							<h2><?= __t('Why get tested?') ?></h2>
							<p><?= __t('Many people who have an') ?><a href="http://dubaistd.com/" target="_blank"><?= __t('STI (sexually transmissible infection)') ?></a><?= __t('don’t have symptoms, so may not even know they have one. Testing and using condoms are the best ways to stay in total control of your sexual health. If left untreated some STIs can cause unpleasant symptoms and could lead to long-term problems such as infertility.') ?></p>
							<h2><?= __t('When should I get tested?') ?></h2>
							<p><?= __t('It’s a good idea to have regular sexual health check-ups once you start having sex, when you change sexual partners or start a new relationship. You and your partner should get tested before you stop using condoms. See your doctor if you have had unsafe sex or have symptoms such as pain, discharge or itching in your genital area.') ?></p>
							<h2><?= __t('Where can I get tested?') ?></h2>
							<p><?= __t('Your doctor, family planning clinic or sexual health clinic can offer STI testing. Having a test is simple and painless.') ?></p>
							<h2><?= __t('Is testing confidential?') ?></h2>
							<p><?= __t('Yes. Doctors are legally obliged to keep information that a patient gives them confidential, regardless of their age. However, if there are issues that raise concerns about patients under the age of 16 then the doctor may take steps to ensure their safety.') ?></p>
							<h2><?= __t('Will anyone be informed of my test results?') ?></h2>
							<p><?= __t('The results of') ?><a href="http://sticlinicdubai.com/" target="_blank"><?= __t('STI testing') ?></a><?= __t('are completely confidential. The results are stored in your medical files. Sexual health clinics normally keep separate records to the files kept by your doctor. All notifiable diseases (including chlamydia, gonorrhoea, syphilis, HIV) are recorded by relevant health departments for the purpose of keeping statistical records.') ?></p>
							<h2><?= __t('Are STI tests expensive?') ?></h2>
							<p><?= __t('The cost depends on the tests required. Just ask when you make your appointment. How will I know what test to have? There is no single test to detect all STIs. The doctor will ask you about any symptoms and discuss your sexual history. We use the information from your conversation to work out the tests you should have. STIs such as gonorrhoea and chlamydia can be detected soon after you have been infected, even if you show no obvious signs. However, some STIs (like HIV) won’t show a positive result as quickly and your doctor will advise you on when to be re-tested.') ?></p>
							<h2><?= __t('How are STIs tested?') ?></h2>
							<p><?= __t('As a general rule you will have either a urine test, a swab, a blood test or a simple physical examination. The type of test depends on which STI is being treated.') ?></p>
							<p></p>
						</div>
					</div>
				</div>
