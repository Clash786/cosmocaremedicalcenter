...
<head>
	...
	<meta name="description" content="<?= __t('Check STD test prices in Dubai at Cosmocare Medical Center. We offer affordable, same-day, and confidential STD testing services including HIV, Chlamydia, Gonorrhea, Syphilis, and more. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('STD test price Dubai, STD testing cost Dubai, affordable STD test Dubai, HIV test Dubai, Chlamydia test Dubai, Gonorrhea test Dubai, Syphilis test Dubai, sexual health clinic Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('STD Test Price in Dubai | Affordable STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive STD and STI Testing') ?> </li>
										<li><?= __t('Transparent and Affordable STD Test Pricing in Dubai') ?></li>
										<li><?= __t('Same-Day Test Results for Quick Diagnosis') ?></li>
										<li><?= __t('Confidential Consultations and Expert Guidance') ?></li>
										<li><?= __t('Follow-Up Care and Preventive Advice for Sexual Health') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist in Sexual Health & STD Testing') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist in Sexual Health and STD Testing') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He provides accurate, confidential, and same-day') ?> <strong><?= __t('STD testing services') ?></strong><?= __t(', helping patients understand their health status quickly and safely. With years of expertise, he ensures all tests, including HIV, Chlamydia, Gonorrhea, and Syphilis, are performed with precision and discretion.') ?></p>
						<p><?= __t('Dedicated to patient care and privacy,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('emphasizes the importance of transparent') ?> <strong><?= __t('STD test pricing') ?></strong> <?= __t('and timely results. His compassionate approach and commitment to excellence make him one of the most trusted experts in Dubai for') ?> <strong><?= __t('affordable and reliable STD testing') ?></strong><?= __t(', providing peace of mind and confidence to every patient.') ?></p>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked what makes dermatology so rewarding, Dr. Murtuza said, "My job is fulfilling because even a small improvement in a patient\'s skin can greatly boost their self-confidence and happiness. Helping people feel comfortable in their own skin is what truly motivates me every day."') ?></p>
							</div>
						</div>
