...
<head>
	...
	<title><?= __t('Genital Herpes Treatment by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu3">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="herpes-treatment.html"><?= __t('Herpes Treatment') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Genital Herpes Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/herpes.jpg" class="img-fluid" alt="genial herpes treatment">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Genital herpes is a common sexually transmitted disease (STD) that any sexually active person can get. Most people with the virus don’t have symptoms. Even without signs of the disease, herpes can still be spread to sex partners.') ?></p>
							<h3><?= __t('What is genital  herpes?') ?></h3>
							<p><?= __t('Genital herpes is an  STD caused by two types of viruses. The viruses are called herpes simplex type  1 (HSV1) and herpes simplex type 2 (HSV-2).') ?><br>
							<h3><?= __t('What is oral herpes?') ?></h3>
							<p>Oral herpes is usually caused by HSV-1 and can result in cold sores or fever blisters on or around the mouth. However, most people do not have any symptoms. Most people with oral herpes were infected during childhood or young adulthood from non-sexual contact with saliva.
							<h3><?= __t('Is there a link  between genital herpes and oral herpes?') ?></h3>
							<p><?= __t('Oral herpes caused  by HSV-1 can be spread from the mouth to the genitals through oral sex. This is  why some cases of genital herpes are caused by HSV-1.') ?></p>
							<h3><?= __t('How common is  genital herpes?') ?></h3>
							<p><?= __t('Genital herpes is  common in the Middle East. More than one out of every six people aged 14 to 49  years have genital herpes.') ?></p>
							<h3><?= __t('How is genital  herpes spread?') ?></h3>
							<p><?= __t('You can get genital  herpes by having vaginal, anal, or oral sex with someone who has the disease. If you do not have  herpes, you can get infected if you come into contact with the herpes virus in:') ?></p>
							<ul class="numbered-list-lg">
								<li><?= __t('A herpes sore;') ?></li>
								<li><?= __t('Saliva (if your  partner has an oral herpes infection) or genital secretions (if your partner  has a genital herpes infection);') ?></li>
								<li><?= __t('Skin in the oral  area if your partner has an oral herpes infection, or skin in the genital area  if your partner has a genital herpes infection.') ?></li>
							</ul>
							<p><?= __t('You can get herpes  from a sex partner who does not have a visible sore or who may not know he or  she is infected. It is also possible to get genital herpes if you receive oral sex  from a sex partner who has oral herpes. You will not get  herpes from toilet seats, bedding, or swimming pools, or from  touching objects around you such as  silverware, soap, or towels. If you have additional  questions about how herpes is spread, consider  discussing your concerns with our doctor at  Cosmocare medical center, Dubai.') ?></p>
							<h3><?= __t('I’m pregnant. How  could genital herpes affect my baby?') ?></h3>
							<p><?= __t('If you are pregnant  and have genital herpes, it is very important for you to go to  prenatal care visits. Tell your doctor if you have ever had  symptoms of, or have been diagnosed with, genital herpes. Also tell your doctor  if you have ever been exposed to genital herpes. There is some research  that suggests that genital herpes infection may lead to miscarriage, or could  make it more likely for you to deliver your baby too early. Herpes infection can  be passed from you to your unborn child before birth  but is more commonly passed to your infant during  delivery. This can lead to a potentially deadly  infection in your baby (called neonatal herpes). It  is important that you avoid getting herpes during  pregnancy. If you are pregnant and have genital  herpes, you may be offered anti-herpes medicine towards the end of your pregnancy. This medicine may reduce your risk of having signs or  symptoms of genital herpes at the time of delivery. At the  time of delivery, your doctor should carefully examine you  for herpes sores. If you have herpes symptoms at delivery, a ‘C-section’ is usually performed.') ?></p>
							<h3><?= __t('How do I know if I  have genital herpes?') ?></h3>
							<p><?= __t('Most people who have  genital herpes have no symptoms, or have very mild  symptoms. You may not notice mild symptoms or  you may mistake them for another skin  condition, such as a pimple or ingrown hair. Because of  this, most people who have herpes do not know it. Herpes sores usually appear as one or more blisters on or around the  genitals, rectum or mouth. The blisters break and leave painful  sores that may take a week or more to heal. These symptoms  are sometimes called “having an outbreak.” The  first time someone has an outbreak they may also have  flu-like symptoms such as fever, body aches, or  swollen glands. People who experience an  initial outbreak of herpes can have repeated outbreaks, especially  if they are infected with HSV-2. Repeat outbreaks  are usually shorter and less severe than the first  outbreak. Although the infection stays in the body for the  rest of your life, the number of outbreaks may decrease over  time. You should be examined  by your doctor if you notice any of these symptoms or if  your partner has an STD or symptoms of an STD. STD  symptoms can include an unusual sore, a smelly  genital discharge, burning when urinating, or (for women)  bleeding between periods.') ?></p>
							<h3><?= __t('How will my doctor  know if I have herpes?') ?></h3>
							<p><?= __t('Your doctor may diagnose genital herpes by simply looking at your  symptoms. Doctor can also take a swab sample from the sore(s) and PCR test for HSV. In certain situations,  a blood test may be used to look for herpes antibodies. Have an  honest and open talk with your health care provider  and ask whether you should be tested for herpes or  other STDs. A herpes blood test can help determine if you have herpes  infection. It cannot tell you who gave you the infection or how  long you have been infected.') ?></p>
							<h3><?= __t('Can herpes be cured?') ?></h3>
							<p><?= __t('There is no cure for  herpes. However, there are medicines that can prevent or shorten  outbreaks. If your outbreak is more frequent, then  one of these  anti-herpes medicines can be taken daily and makes it less likely that you will pass the infection on to your sex partner(s).') ?></p>
							<h3><?= __t('What happens if I  don’t get treated?') ?></h3>
							<p><?= __t('Genital herpes can  cause painful genital sores and can be severe in people with  suppressed immune systems. If you touch your sores or the fluids from the  sores, you may transfer herpes to another part of your body, such as your eyes.  Do not touch the sores or fluids to avoid  spreading herpes to another part of your body. If you do touch the  sores or fluids, immediately wash your hands thoroughly to help  avoid spreading your infection.') ?></p>
							<h3><?= __t('Can I still have sex  if I have herpes?') ?></h3>
							<p><?= __t('If you have herpes,  you should talk to your sex partner(s) and let him or her know that you do and  the risk involved. Using condoms may help lower this risk but it will not get  rid of the risk completely. Having sores or other symptoms of herpes can  increase your risk of spreading the disease. Even if you do not have any  symptoms, you can still infect your sex partners.') ?></p>
						</div>
					</div>
				</div>
			</div>
