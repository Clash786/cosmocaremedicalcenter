...
<head>
	...
	<meta name="description" content="<?= __t('Get safe and effective Skin Cancer & Moles Removal treatments at Cosmocare Medical Center Dubai. Expert dermatologists provide advanced care for all skin concerns. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Skin Cancer Removal Dubai, Mole Removal Dubai, Dermatologist Dubai, Cosmetic Skin Clinic Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Skin Cancer & Moles Removal in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Mole, Skin Lesion, and Skin Cancer Removal') ?></li>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Care Specialist Skin Cancer & Mole Removal') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('skin care specialist') ?></b> <?= __t('at Cosmocare Medical Center Dubai. With extensive experience in dermatology, he provides advanced solutions for a wide range of') ?> <b><?= __t('skin concerns') ?></b><?= __t(', including acne, pigmentation,') ?> <b><?= __t('mole and skin lesion removal') ?></b><?= __t(', anti-aging, and overall skin rejuvenation. Dr. Murtuza believes that every patient deserves a personalized approach to achieve healthy and radiant') ?> <b><?= __t('skin') ?></b>.</p>
						<p><?= __t('As part of the expert team at Cosmocare Medical Center, Dr. Murtuza Bandukwala focuses on identifying the root causes of') ?> <b><?= __t('skin problems') ?></b> <?= __t('and designing treatments that combine modern medical techniques with compassionate patient care. His dedication to continuous learning and adopting innovative dermatology methods ensures safe, effective, and long-lasting results for all patients seeking the best') ?> <b><?= __t('skin care') ?></b> <?= __t('in Dubai, including specialized treatments for') ?> <b><?= __t('mole and skin cancer removal') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Cancer & Mole Removal Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/skin-cancer-moles-removal.webp" class="img-fluid" alt="Expert Skin Cancer & Mole Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/skin-cancer-moles-removal2.jpg" class="img-fluid" alt="Expert Skin Cancer & Mole Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/skin-cancer-moles-removal1.jpg" class="img-fluid" alt="Expert Skin Cancer & Mole Removal Treatments in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with stubborn moles and skin lesions for years, but after visiting Dr. Murtuza Bandukwala at Cosmocare Medical Center for mole and skin cancer removal, I noticed a remarkable improvement in my skin within a few sessions. He truly understands how to treat skin concerns effectively and helped me regain my confidence with healthy, radiant skin."') ?></p>
							</div>
						</div>
