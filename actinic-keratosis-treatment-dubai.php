...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo $actinic_keratosis_treatment_dubai; ?> <?= __t('Expert Actinic Keratosis Treatment in Dubai by Dr. Murtaza Advanced care for sun-damaged skin, pre-cancerous lesions & pigmentation issues. For any queries, call ') ?><?php echo $contact; ?> <?= __t('(Satwa) / ') ?><?php echo $contactjumeirah; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo $email; ?> to BOOK an appointment." />
	<meta name="keywords" content="<?php include 'price.php'; __t('actinic keratosis treatment Dubai, sun spots removal Dubai, pre-cancerous skin lesions')?>' ,<?php echo $dubai_keywords; ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo $actinic_keratosis_treatment_dubai; ?> <?= __t('Actinic Keratosis Treatment in Dubai |') ?> <?php echo $company; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<div class="title-wrap">
								<!-- <h1><?php echo $actinic_keratosis_treatment_dubai; ?> <?= __t('Actinic Keratosis Treatment in Dubai') ?></h1> -->
								<h3><?= __t('Expert Actinic Keratosis Treatment in Dubai') ?></h3>
								<h1><?= __t('Protect Your Skin. Prevent Complications. Stay Healthy.') ?></h1>
								<p><?= __t('At') ?> <strong><?php echo $company; ?></strong>,<?= __t('our specialists provide advanced actinic keratosis treatments, combining cutting-edge therapies with personalized care. Dr. Murtaza ensures that sun-damaged areas, pre-cancerous lesions, and chronic skin spots are treated effectively to maintain healthy skin.') ?></p>
								<p><?= __t('Our approach targets both visible lesions and underlying sun-damaged cells, helping to prevent progression to more serious skin conditions.We use minimally invasive procedures to ensure safety, comfort, and fast recovery.') ?></p>
							</div>


							<div class="service-img">
								<a href="actinic-keratosis-treatment-dubai.php">
									<img src="images/actinic-keratosis-treatment.jpg"
										alt="<?= __t('Actinic Keratosis Treatment in Dubai by Cosmocare Medical Center') ?>"
							...
							<h1><?= __t('Expert Dermatologist for Actinic Keratosis in Dubai') ?></h1>
							<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong>,<?= __t('we provide advanced actinic keratosis treatments under the expert care of') ?> <strong><?= __t('Dr. Murtaza') ?></strong>, <?= __t('one of Dubai\'s trusted dermatologists.') ?>
								<br><?= __t('Whether you\'re dealing with sun-damaged areas, pre-cancerous lesions, or chronic skin spots, Dr. Murtaza and his team are dedicated to restoring your skin\'s health and preventing complications.') ?>
							</p>

							<p><strong><?= __t(' Why Choose Cosmocare for Actinic Keratosis Treatment?') ?></strong></p>
							<ul>
								<li><strong><?= __t(' Personalized Treatment Plans:') ?></strong> <?= __t('Each patient receives a customized plan for their specific skin condition and type.') ?></li>
								<li><strong><?= __t(' Advanced Dermatology Equipment:') ?></strong> <?= __t('We use minimally invasive, FDA-approved procedures for safe and effective results.') ?></li>
								<li><strong><?= __t(' Expert Care by Dr. Murtaza:') ?></strong> <?= __t('Extensive experience in treating actinic keratosis and sun-damaged skin.') ?></li>
								<li><strong><?= __t(' Trusted by Patients Across Dubai:') ?></strong> <?= __t('Conveniently located in Satwa and Jumeirah 2, providing high-quality dermatological care.') ?></li>
							</ul>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Actinic Keratosis Treatment in Dubai...'),
			'link' => 'actinic-keratosis-treatment-dubai.php',
			'date' => 'July 25, 2021'
		],
	];
