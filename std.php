...
// Fetch only pages marked as 'home'
$sql = "SELECT title, slug FROM std_keywords WHERE language = 'en' AND category = 'home' ORDER BY id ASC";
...
<head>
	...
	<meta name="description" content="<?= __t('STI testing (STD testing) refers to many different tests you get at Cosmocare Medical Center to find out if you have a sexually transmitted infection. At-home STI testing is also an option. Testing involves giving samples of blood, urine or other bodily fluids. It\'s quick, painless and an important way to take care of yourself.') ?>" />
	<meta name="keywords" content="<?= __t('std, sti testing, hiv test, dubai, cosmocare') ?>" />
	<meta name="author" content="Cosmocare Medical Center" />	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title><?= __t('STI testing (STD testing) at Cosmocare Medical Center | At-home STI testing in Dubai UAE') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('STD Testing (STI Testing) in Dubai') ?></h1>
							...
							<p>
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()) {
                                        // Ensure the href matches your .htaccess rewrite pattern
                                        echo '<a target="_blank" href="std/' . htmlspecialchars($row['slug']) . '.html">';
                                        echo  __t($row['title']); 
                                        echo '</a><br/>';
                                    }
                                } else {
                                    echo "<p>" . __t('No tests found in this category.') . "</p>";
                                }
                                ?>
							</p>
				  </div>
