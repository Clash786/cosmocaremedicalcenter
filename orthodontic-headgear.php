...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$headgear"; ?> <?= __t('Orthodontic Headgear Treatment in Dubai by Dr. AQR Expert in Orthodontic Headgear Treatment and orthodontics. If you have any further questions, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$dental_keywords"; ?>, <?= __t('Orthodontic Headgear') ?> " />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$headgear"; ?> <?= __t('Orthodontic Headgear Treatment Dubai|') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="orthodontic-headgear.php"><?= __t('Orthodontic Headgear') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							echo "$headgear"; ?> <?= __t('Orthodontic Headgear Treatment in Dubai') ?></h1>
							<h3><?= __t('Orthodontic Headgear Treatment in Dubai') ?></h3>
							<!-- <p><?= __t('At Cosmocare Medical Center, we provide an exceptional quality of Orthodontic headgear treatment in jumeirah Dubai. The dental center is managed by a team of qualified professionals with a wide range of experience in hospital management.') ?>						</p> -->
							<h1><?= __t('Early Jaw Correction for Lifelong Confidence') ?></h1>
							<p><?= __t('At Cosmocare Medical Center, we offer expert-led headgear treatments that guide your child\'s jaw into proper alignment during crucial growth phases. Whether it\'s correcting an overbite, underbite, or facial imbalance, our orthodontic headgear solutions are custom-designed to harness natural growth for long-term facial harmony and function.') ?>
							</p>
							<div class="service-img">
								<a href="orthodontic-headgear.php"><img src="images/orthodontic-headgear.png"
							...
							<br>
							<p><strong><?= __t('Book Your Child\'s Assessment Today') ?></strong></p>
							<p><?= __t('Catch jaw misalignments earlybefore they become bigger problems.') ?></p>
							<p><strong><?= __t(' What Is An Orthodontic Headgear?') ?></strong></p>
							<p><?= __t('Orthodontic headgear is a removable external appliance that gently applies pressure to influence the growth of the jaws and guide them into correct alignment.') ?>
							</p>
							<p><?= __t('It is most often used in children with:') ?></p>
							<ul>
								<li><?= __t('Class II malocclusions (overbite)') ?></li>
								<li> <?= __t('Class III malocclusions (underbite)') ?></li>
								<li><?= __t('Jaw imbalances or facial disproportions') ?> </li>
							</ul>
							<p><?= __t('Timing is keythese treatments are most effective during ages 812, when the bones are still growing.') ?>
							</p>
							<p><strong><?= __t('  Types of Headgear We Offer') ?></strong></p>
							<p><strong><?= __t('1.	Cervical Pull Headgear (For Overbite Correction)') ?></strong></p>
							<ul>
								<li><?= __t('Targets Class II malocclusions (forward upper jaw, short lower jaw)') ?>
								</li>
								<li><?= __t('Wraps around the neck to restrict upper jaw\'s forward growth') ?> </li>
								<li><?= __t('Allows the lower jaw to catch up, correcting overbites') ?></li>
							</ul>
							<p><strong><?= __t('2.	High Pull Headgear (For Vertical Growth Control)') ?></strong></p>
							<ul>
								<li><?= __t('Straps go over and behind the head') ?></li>
								<li><?= __t('Helps patients with excessive vertical upper jaw growth') ?></li>
								<li><?= __t('-	Maintains balanced vertical facial proportions') ?></li>
							</ul>
							<p><strong>
									<?= __t('3.	Reverse-Pull Headgear / Face Mask (For Underbite Correction)') ?></strong>
							</p>
							<ul>
								<li><?= __t('Designed for Class III malocclusions (deficient upper jaw, forward lower jaw)') ?>
								</li>
								<li><?= __t('Encourages forward and downward growth of the upper jaw') ?></li>
								<li><?= __t('Ideal for children with underdeveloped mid-face or crossbites') ?></li>
								<li><?= __t('Most effective before age 10, when jaw sutures are most responsive') ?>
								</li>
							</ul>
							<p><strong><?= __t('	Who Can Benefit from Headgear Treatment?') ?></strong></p>
							<ul>
								<li><?= __t('Children with severe overbites or underbites') ?></li>
								<li><?= __t('Kids showing asymmetrical facial growth') ?></li>
								<li><?= __t('Young patients who need growth modification to avoid future jaw surgerys') ?>
								</li>
								<li><?= __t('Individuals with deep bites, crossbites, or facial disproportions') ?></li>
							</ul>
							<p><strong><?= __t('	Benefits of Early Headgear Use') ?></strong></p>
							<p>
							<ul>
								<?= __t(' Guides Natural Jaw Growth - Correct issues at the root before they get complicated or require surgery.') ?>
								<br>
								<?= __t(' Improves Facial Symmetry - Achieve a balanced, proportional appearance early in life.') ?>
								<br>
								<?= __t(' Non-Invasive Orthopaedic Correction - Avoid surgery by leveraging growth potential during key developmental years.') ?>
								<br>
								<?= __t('Sets the Stage for Braces or Aligners Jaw-first correction makes later treatments simpler and more effective.') ?>
							</ul>
							</p>
							<p><strong><?= __t('	Why Dr. AQR @Cosmocare Medical Center Is the Right Choice For Headgear Treatment in Dubai') ?></strong>
							</p>
							<p>
							<ul>
								<?= __t(' Led by Dr. AQR, Specialist in Dentofacial Orthopedics Years of experience treating complex jaw issues in growing children.') ?>
								<br>
								<?= __t(' Personalized Growth-Guided Plans Each treatment is tailored to your child\'s age, anatomy, and growth potenti.') ?>
								<br>
								<?= __t(' Child-Centered, Parent-Focused Care We support and educate families every step of the way.') ?>
								<br>
							</ul>
							</p>
							<p><strong> <?= __t('When Should You Start?') ?></strong></p>
							<p><?= __t('The ideal window for orthodontic headgear treatment is between ages 812, when the jaws are actively growing. Delaying treatment could result in:') ?>
							</p>
							<ul>
								<li><?= __t('Permanent jaw discrepancies') ?></li>
								<li><?= __t('The need for jaw surgery in the future') ?></li>
								<li><?= __t('Reduced treatment effectiveness') ?></li>
							</ul>
							<p><strong> <?= __t(' Act EarlyBook a Growth Assessment Today') ?></strong></p>
							<p><strong> <?= __t('Ready to Guide Your Child\'s Smile to Harmony?') ?></strong></p>
							<p><?= __t('Let Cosmocare Medical Center help your child grow into a confident, healthy smilewithout invasive treatments.') ?>
							</p>
							<p>
							<ul>
								<?= __t(' Call Us Now') ?> <br>
								<?= __t(' Visit Our Dubai Clinic') ?><br>
								<?= __t(' Book a Free Consultation Online') ?><br>
								</p>
							</ul>
							<p>
