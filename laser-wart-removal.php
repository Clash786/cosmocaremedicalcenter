...
<head>
	...
	<meta name="description" content="<?= __t('Get safe and effective Laser Wart Removal treatment at Cosmocare Medical Center Dubai. Expert dermatologists ensure clear, healthy skin with advanced dermatology solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Laser Wart Removal Dubai, Wart treatment Dubai, Dermatologist Dubai, Skin care Dubai, Cosmetic Skin Clinic Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Laser Wart Removal Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Mole, Wart, and Skin Lesion Removal') ?></li>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-3">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Care Specialist Laser Warts Treatment') ?></h6>
							</div>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/laser-wart-removal-dubai.jpg" class="img-fluid" alt="Laser Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/laser-wart-removal-dubai1.jpg" class="img-fluid" alt="Laser Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/laser-wart-removal-dubai2.webp" class="img-fluid" alt="Laser Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with stubborn warts for years, but after visiting Dr. Murtuza Bandukwala at Cosmocare Medical Center for Laser Wart Removal, I started noticing visible improvements in just a few sessions. He truly understands how to treat skin conditions effectively and helped me regain my confidence."') ?></p>
							</div>
						</div>
