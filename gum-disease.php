...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare Medical Center is one of the few practices in the Dubai, UAE area that offers gum disease treatment. We offer a complete range of gum disease treatment for patients dealing with the various stages of gum disease.') ?>" />
	<meta name="keywords" content="<?= __t('gum disease dubai, gum disease treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Gum Disease Treatment in Dubai | Specialist Gum Disease Treatment | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link" href="braces.php"><?= __t('Braces') ?></a></li>
										<li class="nav-item"><a class="nav-link active" href="gum-disease.php"><?= __t('Gum Disease') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Gum Disease Treatment in Dubai') ?></h1>
							<p><?= __t('Cosmocare Medical Center is one of the few practices in the Dubai, UAE area that offers gum disease treatment. We offer a complete range of gum disease treatment for patients dealing with the various stages of gum disease. Our doctors work with each of our patients to create a comprehensive treatment plan based on their needs.') ?></p>
							<h2><?= __t('What causes gum disease?') ?></h2>
							<p><?= __t('Factors that contribute to periodontal disease include smoking or chewing tobacco, certain medications, defective fillings, crooked teeth, systemic disease, improper home care, and irregular dental cleanings.') ?> </p>
							<p><?= __t('Because gum disease is usually not painful, most patients may not   know they have it until it is too late. Warning signs of gum disease   include:') ?></p>
							<ul>
								<li><?= __t('Gums that bleed during tooth brushing and/or flossing') ?></li>
								<li><?= __t('Gums that have pulled away from the teeth') ?></li>
								<li><?= __t('Persistent bad breath or bad taste') ?></li>
								<li><?= __t('Permanent teeth that are loose or separating; any change in the way your teeth fit together when you bite') ?></li>
								<li><?= __t('Any change in the fit of partial dentures.') ?></li>
							</ul>
							<p></p>
							<div class="service-img">
								<img src="images/gum-disease-treatment.svg" width="100%" class="img-fluid" alt="gum disease treatment in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<p><?= __t('Our dentist in Dentist along with the hygienist examines your mouth for gum disease. Together they will recommend the appropriate treatment options.') ?>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about gum disease treatment with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p></p>
								<p>
								...
								<p>
									<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14436.135439411184!2d55.2781561!3d25.2357845!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x84e25795f8f7e3d9!2sCosmocare%20Dermatology%20PRP%20Therapy%20%26%20STD%20Clinic%20Dubai!5e0!3m2!1sen!2sae!4v1644492789987!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
								</p>
								<p>
							</div>
						</div>
