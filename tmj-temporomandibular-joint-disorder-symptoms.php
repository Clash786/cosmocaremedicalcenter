...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$tmj_temporomandibular_joint_disorder_symptoms"; ?> <?= __t('TMJ Temporomandibular Joint Disorder Symptoms | If you have any further questions, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$dental_keywords"; ?>, <?= __t('TMJ Temporomandibular Joint Disorder Symptoms') ?> " />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$tmj_temporomandibular_joint_disorder_symptoms"; ?> <?= __t('TMJ Temporomandibular Joint Disorder Symptoms |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="tmj-temporomandibular-joint-disorder-symptoms.php">
												<?= __t('TMJ Temporomandibular Joint Disorder Symptoms') ?> </a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							echo "$tmj_temporomandibular_joint_disorder_symptoms"; ?>
								<?= __t('TMJ Temporomandibular Joint Disorder Symptoms') ?> </h1><br>
							<h1> <?= __t('TMJ Temporomandibular Joint Disorder Symptoms') ?> </h1>
							<div class="service-img">
								<a href="tmj-temporomandibular-joint-disorder-symptoms.php"><img
										src="images/tmj-temporomandibular-joint-disorder-symptoms.png"
										alt="TMJ Temporomandibular Joint Disorder Symptoms in Dubai by Cosmocare Medical Center"
										width="100%" border="0" class="img-fluid" /></a>
							</div>
							<br>
							<h2><?= __t('TMJ Temporomandibular Joint Disorder') ?></h2>
							<p><?= __t('TMJ disorder (temporomandibular joint disorder) symptoms can vary depending on the severity and underlying cause, but common ones include:') ?>
							</p>
							<p><strong><?= __t('1. Jaw-related symptoms') ?></strong></p>
							<ul>
								<li><?= __t('Pain or tenderness in the jaw joint area') ?></li>
								<li><?= __t('Clicking, popping, or grinding noises during jaw movement') ?></li>
								<li><?= __t('Limited range of motion (difficulty opening the mouth fully)') ?></li>
								<li><?= __t('Jaw locking in an open or closed position') ?></li>
								<li><?= __t('Stiffness or fatigue in the jaw muscles, especially after chewing') ?></li>
							</ul>
							<p><strong><?= __t('2. Pain in surrounding areas') ?></strong></p>
							<ul>
								<li><?= __t('Pain radiating to the face, ear, temple, or neck') ?></li>
								<li><?= __t('Ear symptoms: earache, fullness, ringing (tinnitus) without actual ear disease') ?>
								</li>
								<li><?= __t('Headaches (especially in the temples or around the jaw)') ?></li>
							</ul>
							<p><strong><?= __t('3. Bite or movement changes') ?></strong></p>
							<ul>
								<li><?= __t('Sudden discomfort when biting or chewing') ?></li>
								<li><?= __t('Feeling that the upper and lower teeth don\'t fit together properly') ?>
								</li>
								<li><?= __t('Uneven bite sensation') ?></li>
							</ul>
							<p><strong><?= __t('4. Other associated symptoms') ?></strong></p>
							<ul>
								<li><?= __t('Facial swelling on one side (less common)') ?></li>
								<li><?= __t('Dizziness or balance issues (in some cases)') ?></li>
							</ul>
							<p>
