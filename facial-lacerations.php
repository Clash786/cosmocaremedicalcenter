...
<head>
	...
	<meta name="description" content="<?= __t('In the Dubai, approximately thousands of patients present annually to the emergency department for facial lacerations. Given the prevalence of facial lacerations, an understanding of proper laceration management is crucial as poor facial wound treatment can significantly impact an individual\'s quality of life. to book an appointment online: Cosmocare Medical Center Call now 043798747') ?>" />
	<meta name="keywords" content="<?= __t('facial laceration repair, tmj specialist dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Facial Laceration Repair in Dubai | Specialist Facial Laceration | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="facial-lacerations.php"><?= __t('Facial Lacerations') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Facial Laceration Repair Dubai') ?></h1>
							<p><?= __t('In the Dubai, approximately thousands of patients present annually to the emergency department for facial lacerations. Given the prevalence of facial lacerations, an understanding of proper laceration management is crucial as poor facial wound treatment can significantly impact an individual\'s quality of life') ?></p>
							<h4><?= __t('Continuing Education Activity') ?></h4>
							<p><?= __t('Facial lacerations encompass a broad range of injuries and highlight complex facial anatomy. Appropriate management of facial lacerations requires knowledge of facial anatomy, current suture techniques, and guidelines for consulting other specialties. This activity reviews facial laceration repair and highlights the roles of the interprofessional team in managing patients who sustain trauma and subsequently undergo facial laceration repair.') ?> </p>
							<div class="service-img">
								<img src="images/facial-lacerations-repair.svg" width="100%" class="img-fluid" alt="Facial Laceration Repair in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare Oral + Facial Laceration would be happy to discuss the details of facial laceration repair with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p></p>
								<p>
