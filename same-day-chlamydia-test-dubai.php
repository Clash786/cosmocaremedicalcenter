...
<head>
	...
	<meta name="description" content="<?= __t('<?php include \'price.php\';  \'Consult the Best Dermatologist for Hair Loss in Dubai at\'  <?php echo $company;   \'offering advanced hair restoration, scalp treatments, and personalized care for men and women. For appointments, call \' <?php echo $contact;   \'(Satwa / \' <?php echo $contactjumeirah;   \'(Jumeirah 2 or email\'  <?php echo $email; .') ?>" />
	<meta name="keywords" content="<?= __t('<?php include \'price.php\';  \', best-dermatologist-for-hair-loss-dubai, hair-loss-treatment, hair-fall-solutions, scalp-treatment, hair-regrowth, dermatologist-dubai,\'  <?php echo $company;') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$company"; ?> <?= __t('| Same Day Chlamydia Test in Dubai Satwa & Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Same Day Chlamydia Test in Dubai') ?></h3>
							<h1><?= __t('Confidential & Same-Day STD Testing') ?></h1>
							<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we offer') ?> <strong><?= __t('same-day Chlamydia testing') ?></strong> <?= __t('in Dubai with complete privacy and accuracy.') ?>
								<br><?= __t('Our goal is to help you take control of your sexual health with professional care, fast results, and absolute confidentiality.') ?>
							</p>
							<h1><?= __t('Private STD Screening & Medical Support') ?></h1>
							<p><?= __t('Whether you require a quick Chlamydia test or a full STD screening, our experienced doctors provide safe, non-judgmental, and confidential services.') ?>
								<br><?= __t('We ensure') ?> <strong><?= __t('accurate results within the same day') ?></strong><?= __t(', with compassionate guidance throughout your visit.') ?>
							</p>
						</div>
						<div class="service-img">
							<a href="same-day-chlamydia-test-dubai.php">
								<img src="images/same-day-chlamydia-test-dubai.jpg"
									alt="Same-Day Chlamydia Test in Dubai by Cosmocare Medical Center"
						...
						<br>
						<h1><?= __t('Same-Day Chlamydia Test in Dubai') ?></h1>
						<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide fast, accurate, and confidential') ?> <strong><?= __t('same-day Chlamydia testing') ?></strong> <?= __t('in Dubai.') ?>
							<br><?= __t('Our expert medical team ensures complete privacy and reliable results, helping you take control of your sexual health with confidence and care.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Same-Day Chlamydia Testing?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Same-Day Results:') ?></strong> <?= __t('Quick and precise results so you don\'t have to wait.') ?></li>
							<li><strong><?= __t(' Confidential & Private Testing:') ?></strong> <?= __t('100% discreet process with professional guidance and counseling.') ?></li>
							<li><strong><?= __t(' Modern Laboratory Facilities:') ?></strong> <?= __t('Advanced diagnostic tools for accurate detection and timely treatment.') ?></li>
							<li><strong><?= __t(' Convenient Locations:') ?></strong> <?= __t('Available at both') ?> <strong><?= __t('Satwa') ?></strong> <?= __t('and') ?> <strong><?= __t('Jumeirah 2') ?></strong> <?= __t('branches for easy access.') ?></li>
						</ul>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Confidential STD Check-up in Dubai by Cosmocare Medical Center...'),
			'link' => 'std-check-up-dubai.php',
			'date' => 'July 25, 2021'
		],
	];
