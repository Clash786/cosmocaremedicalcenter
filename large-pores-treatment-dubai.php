...
<head>
	...
	<meta name="description" content="<?= __t('Get effective large pores treatment in Dubai at Cosmocare Medical Center. Dr. Murtuza Bandukwala offers advanced dermatology solutions to minimize open pores, improve skin texture, and restore smooth, radiant skin. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Large pores treatment Dubai, Open pores solution Dubai, Skin texture improvement Dubai, Pore reduction Dubai, Dermatologist Dubai, Dr. Murtuza Bandukwala, Cosmocare Medical Center, Skin rejuvenation Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Large Pores Treatment in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Advanced treatments to minimize and tighten large pores') ?></li>
										<li><?= __t('Improves overall skin texture and smoothness') ?></li>
										<li><?= __t('Reduces excess oil production and blackheads') ?></li>
										<li><?= __t('Stimulates collagen for firmer, healthier-looking skin') ?></li>
										<li><?= __t('Safe and effective procedures with minimal downtime') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Large Pores Treatment Specialist in Dubai') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified dermatologist and a leading') ?> <b><?= __t('Large Pores Treatment and Skin Care Specialist') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center, Dubai') ?></b><?= __t('. With extensive experience in dermatology and aesthetic skin treatments, he provides advanced solutions to minimize open pores, refine skin texture, and enhance overall skin smoothness. Dr. Murtuza believes in a personalized approach to help every patient achieve healthy, refined, and radiant') ?> <b><?= __t('skin') ?></b>.</p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b>, <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('focuses on identifying the root causes of') ?> <b><?= __t('enlarged pores') ?></b> <?= __t('and designing customized treatments that combine modern dermatology with compassionate patient care. His commitment to adopting innovative, science-based methods ensures safe, visible, and long-lasting results for patients seeking the most effective') ?> <b><?= __t('large pores treatment in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Large Pores Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/large-pores-treatment-dubai1.jpg" class="img-fluid" alt="Large Pores Treatment in Dubai by Dr. Murtuza Bandukwala at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/large-pores-treatment-dubai.jpg" class="img-fluid" alt="Large Pores Treatment in Dubai by Dr. Murtuza Bandukwala at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/large-pores-treatment-dubai2.jpg" class="img-fluid" alt="Large Pores Treatment in Dubai by Dr. Murtuza Bandukwala at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with large pores and uneven skin texture for years, but after visiting Dr. Murtuza Bandukwala at Cosmocare Medical Center, I saw a visible improvement in my skin within just a few sessions. His expertise in skin care and personalized treatment approach helped refine my pores and restore smooth, glowing skin. I finally feel confident about my complexion again!"') ?></p>
							</div>
						</div>
