...
<head>
	...
	<meta name="description" content="<?= __t('Get accurate herpes testing in Dubai at Cosmocare Medical Center. Confidential and reliable herpes testing with expert care. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Herpes testing Dubai, Herpes test Dubai, STD testing Dubai, Herpes diagnosis Dubai, Confidential herpes test Dubai, Sexual health clinic Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Herpes Testing in Dubai | Rapid and Accurate STD Tests at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Dermatologist & STD Specialist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Herpes Testing and Diagnosis') ?></li>
										<li><?= __t('Sexually Transmitted Disease (STD) Screening') ?></li>
										<li><?= __t('Skin Lesion and Rash Evaluation') ?></li>
										<li><?= __t('Viral Skin Infection Treatment') ?></li>
										<li><?= __t('Comprehensive Dermatologic and Sexual Health Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Herpes Testing & STD Care by Consultant Dermatologist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('STD specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in dermatology, he provides accurate') ?> <b><?= __t('herpes testing and diagnosis') ?></b> <?= __t('along with effective treatment options for various') ?> <b><?= __t('sexually transmitted skin conditions') ?></b><?= __t('. Dr. Murtuza ensures complete confidentiality, compassionate care, and advanced dermatological solutions for patients seeking trusted herpes care.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala specializes in detecting and managing') ?> <b><?= __t('herpes simplex virus (HSV)') ?></b> <?= __t('and other') ?> <b><?= __t('STD-related skin issues') ?></b> <?= __t('through professional testing and expert treatments. His patient-centered approach, combined with advanced dermatology techniques, ensures accurate diagnosis, safe care, and optimal skin recovery for those seeking reliable') ?> <b><?= __t('herpes and STD testing in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Herpes Testing & STD Dermatology Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/herpes-testing.jpg" class="img-fluid" alt="Herpes Testing and STD Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/herpes-testing1.jpg" class="img-fluid" alt="Herpes Testing and STD Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/herpes-testing2.jpg" class="img-fluid" alt="Herpes Testing and STD Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was concerned about possible herpes symptoms and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. The herpes testing and consultation were handled with exceptional care and professionalism.') ?> <b><?= __t('Dr. Murtuza') ?></b> <?= __t('explained the process clearly, ensured my confidentiality, and made me feel completely at ease. I\'m truly grateful for his expertise and the reliable results provided."') ?></p>
							</div>
						</div>
