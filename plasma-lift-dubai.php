...
<head>
	...
	<meta name="description" content="<?= __t('Experience non-surgical Plasma Lift in Dubai at Cosmocare Medical Center. Tighten and rejuvenate your skin with advanced plasma technology by expert dermatologist Dr. Murtuza Bandukwala.') ?>">
	<meta name="keywords" content="<?= __t('Plasma Lift Dubai, Plasma Pen Treatment Dubai, Non Surgical Skin Tightening Dubai, Plasma Fibroblast Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Plasma Lift in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Non-surgical skin tightening and lifting') ?></li>
										<li><?= __t('Reduces wrinkles, fine lines, and sagging skin') ?></li>
										<li><?= __t('Stimulates natural collagen and elastin production') ?></li>
										<li><?= __t('Improves skin tone, texture, and elasticity') ?></li>
										<li><?= __t('Minimal downtime and long-lasting results') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Plasma Lift Specialist in Dubai') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified dermatologist and a leading') ?> <b><?= __t('Plasma Lift and skin care specialist') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center, Dubai') ?></b><?= __t('. With extensive experience in dermatology and aesthetic procedures, he provides advanced solutions for various') ?> <b><?= __t('skin concerns') ?></b><?= __t(', including wrinkles, fine lines, pigmentation, and skin laxity. Dr. Murtuza believes in a personalized approach to help every patient achieve firm, youthful, and radiant') ?> <b><?= __t('skin') ?></b>.</p>
						<p><?= __t('As part of the expert team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b>, <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('specializes in identifying the root causes of') ?> <b><?= __t('skin aging') ?></b> <?= __t('and offering treatments like') ?> <b><?= __t('Plasma Lift') ?></b> <?= __t('that combine innovation, safety, and precision. His commitment to using the latest dermatology techniques ensures long-lasting, natural results for patients seeking non-surgical') ?> <b><?= __t('skin rejuvenation in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Plasma Lift Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/plasma-lift-dubai1.jpg" class="img-fluid" alt="Plasma Lift Treatment in Dubai by Dr. Murtuza Bandukwala - Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/plasma-lift-dubai.jpg" class="img-fluid" alt="Plasma Lift Treatment in Dubai by Dr. Murtuza Bandukwala - Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/plasma-lift-dubai2.jpg" class="img-fluid" alt="Plasma Lift Treatment in Dubai by Dr. Murtuza Bandukwala - Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been dealing with sagging skin and fine lines for a long time, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b> <?= __t('for a') ?> <b><?= __t('Plasma Lift treatment') ?></b><?= __t(', I saw visible tightening and rejuvenation within just a few') ?>
							</div>
						</div>
