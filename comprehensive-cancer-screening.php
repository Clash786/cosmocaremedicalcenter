...
<head>
	...
	<title><?= __t('Comprehensive Cancer Screening in Dubai by Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu4">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="comprehensive-cancer-screening.html"><?= __t('Comprehensive Cancer Screening') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Comprehensive Cancer Screening in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/cancer-screening.svg" width="100%" class="img-fluid" alt="cancer screening piles hernia Treatment in Dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Screening can help doctors find and treat several types of cancer early, before they cause symptoms. Early detection is important because when abnormal tissue or cancer is found early, it may be easier to treat. By the time symptoms appear, cancer may have begun to spread and be harder to treat.') ?></h1>
							<p><?= __t('Several screening tests have been shown to detect cancer early and toreduce the chance of dying from that cancer.') ?>
							<p><?= __t('But it is important to keep in mind that screening tests can have potential harms as well as benefits.') ?></p>
							<ul>
								<li><?= __t('Some screening tests may cause bleeding or other health problems.') ?></li>
								<li><?= __t('Screening tests can have false-positive results—that is, the test indicates that cancer may be present even though it is not. False-positive test results can cause anxiety and are usually followed by additional tests and procedures that also have potential harms.') ?></li>
								<li><?= __t('Screening tests can have false-negative results—that is, the test indicates that cancer is not present even though it is. False-negative test results may provide false reassurance, leading to delays in diagnosis and possibly causing an individual to put off seeking medical care even if symptoms develop.') ?></li>
								<li><?= __t('Screening can lead to overdiagnosis—that is, thescreening test correctly shows that a person has cancer, but the cancer is slow growing and would not have harmed that person in his or her lifetime. Treatment of such cancers is called overtreatment.') ?></li>
							</ul>
							<p><?= __t('It can be helpful for people to discuss the potential harms as well as benefits of different cancer screening tests with their doctors.') ?></p>
							<p>
						</div>
					</div>
				</div>
