...
<head>
	...
	<meta name="description" content="<?= __t('Meso Lips Treatment') ?>  <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, <?= __t('Meso Lips Treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('Meso Lips Treatment Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="meso-lips.php"><?= __t('Meso Lips') ?></a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('MESO LIPS') ?></h1>
							<p><?= __t('Hydrate and Enhance with the Power of Meso Lips at Cosmocare Medical Center') ?>
							</p>
							<div class="service-img">
								<a href="meso-lips.php"><img src="images/mesolips.jpg"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Hydrate and Enhance with the Power of Meso Lips at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we understand the desire for beautiful, plump, and kissable lips. Meso Lips offers a revolutionary approach to lip enhancement, delivering essential nutrients directly into the lips for deep hydration, improved texture, and a refreshed appearance. This minimally invasive treatment can be used in conjunction with laser lip lightening for a comprehensive lip rejuvenation experience.') ?>
							</p>
							<h3><?= __t('Grip Luscious, Hydrated Lips') ?></h3>
							<p><?= __t('Meso Lips offers a multitude of benefits for those seeking to revitalize and enhance their lips:') ?>
							</p>
							<ul>
								<li><?= __t(' Intense Hydration: The meso cocktail, containing hyaluronic acid and other hydrating ingredients, delivers deep moisture to the lips, leaving them feeling plump, supple, and smooth.') ?>
								</li>
								<li><?= __t(' Improved Texture: Meso Lips can help address dryness, flakiness, and fine lines around the lips, promoting a smoother and more youthful appearance.') ?>
								</li>
								<li><?= __t(' Enhanced Color: Hydrated lips naturally appear brighter and have a more vibrant color.') ?>
								</li>
								<li><?= __t(' Plumping Effect: Hyaluronic acid can provide a subtle plumping effect, enhancing the natural shape of the lips.') ?>
								</li>
							</ul>
							<h3><?= __t('A Synergistic Approach: Combining Meso Lips with Laser Lip Lightening') ?></h3>
							<p><?= __t('For a more comprehensive lip rejuvenation experience, Cosmocare Medical Center offers the option to combine Meso Lips with laser lip lightening:') ?>
							</p>
							<ul>
								<li><?= __t(' Laser Lip Lightening: This treatment targets hyperpigmentation in the lips, resulting in a lighter and more even lip color.') ?>
								</li>
								<li><?= __t(' Enhanced Results: Combining Meso Lips with laser lip lightening can address both hydration and pigmentation concerns, leading to beautifully enhanced lips.') ?>
								</li>
								<li><?= __t(' Alternating Sessions: Meso Lips and laser lip lightening treatments are typically performed in an alternating sequence to optimize results.') ?>
								</li>
							</ul>
							<h3><?= __t('Secrets Behind the Treatment') ?></h3>
							<p><?= __t('Meso Lips works through a targeted and effective approach:') ?></p>
							<ul>
								<li><?= __t(' Microinjections: A personalized meso cocktail containing hyaluronic acid, vitamins, and other beneficial ingredients is injected directly into the lips.') ?>
								</li>
								<li><?= __t(' Deep Hydration: Hyaluronic acid attracts and retains moisture, leaving the lips feeling plump and hydrated from within.') ?>
								</li>
								<li><?= __t(' Stimulated Collagen Production: Certain ingredients in the meso cocktail can stimulate collagen production, promoting smoother and firmer lips.') ?>
								</li>
							</ul>
							<h3><?= __t('Important Precautions') ?></h3>
							<p><?= __t('While generally safe, there are a few precautions to consider with Meso Lip treatment:') ?>
							</p>
							<ul>
								<li><?= __t(' Consultation: A consultation with a qualified dermatologist or skincare expert is crucial to determine if Meso Lips is right for you and discuss potential side effects') ?>
								</li>
								<li><?= __t(' Multiple Sessions: A series of Meso Lip sessions, typically 3, may be required to achieve optimal results.') ?>
								</li>
							</ul>
							<div class="service-img">
