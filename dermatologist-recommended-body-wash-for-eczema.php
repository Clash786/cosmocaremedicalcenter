...
<head>
	...
	<meta name="description" content="<?= __t('Discover dermatologist-recommended body wash solutions for eczema-prone skin at Cosmocare Medical Center, Dubai. Our dermatologists offer gentle, effective skincare treatments to soothe dryness, irritation, and itching. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>" />
	<meta name="keywords" content="<?= __t('eczema treatment Dubai, body wash for eczema, dermatologist recommended skincare, sensitive skin care Dubai, dry skin treatment Dubai, Cosmocare Medical Center, dermatologist Dubai') ?>" />
	...
	<title><?= __t('Dermatologist Recommended Body Wash for Eczema | Gentle Skincare Solutions in Dubai - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive Evaluation of Eczema and Sensitive Skin Conditions') ?></li>
										<li><?= __t('Dermatologist-Recommended Body Wash and Skincare Products') ?></li>
										<li><?= __t('Customized Treatment Plans for Dryness, Itching, and Redness') ?></li>
										<li><?= __t('Advanced Moisturizing and Barrier Repair Therapies') ?></li>
										<li><?= __t('Long-Term Skin Health and Maintenance Guidance') ?></li>
									</ul>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist Dermatologist Eczema & Sensitive Skin Care Expert') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist Dermatologist at Cosmocare Medical Center, Dubai') ?></strong><?= __t(', with extensive expertise in treating eczema, dry skin, and other sensitive skin conditions. He provides personalized guidance on dermatologist-recommended body washes and skincare routines designed to soothe irritation, restore moisture balance, and strengthen the skin\'s natural barrier.') ?></p>
						<p><?= __t('Dedicated to patient care and continuous learning,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('stays updated with the latest advancements in dermatology and therapeutic skincare. He believes that managing eczema is not just about treatment, but about helping patients feel comfortable and confident in their own skin. His compassionate approach and evidence-based care make him one of the most trusted dermatologists in Dubai for eczema management and sensitive skin solutions.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Eczema & Sensitive Skin Care by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/eczema-treatment-dubai.jpg" class="img-fluid" alt="Dermatologist Recommended Body Wash for Eczema by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
									<div class="col-sm-4"><img src="images/content/eczema-treatment-dubai1.jpg" class="img-fluid" alt="Dermatologist Recommended Body Wash for Eczema by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
									<div class="col-sm-4"><img src="images/content/eczema-treatment-dubai2.jpg" class="img-fluid" alt="Dermatologist Recommended Body Wash for Eczema by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked what makes dermatology so rewarding,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('shared, œHelping patients manage conditions like') ?> <strong><?= __t('eczema and sensitive skin') ?></strong> <?= __t('is truly fulfilling. Even a small improvement in comfort or skin health can make a big difference in a person\'s confidence and quality of life. Seeing patients feel at ease in their own skin is what inspires me every day.') ?></p>
							</div>
						</div>
