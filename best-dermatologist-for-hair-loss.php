...
<head>
	...
	<meta name="description" content="<?= __t('Consult the best dermatologist for hair loss in Dubai at Cosmocare Medical Center. Expert treatments for hair thinning, hair restoration, PRP therapy, and advanced hair care solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Best dermatologist Dubai, Hair loss treatment Dubai, Hair restoration Dubai, PRP therapy Dubai, Hair thinning solutions Dubai, Hair transplant Dubai, Trichologist Dubai, Hair care clinic Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Best Dermatologist for Hair Loss in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Specialist Dermatologist & Hair Loss Expert') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('PRP Therapy for Hair Loss') ?></li>
										<li><?= __t('Mesotherapy for Hair Regrowth') ?></li>
										<li><?= __t('Advanced Scalp and Follicle Health Management') ?></li>
										<li><?= __t('Non-Surgical Hair Restoration') ?></li>
										<li><?= __t('Treatment of Dandruff and Scalp Conditions') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist Dermatologist & Hair Loss Expert') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a highly experienced') ?> <b><?= __t('Specialist Dermatologist') ?></b> <?= __t('and one of the leading') ?> <b><?= __t('Hair Loss Experts') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center, Dubai') ?></b><?= __t('. With years of expertise in dermatology and trichology, he provides advanced and effective treatments for both male and female hair loss. His areas of specialization include') ?> <b><?= __t('PRP therapy') ?></b>,<b><?= __t('mesotherapy') ?></b> , <b><?= __t('scalp rejuvenation') ?></b>,<?= __t('and') ?> <b><?= __t('non-surgical hair restoration') ?></b><?= __t('. Dr. Murtuza is dedicated to helping patients regain their confidence through healthier, thicker, and natural-looking hair.') ?></p>
						<p><?= __t('As a key part of the expert team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b> , <b><?= __t('Dr. Murtuza') ?></b> <?= __t('focuses on identifying and addressing the root causes of hair fall  including') ?> <b><?= __t('hormonal imbalance') ?></b> , <b><?= __t('nutritional deficiencies') ?></b>,<?= __t('and') ?> <b><?= __t('stress-related issues') ?></b><?= __t('. He combines modern medical technology with a compassionate approach to deliver safe and long-lasting results. His commitment to continuous innovation keeps him at the forefront of') ?> <b><?= __t('hair loss and scalp health treatments in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Hair Loss Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/hair-prp-treatment1.jpg" class="img-fluid" alt="Best Dermatologist for Hair Loss in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/hair-prp-treatment.jpg" class="img-fluid" alt="Best Dermatologist for Hair Loss in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/hair-prp-treatment3.jpg" class="img-fluid" alt="Best Dermatologist for Hair Loss in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with severe hair fall for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center, Dubai') ?></b><?= __t(', I noticed visible improvement within just a few PRP sessions. He truly understands how to treat hair loss effectively and helped me regain my confidence with healthier and stronger hair."') ?></p>
							</div>
						</div>
