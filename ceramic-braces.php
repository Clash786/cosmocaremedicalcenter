...
<head>
	...
	<meta name="description" content="<?= __t('Our ceramic braces procedure at Cosmocare provide a comfortable and effective way to straighten your teeth and transform your smile. in Jumeirah 2 Dubai. Please call at 04 379 8747 (Satwa / 04 353 6164. (Jumeirah 2 Medical Center for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('Ceramic Braces in Dubai, Tooth Extraction, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title>✅ <?php include 'price.php'; echo "$braces"; ?> <?= __t('Teeth Ceramic Braces in Jumeirah 2 Dubai Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Teeth Ceramic Braces in Dubai') ?> <?php include 'price.php';
																			echo "$braces"; ?> </h1>
							<h4><?= __t('Never Too Late to Get the Smile You Want') ?></h4>
							<p><?= __t('Are you self-conscious about your smile but hesitant to get traditional metal braces? If so, ceramic braces may be the solution you\'re looking for. With their clear or tooth-colored brackets, ceramic braces provide a more discreet option for straightening your teeth. In this article, we\'ll explore everything you need to know about ceramic braces, from how they work to the cost and aftercare involved. So, whether you\'re a teenager or an adult looking to improve your smile, read on to discover the benefits of ceramic braces in Dubai.') ?></p>
							<p> <?= __t('To schedule an appointment for Ceramic Braces in Dubai? Please call at 04 379 8747 ') ?>(<a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Meidcal Center') ?></a>) / 04 353 6164. <a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank"><?= __t('(Jumeirah 2 Medical Center)') ?></a><?= __t(' for BOOK an appointment.') ?></p>
							<div class="service-img">
								<img src="images/ceramic-braces-cosmocare.svg" width="100%" class="img-fluid" alt="Ceramic Braces in Dubai by Cosmocare Medical Center">
							</div>
							<br>
							<br>
							<div class="service-img">
