...
<head>
	...
	<meta name="description" content="<?= __t('An anal fissure is a tear in the skin lining the inside of the anus which can be caused by constipation. If a fissure does not heal on its own, surgical treatment can help. Find out here from Cosmocare Medical Center about the general information and conditions of a ANAL FISSURE surgery.') ?>" />
	<meta name="keywords" content="<?= __t('anal fissure Treatment in dubai, anal fissure surgery in dubai, fissure surgery, anal fissure specialist surgeon in dubai') ?>" />
	...
	<title><?= __t('Anal Fissure Surgery in Dubai | Fissure Treatment Specialist Doctor by Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu4">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="fissure.html"><?= __t('Fissure') ?></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Anal Fissure Surgery / Treatment in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/anal-fissure-surgery.svg" width="100%" class="img-fluid" alt="Anal Fissure  Surgery / Treatment | Anal Fissure Specialist Doctor in Dubai by Cosmocare Medical Center">
						</div>
						<div class="pt-2 pt-md-4">
							<h2><?= __t('Anal Fissure surgery with Cosmocare Medical Center') ?></h2>
							<p><?= __t('Here at Cosmocare Medical Center, our skilled and experienced surgeons regularly perform Anal Fissure surgery.') ?></p>
