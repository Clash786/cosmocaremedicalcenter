...
<head>
	...
	<meta name="description" content="<?= __t('Meso Lift Treatment') ?> <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, <?= __t('Meso Lift Treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('Meso Lift Treatment|') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="meso-lift.php"><?= __t('Meso Lift') ?></a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('MESO LIFT') ?></h1>
							<p><?= __t('Reinvigorate Your Radiance: Unveiling the Power of Mesolifting at Cosmocare Medical Center') ?>
							</p>
							<div class="service-img">
								<a href="meso-face.php"><img src="images/mesolift.jpg"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Reinvigorate Your Radiance: Unveiling the Power of Mesolifting at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we understand the desire for a revitalized, youthful, and luminous complexion. Mesolifting offers a groundbreaking approach to facial rejuvenation, delivering a potent cocktail of essential nutrients directly into the skin. This minimally invasive treatment stimulates collagen and elastin production, promoting a firmer, brighter, and more youthful appearance.') ?>
							</p>
							<h3><?= __t('Choose a Brighter, Tighter You') ?></h3>
							<p><?= __t('Mesolifting offers a multitude of benefits for those seeking to restore vitality and radiance to their skin:') ?>
							</p>
							<ul>
								<li><?= __t(' Enhanced Elasticity and Firmness: Mesolifting stimulates the production of collagen and elastin, the building blocks responsible for skin structure and tightness. This leads to a firmer, lifted appearance and a noticeable reduction in sagging.') ?>
								</li>
								<li><?= __t(' Improved Skin Clarity and Brightness: The targeted delivery of essential vitamins and antioxidants nourishes the skin from within, promoting a brighter, more radiant complexion.') ?>
								</li>
								<li><?= __t(' Reduced Signs of Aging: By addressing collagen and elastin loss, mesolifting helps combat fine lines, wrinkles, and other visible signs of aging.') ?>
								</li>
								<li><?= __t(' Scar Reduction: Mesolifting can improve the appearance of acne scars and other blemishes by stimulating collagen production and promoting tissue regeneration.') ?>
								</li>
								<li><?= __t(' Sun Damage Reduction: Mesolifting can help minimize the visible effects of sun damage, such as hyperpigmentation and uneven skin tone.') ?>
								</li>
							</ul>
							<h3><?= __t('Discover the Science Behind the Treatment') ?></h3>
							<p><?= __t('Mesolifting works through a precise and targeted approach:') ?></p>
							<ul>
								<li><?= __t(' Microinjections: A personalized cocktail of essential vitamins, antioxidants, and hyaluronic acid is delivered directly into the mesoderm, the middle layer of the skin.') ?>
								</li>
								<li><?= __t(' Enhanced Absorption: Bypassing the surface layer of the skin allows for deeper penetration and increased absorption of the beneficial ingredients.') ?>
								</li>
								<li><?= __t(' Targeted Action: The customized cocktail can be formulated to address specific concerns, ensuring optimal results.') ?>
								</li>
							</ul>
							<h3><?= __t('A Treatment formulated for a Variety of Concerns') ?></h3>
							<p><?= __t('Mesolifting offers a versatile treatment option for various signs of aging and sun damage:') ?>
							</p>
							<ul>
								<li><?= __t(' Loss of Elasticity and Firmness: If you struggle with sagging skin or a loss of definition in your facial contours, mesolifting can help restore a firmer, more youthful appearance.') ?>
								</li>
								<li><?= __t(' Fine Lines and Wrinkles: Mesolifting stimulates collagen production, leading to a reduction in the appearance of fine lines and wrinkles.') ?>
								</li>
								<li><?= __t(' Uneven Skin Tone: The targeted delivery of vitamins and antioxidants can help improve overall skin tone and reduce hyperpigmentation.') ?>
								</li>
								<li><?= __t(' Sun Damage: Mesolifting can help minimize the visible effects of sun damage, promoting a healthier complexion.') ?>
								</li>
							</ul>
							<h3><?= __t('Who Can Benefit from Mesolifting?') ?></h3>
							<p><?= __t('Mesolifting is a suitable treatment option for a variety of individuals seeking facial rejuvenation:') ?>
							</p>
							<ul>
								<li><?= __t(' Those with Loss of Vitality and Brightness: If your skin appears dull and tired, mesolifting can help restore its radiance and vitality.') ?>
								</li>
								<li><?= __t(' Those with Sagging Skin and Wrinkles: Mesolifting can address sagging skin and wrinkles, promoting a firmer and more youthful appearance.') ?>
								</li>
								<li><?= __t(' Those with Sun Damage: Mesolifting can combat the visible effects of sun damage, promoting a healthier complexion.') ?>
								</li>
								<li><?= __t(' Those with Acne Scars: Mesolifting can improve the appearance of acne scars by stimulating collagen production and tissue regeneration.') ?>
								</li>
							</ul>
							<h3><?= __t('Treatment Frequency') ?></h3>
							<p><?= __t('Mesolifting typically requires an initial series of treatments followed by maintenance sessions:') ?>
							</p>
							<ul>
								<li><?= __t(' Initial Sessions: 1-4 week intervals are recommended for the initial 4-6 sessions to achieve optimal results.') ?>
								</li>
								<li><?= __t(' Maintenance: Following the initial series, maintenance sessions can be performed every 3-6 months to maintain results.') ?>
								</li>
							</ul>
							<h3><?= __t('The Perfect Collaboration: Mesolifting and HydraFacial') ?></h3>
							<p><?= __t('For an even more comprehensive approach to facial rejuvenation, consider combining Mesolifting with a HydraFacial treatment:') ?>
							</p>
							<ul>
								<li><?= __t(' Deep Exfoliation and Hydration: HydraFacial gently exfoliates dead skin cells and impurities, while also delivering deep hydration. This prepares the skin for optimal absorption of the nutrients delivered during mesolifting and promotes overall skin health.') ?>
								</li>
								<li><?= __t(' Enhanced Results: The combination of these treatments can lead to even more dramatic improvements in skin texture, tone, elasticity, and overall radiance.') ?>
								</li>
							</ul>
							<div class="service-img">
