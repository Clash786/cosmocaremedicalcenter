...
<head>
	...
	<meta name="description" content="<?= __t('To figure out what\'s causing your Gynaecological Laparoscopy, Our gynecologist specialist asks you about your symptoms. To schedule an appointment for Gynaecological Laparoscopy Surgery? Please call at') ?> <?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) /') ?> <?php include 'price.php'; echo "$contactjum"; ?> <?= __t('(Jumeirah 2) for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('Gynaecological Laparoscopy') ?>, <?php include 'price.php'; echo "$company"; ?>, <?= __t('cosmocare, testing, treatment, dubai, treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="author" content="<?php include 'price.php'; echo "$company"; ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title>[<?php include 'price.php'; echo "$gynecon"; ?><?= __t(']  Gynaecological Laparoscopy Surgery treatment in Dubai? Specialist Gynecologist') ?> <?php include 'price.php'; echo "$company"; ?></title>
	<!-- Stylesheets -->
			...
			<div class="breadcrumbs-wrap">
				<div class="container">
					<div class="breadcrumbs">
						...
						<a
							href="services.php"><?= __t('Services') ?></a><?= __t(' Gynaecological Laparoscopy - Diagnosis and treatment - Cosmocare') ?>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
								...
								<li class="nav-item">
									...
									<div class="collapse show" id="submenu5">
										<ul class="flex-column nav">
											...
											<li class="nav-item"><a class="nav-link"
													href="recurrent-implantation-failures.php"><?= __t('Gynaecological Laparoscopy') ?></a>
											</li>
											<li class="nav-item"><a class="nav-link"
						...
						<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
							<div class="title-wrap">
								<h1><?= __t(' Gynaecological Laparoscopy - Diagnosis and treatment - Cosmocare') ?></h1>
								<p><?= __t('To figure out what\'s causing your Gynaecological Laparoscopy, Our gynecologist specialist asks you about your symptoms. You\'ll also answer questions about health conditions that you and your blood relatives, such as parents and siblings, have had over the years.') ?>
								</p>
								...
								<p><?= __t('You may have a gynaecological laparoscopy to investigate certain symptoms, such as pain in your pelvis. You may have other tests, such as an ultrasound, magnetic resonance imaging (MRI) or computer tomography (CT) scan first. You may also have a gynaecological laparoscopy to treat a condition.') ?>
								</p>
								<img alt="Gynaecological Laparoscopy - Diagnosis and treatment"
									src="images/gynaecological-laparoscopy.svg" width="100%">
								<p><?= __t('To schedule an appointment, please call at') ?> <?php include 'price.php';
								   echo "$contact"; ?> ( <a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6"
										target="_blank"><?= __t('Satwa Meidcal Center') ?></a>) / <?php include 'price.php';
										  echo "$contactjum"; ?>.
