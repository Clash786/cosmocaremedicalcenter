...
<head>
	...
	<meta name="description" content="<?= __t('Get an instant and accurate Herpes test in Dubai at Cosmocare Medical Center. Confidential testing for HSV-1 and HSV-2 with same-day results. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Instant Herpes test Dubai, HSV test Dubai, Herpes testing Dubai, same-day herpes test Dubai, confidential herpes test Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('Instant Herpes Test in Dubai | Accurate & Confidential - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Rapid and Accurate Herpes (HSV-1 & HSV-2) Testing') ?></li>
										<li><?= __t('Confidential and Private Test Results') ?></li>
										<li><?= __t('Same-Day Testing for Quick Diagnosis') ?></li>
										<li><?= __t('Expert Consultation and Medical Guidance') ?></li>
										<li><?= __t('Comprehensive Sexual Health Assessment') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist in STD & Herpes Testing') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist in STD & Herpes Testing') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He provides accurate, confidential, and same-day testing for Herpes (HSV-1 & HSV-2) and other STDs. With his expertise, patients receive professional guidance and personalized care to ensure their sexual health and well-being.') ?></p>
						<p><?= __t('Committed to staying updated with the latest advancements in STD diagnostics and treatment,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('emphasizes confidentiality, accuracy, and patient comfort. His compassionate approach makes him one of the most trusted specialists in Dubai for herpes and sexual health testing.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Herpes & STD Testing Services by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/instant-herpes-test-dubai.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Herpes & STD Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/instant-herpes-test-dubai1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Herpes & STD Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/instant-herpes-test-dubai2.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Herpes & STD Testing in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to STD and herpes testing,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "The most rewarding part of my work is providing accurate, confidential testing that helps patients take control of their sexual health. Even a small step towards awareness and prevention can greatly boost their confidence and peace of mind. Helping people feel safe and informed motivates me every day."') ?></p>
							</div>
						</div>
