...
<head>
	...
	<meta name="description" content="<?= __t('Experience advanced skin resurfacing laser treatment in Dubai at Cosmocare Medical Center. Reduce acne scars, wrinkles, pigmentation, and uneven skin tone with expert dermatologists. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Skin resurfacing laser Dubai, Laser skin treatment Dubai, Acne scar removal Dubai, Wrinkle reduction Dubai, Pigmentation removal Dubai, Skin rejuvenation Dubai, Laser dermatologist Dubai, Cosmetic dermatology Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Skin Resurfacing Laser in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Precise Skin Resurfacing for Smoother Texture') ?></li>
										<li><?= __t('Scar and Wrinkle Reduction Treatments') ?></li>
										<li><?= __t('Expert Consultation with Dermatologists in Dubai') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Resurfacing Laser Specialist in Dubai') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified dermatologist and one of the leading') ?> <b><?= __t('skin resurfacing laser specialists') ?></b> <?= __t('and') ?> <b><?= __t('skin care doctors') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With years of expertise in dermatology, he provides advanced') ?> <b><?= __t('laser skin treatments') ?></b> <?= __t('for acne scars, pigmentation, wrinkles, and uneven skin texture. Dr. Murtuza is dedicated to helping patients achieve smoother, clearer, and rejuvenated') ?> <b><?= __t('skin') ?></b> <?= __t('through safe and effective resurfacing procedures.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines cutting-edge') ?> <b><?= __t('laser dermatology technology') ?></b> <?= __t('with personalized treatment plans to deliver long-lasting results. His approach focuses on identifying the root cause of') ?> <b><?= __t('skin concerns') ?></b> <?= __t('and offering targeted') ?> <b><?= __t('resurfacing laser solutions') ?></b> <?= __t('that restore youthful radiance and improve overall skin health. Patients trust his expertise for professional and results-driven') ?> <b><?= __t('skin resurfacing treatments in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Resurfacing Laser Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/skin-resurfacing-laser-dubai.jpg" class="img-fluid" alt="Advanced Skin Resurfacing Laser Treatment in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-resurfacing-laser-dubai1.jpg" class="img-fluid" alt="Advanced Skin Resurfacing Laser Treatment in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-resurfacing-laser-dubai2.jpg" class="img-fluid" alt="Advanced Skin Resurfacing Laser Treatment in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with acne scars and uneven skin texture for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a remarkable improvement in my skin after just a few') ?> <b><?= __t('skin resurfacing laser sessions') ?></b><?= __t('. He truly understands how to treat complex skin concerns and helped me regain my confidence with smooth, clear, and glowing skin."') ?></p>
							</div>
						</div>
