...
<head>
	...
	<meta name="description" content="<?= __t('Get a comprehensive and confidential full STD screening in Dubai at Cosmocare Medical Center. Expert testing and counseling for all sexually transmitted infections. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Full STD screening Dubai, STD checkup Dubai, STD testing Dubai, Sexual health screening Dubai, HIV test Dubai, Syphilis test Dubai, Gonorrhea test Dubai, Chlamydia test Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Full STD Screening in Dubai | Confidential Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive Full STD Screening and Testing') ?></li>
										<li><?= __t('HIV, Syphilis, Gonorrhea, Chlamydia, and Other STD Tests') ?></li>
										<li><?= __t('Confidential Sexual Health Consultations') ?></li>
										<li><?= __t('Partner Notification and Counseling') ?></li>
										<li><?= __t('Preventive Advice, Guidance, and Follow-up Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Physician & Full STD Screening Specialist') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified physician and a leading') ?> <b><?= __t('sexual health specialist') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center Dubai') ?></b><?= __t('. With extensive experience in sexual health and infectious diseases, he provides confidential and comprehensive') ?> <b><?= __t('full STD screening') ?></b> <?= __t('for a wide range of') ?> <b><?= __t('sexually transmitted infections (STIs)') ?></b><?= __t('. Dr. Murtuza ensures every patient receives a personalized approach for accurate diagnosis and effective treatment.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the root causes of') ?> <b><?= __t('STD concerns') ?></b> <?= __t('and designing tailored treatment plans that combine modern medical techniques with compassionate care. His commitment to privacy, patient safety, and continuous learning ensures safe, effective, and reliable results for all patients seeking the best') ?> <b><?= __t('full STD screening and sexual health services') ?></b> <?= __t('in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Full STD Screening & Sexual Health Services by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/std-checkup-dubai.jpg" class="img-fluid" alt="Comprehensive Full STD Screening and Sexual Health Services in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/full-std-screening-dubai1.jpg" class="img-fluid" alt="Comprehensive Full STD Screening and Sexual Health Services in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/full-std-screening-dubai.webp" class="img-fluid" alt="Comprehensive Full STD Screening and Sexual Health Services in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was anxious about getting tested, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I received a comprehensive and confidential') ?> <b><?= __t('full STD screening') ?></b><?= __t('. The process was professional, discreet, and reassuring, and Dr. Murtuza provided expert guidance and care. I felt safe, informed, and confident about my sexual health."') ?></p>
							</div>
						</div>
