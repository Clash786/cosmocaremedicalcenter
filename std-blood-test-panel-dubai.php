...
<head>
	...
	<meta name="description" content="<?= __t('Get a complete STD blood test panel in Dubai at Cosmocare Medical Center. Confidential and accurate testing for HIV, Syphilis, Gonorrhea, Hepatitis, and other sexually transmitted infections. Book your private STD screening today. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('STD blood test Dubai, STD panel Dubai, HIV test Dubai, Syphilis test Dubai, Gonorrhea test Dubai, Hepatitis test Dubai, STD clinic Dubai, STD screening Dubai, STD testing Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('STD Blood Test Panel in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
			...
			<div class="container mt-6">
				<div class="row">
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive STD Blood Test Panels') ?></li>
										<li><?= __t('Confidential and Discreet STD Testing') ?></li>
										<li><?= __t('Screening for HIV, Hepatitis, Syphilis & More') ?></li>
										<li><?= __t('Advanced Laboratory Accuracy and Fast Results') ?></li>
										<li><?= __t('Expert Consultation and Personalized Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						...
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b> <?= __t('in Dubai, our experienced physicians offer confidential and reliable') ?> <b><?= __t('STD blood testing') ?></b> <?= __t('to help you take control of your sexual health. We provide comprehensive screening for a wide range of sexually transmitted diseases, including HIV, Hepatitis B and C, Syphilis, Gonorrhea, Chlamydia, and more  all with complete privacy and professionalism.') ?></p>
						<p><?= __t('Our team of expert doctors ensures accurate diagnosis, timely results, and personalized treatment options when required. At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', we understand the importance of confidentiality and compassionate care, offering a safe and judgment-free environment for every patient. Whether you need routine testing or are experiencing symptoms, our') ?> <b><?= __t('STD specialists in Dubai') ?></b> <?= __t('are here to support your health and peace of mind.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD & Sexual Health Tests by') ?> <span class="theme-color text-nowrap"><?= __t('Cosmocare Medical Center') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/std-blood-test-panel-dubai.jpg" class="img-fluid" alt="Comprehensive STD Blood Test Panel in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/std-blood-test-panel-dubai1.jpg" class="img-fluid" alt="Comprehensive STD Blood Test Panel in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/std-blood-test-panel-dubai2.jpg" class="img-fluid" alt="Comprehensive STD Blood Test Panel in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was anxious about getting tested, but after visiting') ?> <b><?= __t('Cosmocare Medical Center') ?></b> <?= __t('for an') ?> <b><?= __t('STD blood test panel') ?></b><?= __t(', I was impressed by the professionalism and confidentiality of the staff. The process was quick, discreet, and accurate. Thanks to their supportive medical team, I felt completely at ease and received my results promptly with expert guidance."') ?></p>
							</div>
						</div>
