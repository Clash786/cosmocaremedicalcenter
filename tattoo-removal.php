...
<head>
	...
	<meta name="description" content="<?= __t('At Cosmocare, our expert  and certified dermatologist  Dr Murtuza Bandukwala,  uses the most advanced laser tattoo removal technology to remove the unwanted tattoos..') ?>" />
	<meta name="keywords" content="<?= __t('tattoo laser removal dubai, tattoo removal') ?>" />
	...
	<title><?= __t('Tattoo Removal by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="tattoo-removal.html"><?= __t('Tattoo Removal') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Tattoo Removal') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/tattoo.jpg" class="img-fluid" alt="tattoo removal laser dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('If you are looking for  minimally invasive, safe, painless, quick and effective tattoo removal  technique, we assure you that Cosmocare is the right place.') ?></p>
							<p><?= __t('Gone are the days when the old,  lengthy, painful and complicated techniques like Dermabrasion, cryosurgery were  used to remove the tattoos.') ?></p>
							<p><?= __t('At Cosmocare, our expert and certified dermatologist Dr Murtuza Bandukwala, uses the most advanced laser tattoo removal  technology to remove the unwanted tattoos..') ?></p>
							<p><?= __t('The laser treatment does  wonders for those who want to get rid of tattoos partially or completely. The  laser Treatment is the safest technique which is hails fast and satisfactory  results. This technique is also beneficial for stubborn, big dark tattoos and  people with darker skin tones.') ?></p>
							<p><?= __t('Tattoos are actually thousands  of ink particles suspended in the skin. Since the tattoo ink particles are  large therefore it is not removed by normal human immune system which is  responsible for removing small foreign particles from the skin. Laser helps in breaking up the ink particles into  smaller pieces. The ink particles are targeted with highly concentrated light  waves which heats up the ink particles and break them into smaller particles.  Such small particles are then cleared by the immune system.') ?></p>
							<p><?= __t('At Cosmocare, our dermatologist  after consultation decides the number of sessions to remove the tattoo  completely depending on the design, size and color of the tattoo. The number of  sessions vary from 1-10.') ?></p>
							<p><?= __t('After the treatment, there is  no sign of scars and marks. The removed tattoo is a history and past memory.  There is no downtime after the treatment and you can resume the normal routine.') ?></p>
							<p><?= __t('We have the latest and most  advanced laser machine from Quanta System . Quanta is an100% Italian company and the Global  leader in manufacturing laser products since 1985.') ?></p>
							<p><?= __t('The latest generation Q switched laser technology, associated  with Quanta System’s laser treatment, ensures not only complete tattoo removal  but also an effect of skin regeneration bringing the skin close to its original  texture. This is an ideal solution to perform the greatest range of benign  pigmented lines, tattoo removal and skin resurfacing treatment with fast  treatments and safety.') ?></p>
							<p></p>
						</div>
					</div>
				</div>
