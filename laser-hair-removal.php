...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare Medical Center offer laser hair removal for men and women in Dubai. Laser hair removal can help you enjoy smooth skin all day, every day and eliminates the need for shaving and waxing once and for all.') ?>" />
	<meta name="keywords" content="<?= __t('laser hair removal dubai, body hair removal dubai, face hair removal dubai, cosmocare medical center,') ?>" />
	...
	<title><?= __t('Laser Hair Removal Dubai 99 aed | Dermatology, Laser hair Removal, Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="laser-hair-removal.html"><?= __t('Laser Hair Removal') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Laser Hair Removal Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/laserhairremoval.svg" width="100%" class="img-fluid" alt="Laser Hair Removal Dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><strong><?= __t('Hello Laser, Good Bye Razor!') ?></strong></p>
							<p><?= __t('No more shaving, waxing, tweezing or any other annoying methods.') ?></p>
							<p><strong><a href="https://removalhairs.com/" target="_blank"><?= __t('Laser hair removal') ?></a></strong><?= __t('can help you enjoy smooth skin all day, every day and eliminates the need for shaving and waxing once and for all. We offer laser hair removal for men and women. Our trained staff are both discreet and professional.') ?></p>
							<p><?= __t('Experience our latest state-of-the-art laser machine with a cooling system that blows a continuous stream of cold air (4 degree Celsius) on the skin before, during, and after, the laser pulse. We are capable of treating all skin and hair types because we have created a system that makes laser hair removal a secure and effective option for people with darker skin tones or lighter hair colors, which pose a challenge in the laser hair removal industry.') ?></p>
							...
							<img src="images/laser_hair_removal_prices.svg" width="100%" class="img-fluid" alt="Laser Hair Removal Dubai">
							<p></p>
						</div>
					</div>
				</div>
