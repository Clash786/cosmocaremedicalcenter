...
<head>
	...
	<meta name="description" content="<?= __t('HA MESO Treatment') ?>  <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, HA MESO Treatment" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('HA MESO Treatment Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="ha-meso.php"><?= __t('HA Meso') ?></a></li>
										<li class="nav-item"><a class="nav-link"
												href="meso-eyes.php"><?= __t('Meso Eyes') ?> </a></li>
										<li class="nav-item"><a class="nav-link" href="meso-face.php">
												<?= __t('Meso Face') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="meso-gold.php">
												<?= __t('Meso Gold') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="meso-lift.php">
												<?= __t('Meso Lift') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="meso-lips.php">
												<?= __t('Meso Lips') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="meso-open-pores-acne-scars.php">
												<?= __t('Meso Open Pores Acne Scars') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="mesotherapy-face-treatment.php">
												<?= __t('Mesotherapy Face Treatment') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="meso-whitening.php">
												<?= __t('Meso Whitening') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="tprx-meso.php">
												<?= __t('Tprx Meso') ?></a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('HA MESO') ?></h1>
							<p><?= __t('Start Deep Hydration and Banish Fine Lines: HA Mesotherapy at Cosmocare Medical Center') ?>
							</p>
							<div class="service-img">
								<a href="ha-meso.php"><img src="images/mesoha.png"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Start Deep Hydration and Banish Fine Lines: HA Mesotherapy at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we\'re committed to providing innovative solutions for achieving a refreshed, rejuvenated, and radiant complexion. Mesotherapy for Face offers a revolutionary approach to facial rejuvenation, utilizing microinjections or a dermapen to deliver a personalized cocktail of essential nutrients directly into the skin. This targeted treatment nourishes the skin from within, promoting a smoother, firmer, and healthier appearance.') ?>
							</p>
							<h3><?= __t('Awaken the Power of Personalized Nourishment') ?></h3>
							<p><?= __t('Mesotherapy for Face offers a multitude of benefits for those seeking to revitalize and enhance their complexion:') ?>
							</p>
							<ul>
								<li><?= __t('Deep Nourishment: By delivering essential vitamins, minerals, hyaluronic acid, and other revitalizing ingredients directly into the mesoderm, the middle layer of skin, mesotherapy promotes deep nourishment and cellular renewal.') ?>
								</li>
								<li><?= __t('Collagen and Elastin Stimulation: Mesotherapy stimulates the production of collagen and elastin, the proteins responsible for skin structure and elasticity. This leads to firmer, smoother, and younger-looking skin.') ?>
								</li>
								<li><?= __t('Enhanced Radiance: Nourished skin glows from within! Mesotherapy can help promote a radiant and healthy complexion.') ?>
								</li>
							</ul>
							<h3><?= __t('Unlocking the Science Behind the Treatments') ?></h3>
							<p><?= __t('Mesotherapy for Face works through a precise and targeted approach:') ?></p>
							<ul>
								<li><?= __t('Delivery System: A customized blend of revitalizing ingredients is delivered directly into the mesoderm via microinjections or a dermapen.') ?>
								</li>
								...
								<li><?= __t('Targeted Action: The personalized cocktail can be formulated to address specific') ?>
								</li>
							</ul>
							<h3><?= __t('A Treatment Tailored for All Skin Types') ?></h3>
							<p><?= __t('Mesotherapy for Face is a versatile treatment suitable for most skin types:') ?>
							</p>
							<ul>
								<li><?= __t('Addressing Concerns: Whether you\'re looking to combat fine lines, wrinkles, uneven skin tone, or simply want to promote overall skin health, mesotherapy can be customized to address your unique needs.') ?>
								</li>
								<li><?= __t('Gentle Approach: Mesotherapy offers a minimally invasive approach to facial rejuvenation, making it suitable for those with sensitive skin.') ?>
								</li>
							</ul>
							<h3><?= __t('The Perfect Synergy: Mesotherapy and HydraFacial') ?></h3>
							<p><?= __t('For an even more comprehensive approach to facial rejuvenation, consider combining Mesotherapy for Face with a HydraFacial treatment:') ?>
							</p>
							<ul>
								<li><?= __t('Deep Nourishment and Exfoliation: Mesotherapy nourishes the skin from within, while HydraFacial gently exfoliates and hydrates the surface layer.') ?>
								</li>
