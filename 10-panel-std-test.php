...
<head>
	...
	<meta name="description" content="<?= __t('Get comprehensive 10 Panel STD testing in Dubai at Cosmocare Medical Center. Confidential, accurate, and reliable STD tests with expert care. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('10 Panel STD Test Dubai, STD testing Dubai, HIV test Dubai, Herpes test Dubai, Syphilis test Dubai, Gonorrhea test Dubai, Chlamydia test Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('10 Panel STD Test in Dubai | Rapid and Accurate STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive 10 Panel STD Screening') ?></li>
										<li><?= __t('Rapid and Accurate HIV Testing') ?></li>
										<li><?= __t('Herpes, Syphilis, Gonorrhea, and Chlamydia Tests') ?></li>
										<li><?= __t('Confidential and Same-Day Test Results') ?></li>
										<li><?= __t('Expert Consultation and Treatment Guidance') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Expert in 10 Panel STD Testing and Treatments') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('STD specialist') ?></b> <?= __t('at Cosmocare Medical Center Dubai. With extensive experience in dermatology, he provides comprehensive solutions for a wide range of') ?> <b><?= __t('sexually transmitted infections') ?></b><?= __t(', including HIV, Herpes, Syphilis, Gonorrhea, Chlamydia, and other conditions covered in a 10 Panel STD test. Dr. Murtuza ensures every patient receives a personalized, confidential, and accurate testing experience.') ?></p>
						<p><?= __t('At Cosmocare Medical Center, Dr. Murtuza Bandukwala focuses on accurate diagnosis, rapid results, and effective treatment plans. His expertise in 10 Panel STD testing, along with compassionate patient care, ensures safe, reliable, and professional services for individuals seeking trusted') ?> <b><?= __t('STD testing and treatment in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('10 Panel STD Testing & Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/10-panel-std-test-dubai.jpg" class="img-fluid" alt="10 Panel STD Testing and Expert STD Care in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/10-panel-std-test-dubai1.webp" class="img-fluid" alt="10 Panel STD Testing and Expert STD Care in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/10-panel-std-test-dubai2.jpg" class="img-fluid" alt="10 Panel STD Testing and Expert STD Care in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('I was concerned about potential sexually transmitted infections and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('The 10 Panel STD testing and consultation were handled with professionalism and confidentiality.') ?> <b><?= __t('Dr. Murtuza') ?></b> <?= __t('explained every step clearly, ensured accurate results, and provided expert guidance for treatment. I\'m truly grateful for his expertise and the reliable, discreet care I received.') ?></p>
							</div>
						</div>
