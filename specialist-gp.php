...
<head>
	...
	<meta name="description" content="<?= __t('Dr. Mubina Tankiwala general and Cosmetic dentist and working as general dentist since then she has extensive experience in preventive, restorative, and Aesthetic Dentistry. Passionate about creating beautiful smiles, Dr. Samhita has a multidisciplinary experience of over 25 years, with over 10 years’ experience in Dubai. /') ?>">
	<meta name="keywords" content="<?= __t('cosmetic dentist, general dentist, fillings, veneers, Zoom Whitening, Extractions/') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center') ?>">
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title><?= __t('👍 GP Specialist, General Practitioner in Dubai Dr. Mubina Tankiwala - Cosmocare Medical Center') ?> </title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					<div class="col-md">
						<div class="doctor-page-photo text-center">
							<img src="images/content/doctor-09.jpg" class="img-fluid" alt="GP Specialist, General Practitioner in Dubai Dr. Mubina Tankiwala - Cosmocare Medical Center ">
						</div>
						...
						<table class="table doctor-page-table">
							...
							<tr>
								<td><?= __t('Degrees') ?></td>
								<td><?= __t('She passed out from the prestigious Govt.Dental College and Hospital, Mumbai India in 1992') ?></td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								<h3><?= __t('Dr. Mubina Tankiwala') ?></h3>
								<h6><?= __t('General Practitioner') ?></h6>
							</div>
						...
						<p></p><?= __t('>Dr. Mubina is a very friendly General Practitioner, a natural leader with problem solving ability and commitment to excellence. She makes patients very comfortable. She comes with a good academic, and clinical background and clinical experience for the last 11 plus years. She has a multidisciplinary experience in Dubai.') ?></p>
						<p>
							<?= __t('She does all procedures along with routine treatments-') ?>
						</p>
						<ul class="marker-list-md">
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Smile For Your Health!'),
			'link' => '/',
			'date' => 'August 22, 2020'
		],
		[
