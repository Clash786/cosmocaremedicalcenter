...
<head>
	...
	<meta name="description" content="<?= __t('Consult a top Dermatologist Specialist in Dubai at Cosmocare Medical Center. Expert treatments for acne, pigmentation, skin care, mole removal, anti-aging, and hair loss. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dermatologist Specialist Dubai, Skin specialist Dubai, Acne treatment Dubai, Pigmentation treatment Dubai, Mole removal Dubai, Anti-aging treatment Dubai, Hair loss treatment Dubai, Cosmetic dermatology Dubai, Skin clinic Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('Top Dermatologist Specialist in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
			...
			<div class="container mt-6">
				<div class="row">
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Skin Cancer Screening and Diagnosis') ?></li>
										<li><?= __t('Mole, Wart, and Lesion Evaluation') ?></li>
										<li><?= __t('Dermatologic Surgery and Minor Skin Procedures') ?></li>
										<li><?= __t('Laser and Cryotherapy Treatments') ?></li>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Dermatologist Specialist') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He provides expert care for a wide range of skin, hair, and nail conditions, with special focus on acne, pigmentation, anti-aging, and advanced laser treatments. Over the years, Dr. Murtuza has helped countless patients achieve healthier, clearer, and more radiant skin through personalized, evidence-based solutions.') ?></p>
						<p><?= __t('Committed to continuous learning,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('stays updated with the latest advancements in dermatology and aesthetic medicine. He believes that effective dermatology is not just about improving appearance but also about restoring confidence and enhancing overall well-being. His compassionate approach and dedication to excellence make him one of the most trusted dermatologists in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Dermatology Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/dermatologist.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/dermatologist1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/dermatologist2.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to patient care,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "') ?><strong><?= __t('Seeing improvements in my patients\' skin') ?></strong> <?= __t('is incredibly rewarding. Even small changes can significantly boost their') ?> <strong><?= __t('confidence and overall well-being') ?></strong><?= __t('. Helping people feel comfortable and confident in their own skin is what motivates me every day."') ?></p>
							</div>
						</div>
