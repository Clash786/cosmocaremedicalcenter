...
<head>
	...
	<meta name="description" content="<?= __t('Consult the best skin allergy doctor in Dubai at Cosmocare Medical Center. Expert diagnosis and treatment for eczema, rashes, hives, and allergic skin reactions. Book an appointment with our experienced dermatologists. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Skin allergy doctor Dubai, Allergy dermatologist Dubai, Eczema treatment Dubai, Hives treatment Dubai, Skin rash doctor Dubai, Allergic skin reaction Dubai, Dermatologist Dubai, Skin clinic Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Skin Allergy Doctor in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Diagnosis and Treatment of Skin Allergies') ?></li>
										<li><?= __t('Eczema, Dermatitis, and Psoriasis Management') ?></li>
										<li><?= __t('Hives and Itchy Skin Relief Treatments') ?></li>
										<li><?= __t('Patch Testing for Allergic Reactions') ?></li>
										<li><?= __t('Customized Skincare for Sensitive Skin') ?></li>
										<li><?= __t('Allergy-Related Rashes and Redness Treatment') ?></li>
										<li><?= __t('Consultation with Expert Skin Allergy Doctor in Dubai') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Allergy Specialist in Dubai') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified dermatologist and one of the leading') ?> <b><?= __t('skin allergy specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in dermatology and allergy management, he provides expert diagnosis and treatment for conditions such as eczema, dermatitis, hives, and allergic skin reactions. Dr. Murtuza is dedicated to helping patients achieve healthy, irritation-free') ?> <b><?= __t('skin') ?></b> <?= __t('through advanced allergy testing and personalized treatment plans.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines medical expertise with compassionate care to address a wide range of') ?> <b><?= __t('skin allergy concerns') ?></b><?= __t('. His approach focuses on identifying the underlying causes of allergic reactions and offering safe, effective, and long-term relief. Patients trust him as one of the most reliable') ?> <b><?= __t('skin allergy doctors') ?></b> <?= __t('in Dubai for comprehensive and results-oriented care.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Allergy Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/skin-allergy-doctor-dubai.jpg" class="img-fluid" alt="Expert Skin Allergy Doctor and Treatment in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-allergy-doctor-dubai3.jpg" class="img-fluid" alt="Expert Skin Allergy Doctor and Treatment in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-allergy-doctor-dubai2.jpg" class="img-fluid" alt="Expert Skin Allergy Doctor and Treatment in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been dealing with recurring rashes and skin allergies for a long time, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', my skin finally started to heal. His diagnosis was accurate, and the treatment plan he provided gave me lasting relief from itching and redness. I truly appreciate his expertise and care  my skin feels calm, healthy, and allergy-free now."') ?></p>
							</div>
						</div>
