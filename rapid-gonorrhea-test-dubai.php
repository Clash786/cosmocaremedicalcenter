...
<head>
	...
	<meta name="description" content="<?= __t('Get a confidential and accurate Rapid Gonorrhea Test in Dubai at Cosmocare Medical Center. Same-day STD testing with quick results, complete privacy, and professional medical care. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Rapid Gonorrhea Test Dubai, STD testing Dubai, Same-day STD test Dubai, Confidential Gonorrhea test Dubai, Sexual health clinic Dubai, STD clinic Dubai, Gonorrhea screening Dubai, STD doctor Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Rapid Gonorrhea Test in Dubai | Same-Day STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
			...
			<div class="container mt-6">
				<div class="row">
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Rapid Gonorrhea Test with Same-Day Results') ?></li>
										<li><?= __t('Comprehensive STD Screening and Diagnosis') ?></li>
										<li><?= __t('Confidential and Discreet Testing Environment') ?></li>
										<li><?= __t('Professional Consultation and Treatment Options') ?></li>
										<li><?= __t('Accurate Laboratory Testing with Quick Turnaround') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						...
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', our experienced general physicians and laboratory experts provide fast and confidential') ?> <b><?= __t('Rapid Gonorrhea Testing') ?></b> <?= __t('in Dubai. Using advanced diagnostic methods, we deliver accurate same-day results in a safe, private, and professional environment. Whether for routine screening or symptom-based testing, our goal is to ensure your comfort and peace of mind.') ?></p>
						<p><?= __t('Our dedicated medical team focuses on early detection and effective management of sexually transmitted infections. The') ?> <b><?= __t('Rapid Gonorrhea Test') ?></b> <?= __t('at Cosmocare Medical Center allows patients to receive timely results and appropriate treatment recommendations. We prioritize your health, privacy, and confidentiality at every step of the testing process.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD Testing & Rapid Gonorrhea Screening at') ?> <span class="theme-color text-nowrap"><?= __t('Cosmocare Medical Center') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/rapid-gonorrhea-test-dubai.jpg" class="img-fluid" alt="Confidential Rapid Gonorrhea Test in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/rapid-gonorrhea-test-dubai1.jpg" class="img-fluid" alt="Confidential Rapid Gonorrhea Test in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/rapid-gonorrhea-test-dubai2.jpg" class="img-fluid" alt="Confidential Rapid Gonorrhea Test in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was really nervous about getting tested, but the staff at') ?> <b><?= __t('Cosmocare Medical Center') ?></b> <?= __t('made me feel completely comfortable. The') ?> <b><?= __t('Rapid Gonorrhea Test') ?></b> <?= __t('was quick, confidential, and I received my results the same day. Their professionalism and respect for privacy truly helped ease my anxiety. I highly recommend Cosmocare for anyone looking for reliable and discreet') ?> <b><?= __t('STD testing in Dubai') ?></b>."</p>
							</div>
						</div>
