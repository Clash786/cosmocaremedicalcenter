...
<head>
	...
	<meta name="description" content="<?= __t('Get safe and effective Facial Wart Removal treatment at Cosmocare Medical Center Dubai. Our expert dermatologists provide advanced care for facial skin concerns using the latest techniques. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Facial Wart Removal Dubai, Wart treatment Dubai, Dermatologist Dubai, Skin care Dubai, Cosmetic Skin Clinic Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Facial Wart Removal Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
			...
			<div class="container mt-6">
				<div class="row">
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Dermatologist & Skin Care Specialist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Acne and Pigmentation Treatments') ?></li>
										<li><?= __t('Mole, Skin Lesion, and Facial Wart Removal') ?></li>
										<li><?= __t('Anti-Aging and Skin Rejuvenation') ?></li>
										<li><?= __t('Laser Therapies for Skin Conditions') ?></li>
										<li><?= __t('PRP Therapy for Skin Rejuvenation') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-3">
							<div class="doctor-info-name">
								<h4><?= __t('Dr. Murtuza Bandukwala') ?></h4>
								<h6><?= __t('Consultant Dermatologist & Skin Care Specialist Facial Wart Removal') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading skin care specialists at') ?> <b><?= __t('Cosmocare Medical Center Dubai') ?></b><?= __t('. With over two decades of experience in dermatology, he offers advanced solutions for a wide range of skin concerns, including acne, pigmentation, mole and') ?> <b><?= __t('facial wart removal') ?></b><?= __t(', and anti-aging treatments. His expertise includes') ?> <b><?= __t('laser therapies for facial warts') ?></b><?= __t(', PRP for skin rejuvenation, chemical peels, and non-surgical cosmetic procedures. Dr. Murtuza believes that every patient at Cosmocare Medical Center deserves a customized approach to achieve healthy, radiant skin.') ?></p>
						<p><?= __t('As part of the expert team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the root causes of skin issues, including hormonal changes, environmental factors, and lifestyle. He combines modern medical techniques with compassionate patient care to ensure safe and long-lasting results. His commitment to continuous learning and innovation keeps Cosmocare Medical Center at the forefront of dermatology and cosmetic skin care in Dubai, specializing in') ?> <
								<div class="mt-4 mt-lg-6">
					</div>
					<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
						<h5 class="collapse-title"><?= __t('Facial Wart Removal & Skin Care Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
					...
					<div id="tab1" class="collapse show">
						<div class="pb-4 pb-lg-6">
							<div class="row row-sm-space pt-2">
								<div class="col-sm-4"> <img src="images/content/facial-wart-removal-dubai.jpg" class="img-fluid" alt="Facial Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
								<div class="col-sm-4"> <img src="images/content/facial-wart-removal-dubai1.jpg" class="img-fluid" alt="Facial Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
								<div class="col-sm-4"> <img src="images/content/facial-wart-removal-dubai2.jpg" class="img-fluid" alt="Facial Wart Removal Specialist in Dubai at Cosmocare Medical Center"></div>
							</div>
						</div>
					</div>
					...
					<div id="tab2" class="collapse show">
						<div class="pb-4">
							...
							<p><?= __t('"I had been struggling with stubborn facial warts for years, but after visiting Dr. Murtuza Bandukwala at Cosmocare Medical Center for Facial Wart Removal, I started noticing visible improvements in just a few sessions. He truly understands how to treat skin conditions effectively and helped me regain my confidence."') ?></p>
						</div>
					</div>
