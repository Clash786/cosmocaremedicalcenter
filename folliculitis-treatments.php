...
<head>
	...
	<meta name="description" content="<?= __t('Expert treatment for folliculitis and inflamed hair follicles in Dubai at Cosmocare Medical Center. Consult Dr. Murtuza Bandukwala for safe and effective solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Folliculitis treatment Dubai, Hair follicle infection Dubai, Dermatologist Dubai, Skin specialist Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('Folliculitis Treatment in Dubai | Expert Dermatologist at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Diagnosis and Treatment of Folliculitis') ?></li>
										<li><?= __t('Inflamed and Infected Hair Follicle Management') ?></li>
										<li><?= __t('Medical and Topical Therapies for Follicle Health') ?></li>
										<li><?= __t('Laser and Non-Surgical Treatments for Recurrent Folliculitis') ?></li>
										<li><?= __t('Comprehensive Hair and Scalp Health Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Hair & Scalp Specialist Dermatologist') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a leading') ?> <strong><?= __t('Hair and Scalp Specialist Dermatologist') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t(', with extensive expertise in diagnosing and treating folliculitis, inflamed hair follicles, and recurrent scalp infections. He provides advanced medical and laser treatments to restore healthier hair and scalp conditions.') ?></p>
						<p><?= __t('Committed to staying updated with the latest advancements in hair and scalp care,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('combines professional precision with compassionate care, helping patients achieve lasting relief, optimal scalp health, and renewed confidence.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Folliculitis & Scalp Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/olliculitis-treatments1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Hair & Scalp Specialist Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/olliculitis-treatments2.webp" class="img-fluid" alt="Dr. Murtuza Bandukwala - Hair & Scalp Specialist Dermatologist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('finds treating folliculitis and scalp conditions deeply rewarding. He says, "Even a small improvement in a patient\'s hair or scalp health can significantly boost their confidence and comfort. Helping people feel confident in their own skin and hair is what motivates me every day."') ?></p>
							</div>
						</div>
