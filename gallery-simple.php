				...
				<div class="gallery-wrap">
					...
					<div class="gallery-smiles gallery-isotope" id="gallery">
						<div class="gallery-item category2 category7">
							...
							<div class="after-label"><?= __t('After') ?></div>
							<div class="before-label"><?= __t('Before') ?></div>
							<div class="gallery-caption">
								<h5><?= __t('Braces') ?></h5>
								<p><?= __t('This patients\' teeth were corrected and straightened with almost invisible clear aligners.') ?></p>
								<p><?= __t('Dentist:') ?> <b><?= __t('Dr. Gerald Gleaves') ?></b></p>
							</div>
						</div>
						<div class="gallery-item category1 category5 category8">
							...
							<div class="before-label"><?= __t('Before') ?></div>
							<div class="gallery-caption">
								<h5><?= __t('Hygiene Therapy') ?></h5>
								<p><?= __t('Our \'stain removal\' treatment removed years of discolouration from tea, coffee and tobacco.') ?></p>
								<p><?= __t('Dentist:') ?> <b><?= __t('Dr. Pamela Knaack') ?></b></p>
							</div>
						</div>
