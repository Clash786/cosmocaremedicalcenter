...
<head>
	...
	<meta name="description" content="<?= __t('Your modern dental clinic at 2nd December Street, Dubai. Cosmocare Medical Center | Orthodontics✓ Children&#039;s dentist✓ Implantology✓ Dental aesthetics✓ ☎ 043798747') ?>" />
	<meta name="keywords" content="<?= __t('dentistry, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="author" content="<?= __t('Cosmocare Medical Center') ?>">
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title><?= __t('Dentistry | Best Dental Clinic in Dubai by Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('YOUR DENTIST IN Dubai') ?></h1>
							<h2><?= __t('A WARM WELCOME') ?></h2>
						</div>
						<div class="service-img">
							<img src="images/dentistry-dubai.svg" width="100%" class="img-fluid" alt="Dental Clinic in Dubai and dentist specialist Doctor in Dubai by Cosmocare Medical Center">
						</div>
						<p><?= __t('we are waiting for you in our modern dental practice Cosmcoare in Dubai, UAE. Our wide-ranging spectrum of treatments is geared towards people who are health-conscious in considering their own and their families\' health and would like to make use of the options modern dentistry provides.') ?></p>
