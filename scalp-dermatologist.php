...
<head>
	...
	<meta name="description" content="<?= __t('Consult a Scalp Specialist Dermatologist in Dubai at Cosmocare Medical Center. Expert hair and scalp treatments for hair loss, dandruff, alopecia, and other scalp conditions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Scalp dermatologist Dubai, hair specialist Dubai, hair loss treatment Dubai, scalp treatment Dubai, alopecia treatment Dubai, dandruff treatment Dubai, Cosmocare Medical Center, hair clinic Dubai') ?>">
	...
	<title><?= __t('Scalp Specialist Dermatologist in Dubai | Hair & Scalp Treatments - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive Scalp and Hair Health Assessment') ?></li>
										<li><?= __t('Diagnosis and Treatment of Hair Loss, Alopecia, and Dandruff') ?></li>
										<li><?= __t('Medical and Surgical Hair Restoration Options') ?></li>
										<li><?= __t('Advanced Scalp Treatments and PRP Therapy') ?></li>
										<li><?= __t('Personalized Hair Care and Preventive Solutions') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist Scalp & Hair Dermatologist') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist Scalp & Hair Dermatologist') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He specializes in diagnosing and treating a wide range of hair and scalp conditions, including hair loss, dandruff, alopecia, and other scalp disorders. Using advanced and evidence-based treatments, Dr. Murtuza helps patients achieve healthier, stronger, and fuller hair.') ?></p>
						<p><?= __t('Committed to continuous learning and innovation,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('stays updated with the latest advancements in hair and scalp care. He believes that restoring scalp health not only improves appearance but also boosts confidence and overall well-being. His expert and compassionate approach makes him one of the most trusted scalp and hair specialists in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Scalp & Hair Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/scalp-dermatologist-dubai.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Scalp & Hair Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/scalp-dermatologist-dubai1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Scalp & Hair Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/scalp-dermatologist-dubai2.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Scalp & Hair Dermatologist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to hair and scalp care,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "Restoring scalp health and treating hair concerns is deeply rewarding. Even a small improvement in hair growth or scalp condition can greatly boost a patient\'s confidence and overall well-being. Helping people feel confident and comfortable with their hair motivates me every day."') ?></p>
							</div>
						</div>
