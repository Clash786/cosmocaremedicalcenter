...
<head>
	...
	<meta name="description" content="<?= __t('In Cosmocare Medical Center, the Physiotherapy Department is equipped with state-of the art facilities to provide treatment to our patients conforming to the highest standards.') ?>" />
	<meta name="keywords" content="<?= __t('Physiotherapy Clinic in Dubai, Physiotherapy, Physiotherapy Treatment dubai, Physiotherapy specialist') ?>" />
	...
	<title><?= __t('Physiotherapy Clinic in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					<div class="col-md">
						<ul class="services-nav flex-column flex-nowrap">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu9">
									<ul class="flex-column nav">
										<li class="nav-item"><a class="nav-link active" href="physiotherapy.html"><?= __t('Physiotherapy') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Physiotherapy Clinic in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/physiotherapy_clinic_in_dubai.svg" width="100%" class="img-fluid" alt="physiotherapy clinic in dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('In Cosmocare Medical Center, the Physiotherapy Department is equipped with state-of the art facilities to provide treatment to our patients conforming to the highest standards. Our Physiotherapy Department emphasizes on the patient’s day-to-day functioning and enhancing their quality of life. Our goal is to design a unique programme for recovery, health and wellness that fits each patient’s needs.') ?></p>
							<p>
								<?= __t('Physiotherapy aims to help you to optimize your mobility, function and independence. Patient education being such an important part of delivering medical and service excellence, the department incorporate patient education in the daily rehabilitation of patients.') ?>
							</p>
							<p>
								<?= __t('Cosmocare Medical Center is a leading private clinic renowned for its quality care and compassion. We take a holistic approach to healthcare and acknowledge the uniqueness of every patient to create a healing environment that is second to none.') ?>
							</p>
