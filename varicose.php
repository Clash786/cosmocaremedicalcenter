...
<head>
	...
	<meta name="description" content="<?= __t('Medical treatment for varicose veins may not be necessary if there are no symptoms, but surgical and nonsurgical approaches are available. Find out here from Cosmocare Medical Center about the general information and conditions of a varicose veins surgery.') ?>" />
	<meta name="keywords" content="<?= __t('Varicose Veins Treatment in dubai, Varicose Veins surgery in dubai, circumcision surgery, Varicose Veins specialist surgeon in dubai') ?>" />
	...
	<title><?= __t('Varicose Veins Treatment / Surgery in Dubai | Varicose Veins Specialist Surgeon by Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu4">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="varicose.html"><?= __t('Varicose Vein') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Varicose Veins Surgery / Treatment in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/varicose-veins.svg" width="100%" class="img-fluid" alt="Varicose Veins Surgery / Treatment | Varicose Veins  Specialist Surgeon in Dubai by Cosmocare Medical Center">
						</div>
						<div class="pt-2 pt-md-4">
							<h2><?= __t('Varicose veins surgery with Cosmocare Medical Center') ?></h2>
							<p><?= __t('Here at Cosmocare Medical Center, our skilled and experienced surgeons regularly perform Varicose veins surgery.') ?></p>
