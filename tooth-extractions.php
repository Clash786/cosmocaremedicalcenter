...
<head>
	...
	<meta name="description" content="<?= __t('cosmocare medical center Dental Clinic offers affordable Tooth Extraction in Dubai. Your modern dental clinic at 2nd December Street, Dubai. Cosmocare Medical Center | Orthodontics✓ Children&#039;s dentist✓ Implantology✓ Dental aesthetics✓ ☎ 043798747') ?>" />
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Tooth Extraction in Dubai') ?></h1>
						</div>
						<h3><?= __t('What is a tooth extraction?') ?><img src="images/tooth-extraction.jpg" alt="A tooth extraction may be necessary for many reasons, including severe damage or decay."></h3>
						<p><?= __t('A tooth extraction is a dental procedure during which your tooth is completely removed from its socket. Sometimes, people refer to this as   “pulling" a tooth.') ?></p>
						<h3><?= __t('When is tooth extraction recommended?') ?></h3>
						<p><?= __t('Healthcare providers prefer to save natural teeth whenever possible. But sometimes, other restorative methods — such as dental fillings or dental crowns — aren’t enough. If your tooth has been badly damaged past the point of repair, then removal may be necessary. Your dentist may recommend tooth extraction if you have:') ?></p>
						<ul data-identity="unordered-list">
							<li><?= __t('Severe tooth decay (cavities).') ?></li>
							<li><?= __t('A fractured tooth.') ?></li>
							<li><?= __t('An impacted tooth.') ?></li>
							<li><?= __t('Crowded teeth.') ?></li>
							<li><?= __t('Severe gum disease.') ?></li>
							<li><?= __t('Tooth luxation or other dental injuries.') ?></li>
						</ul>
						<h3 data-identity="headline"><?= __t('Who performs tooth extraction?') ?></h3>
						<p data-identity="paragraph-element"><?= __t('Our dental specialists can perform tooth extractions. While general dentist perform plenty of extractions, more complex cases are usually referred out to oral   surgeons or periodontists.') ?></p>
						<div class="service-img">
							<a href="scaling-polishing.php"><img src="images/teeth-scaling-polishing.svg" alt="Tooth Extraction in Dubai and tooth extraction in Dubai by Cosmocare Medical Center" width="100%" border="0" class="img-fluid"></a>
						</div>
						<div>
