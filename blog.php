...
<head>
	...
	<meta name="description" content="<?= __t('Latest Updates for Cosmocare Medical Center & Dermatology Clinic') ?>">
	...
	<title><?= __t('Blog - Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
						...
						<div class="blog-posts">
							<div class="blog-post">
								<div class="blog-post-info">
									...
									<div>
										<h2 class="post-title"><a
												href="piles-hernia-doctor.html"><?= __t('New Doctor On Our Panel') ?></a>
										</h2>
										<div class="post-meta">
								...
								<div class="post-image">
									<a href="piles-hernia-doctor.html"><img src="images/content/news-01.jpg" alt=""></a>
								</div>
								<div class="post-teaser">
									<?= __t('We welcome Dr Mutaza  Pithawala, specialist General Surgeon at our clinic.  He is well known name and a top rated surgeon of Dubai, famous[…]') ?>
								</div>
								<div class="mt-3 mt-lg-4"><a href="piles-hernia-doctor.html"
										class="btn btn-sm btn-hover-fill"><i
