...
<head>
	...
	<meta name="description" content="<?= __t('Looking for the best skin specialist doctor in Dubai? Visit Cosmocare Medical Center for expert dermatology care, treating acne, pigmentation, eczema, allergies, and other skin conditions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Skin specialist doctor Dubai, Best dermatologist Dubai, Skin doctor Dubai, Acne treatment Dubai, Pigmentation treatment Dubai, Eczema treatment Dubai, Skin allergy doctor Dubai, Cosmetic dermatology Dubai, Skin clinic Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Skin Specialist Doctor in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							...
							<tr>
								...
								<td><?= __t('Dermatologist & Skin Specialist Doctor') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Specialist Doctor') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a highly experienced') ?> <b><?= __t('skin care specialist in Dubai') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', known for providing advanced dermatological treatments for all types of') ?> <b><?= __t('skin conditions') ?></b><?= __t('. He offers personalized care for concerns like') ?> <b><?= __t('acne, pigmentation, scars, anti-aging, and skin rejuvenation') ?></b><?= __t('. Using state-of-the-art technology and proven medical techniques, Dr. Murtuza helps patients achieve smoother, clearer, and healthier skin that enhances their natural beauty.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center Dubai') ?></b><?= __t(', Dr. Murtuza Bandukwala combines science with aesthetics to deliver exceptional results. His patient-centered approach focuses on understanding individual') ?> <b><?= __t('skin types') ?></b> <?= __t('and recommending the most effective treatment plans for long-lasting improvement. Whether you\'re struggling with chronic acne, uneven skin tone, or dull skin, Dr. Murtuza ensures safe, customized, and result-driven dermatology solutions tailored just for you.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/skin-care-specialist-dubai.jpg" class="img-fluid" alt="Expert Skin Care Treatments in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-care-specialist-dubai1.jpg" class="img-fluid" alt="Expert Skin Care Treatments in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/skin-care-specialist-dubai2.jpg" class="img-fluid" alt="Expert Skin Care Treatments in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with acne and pigmentation issues for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a remarkable improvement in my skin within a few sessions. He truly understands how to treat various') ?> <b><?= __t('skin concerns') ?></b> <?= __t('effectively and helped me regain my confidence with healthy, radiant skin. I highly recommend him to anyone looking for the best') ?> <b><?= __t('skin specialist in Dubai') ?></b><?= __t('."') ?></p>
							</div>
						</div>
