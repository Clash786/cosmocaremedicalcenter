...
<head>
	...
	<meta name="description" content="<?= __t('Get accurate and confidential Trichomoniasis testing in Dubai at Cosmocare Medical Center. Our expert doctors provide reliable STD testing, diagnosis, and effective treatment in a safe and private environment. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Trichomoniasis test Dubai, STD test Dubai, STI screening Dubai, Trichomoniasis treatment Dubai, Sexual health clinic Dubai, Cosmocare Medical Center, Private STD testing Dubai, Vaginal infection test Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Test for Trichomoniasis in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
			...
			<div class="container mt-6">
				<div class="row">
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Confidential Trichomoniasis Testing') ?></li>
										<li><?= __t('Comprehensive STD & STI Screening') ?></li>
										<li><?= __t('Accurate Diagnosis and Lab Analysis') ?></li>
										<li><?= __t('Effective Treatment and Medical Advice') ?></li>
										<li><?= __t('Private Consultations with Expert Doctors') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						...
						<p><?= __t('At Cosmocare Medical Center Dubai, our experienced physicians provide confidential and accurate') ?> <b><?= __t('Trichomoniasis testing') ?></b> <?= __t('and treatment services. Using advanced laboratory diagnostics, we ensure quick and reliable results to help detect infections early and begin effective treatment promptly.') ?></p>
						<p><?= __t('Our doctors maintain complete privacy for every patient and offer comprehensive') ?> <b><?= __t('STD screening') ?></b> <?= __t('options to ensure your sexual health and overall well-being. Cosmocare Medical Center is committed to providing safe, non-judgmental, and professional medical care for all patients seeking') ?> <b><?= __t('STD checkups in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Trichomoniasis Testing & Treatment by') ?> <span class="theme-color text-nowrap"><?= __t('Cosmocare Medical Center Dubai') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test.jpg" class="img-fluid" alt="Confidential Trichomoniasis Test in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test1.jpg" class="img-fluid" alt="Confidential Trichomoniasis Test in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test2.jpg" class="img-fluid" alt="Confidential Trichomoniasis Test in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was anxious about getting tested for Trichomoniasis, but the team at Cosmocare Medical Center made the entire process so comfortable and confidential. The doctors were supportive and explained everything clearly. I received my results quickly and started treatment right away. I truly appreciate their professionalism and care."') ?></p>
							</div>
						</div>
