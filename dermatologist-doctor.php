...
<head>
	...
	<meta name="description" content="<?= __t('Consult Dr. Murtuza Bandukwala, a leading dermatologist in Dubai at Cosmocare Medical Center. Expert in skin care, acne, pigmentation, mole removal, anti-aging, and cosmetic dermatology treatments. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dermatologist Dubai, Skin Care Specialist Dubai, Acne Treatment Dubai, Mole Removal Dubai, Pigmentation Treatment Dubai, Cosmetic Dermatology Dubai, Anti-Aging Treatment Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dermatologist in Dubai | Expert Skin Care & Cosmetic Treatments at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Comprehensive Dermatologic and Cosmetic Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Expert in Skin Care and Cosmetic Treatments') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('skin care specialist') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in dermatology, he provides advanced solutions for a wide range of') ?> <b><?= __t('skin concerns') ?></b><?= __t(', including acne, pigmentation, mole removal, anti-aging treatments, and overall skin rejuvenation. Dr. Murtuza ensures personalized care, safe procedures, and effective results for every patient seeking healthy and radiant skin.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the root causes of') ?> <b><?= __t('skin problems') ?></b> <?= __t('and designing treatment plans that combine modern dermatology techniques with compassionate patient care. His expertise in cosmetic and medical dermatology ensures accurate diagnosis, safe care, and optimal skin health for those seeking trusted dermatology services in Dubai.') ?></p>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/dermatologist-dubai.jpg" class="img-fluid" alt="Expert Dermatology and Skin Care Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/dermatologist-dubai1.webp" class="img-fluid" alt="Expert Dermatology and Skin Care Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/dermatologist-dubai2.jpg" class="img-fluid" alt="Expert Dermatology and Skin Care Treatments in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with persistent skin issues and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. The consultation and treatment were handled with exceptional care and professionalism.') ?> <b><?= __t('Dr. Murtuza') ?></b> <?= __t('explained every step clearly, ensured I felt comfortable, and provided a personalized treatment plan. I am truly grateful for his expertise and the visible improvements in my skin."') ?></p>
							</div>
						</div>
