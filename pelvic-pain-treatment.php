...
<head>
	...
	<meta name="description" content="<?= __t('To figure out what\'s causing your chronic pelvic pain, Our gynecologist specialist asks you about your symptoms. To schedule an appointment for Chronic Pelvic Pain? Please call at') ?> <?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) /') ?> <?php include 'price.php'; echo "$contactjum"; ?> <?= __t('(Jumeirah 2) for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('Chronic Pelvic Pain') ?>, <?php include 'price.php'; echo "$company"; ?>, <?= __t('cosmocare, testing, treatment, dubai, treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="author" content="<?php include 'price.php'; echo "$company"; ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title>[<?php include 'price.php'; echo "$gynecon"; ?><?= __t(']  Chronic Pelvic Pain treatment in Dubai? Specialist Gynecologist') ?> <?php include 'price.php'; echo "$company"; ?></title>
	<!-- Stylesheets -->
			...
			<div class="breadcrumbs-wrap">
				<div class="container">
					<div class="breadcrumbs">
						...
						<?= __t('Chronic Pelvic Pain - Diagnosis and treatment - Cosmocare') ?>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
							<div class="title-wrap">
								<h1><?= __t(' Chronic Pelvic Pain - Diagnosis and treatment - Cosmocare') ?></h1>
								<p><?= __t('To figure out what\'s causing your chronic pelvic pain, Our gynecologist specialist asks you about your symptoms. You\'ll also answer questions about health conditions that you and your blood relatives, such as parents and siblings, have had over the years.') ?>
								</p>
								<h2><?= __t('Treatment') ?></h2>
								<p><?= __t('With chronic pelvic pain, the goal of treatment is to ease symptoms and make your quality of life better.') ?>
								</p>
								<p><?= __t('Our gynecologist specialist can find a specific cause, treatment   focuses on that cause. If a cause can\'t be found, the focus of treatment   is to manage pain and other symptoms. You may need more than one   treatment.') ?>
								</p>
								<h3><?= __t('Medications') ?></h3>
								<p><?= __t('Depending on the cause, certain medicines may be used to treat chronic pelvic pain, such as:') ?>
								</p>
								<ul>
									<li><strong><?= __t('Pain relievers.') ?></strong>
										<?= __t('Medicines that you can buy   without a prescription may ease some of your pain. These include   aspirin, ibuprofen (Advil, Motrin IB, others) and acetaminophen (Tylenol, others). Sometimes you may need a strong prescription pain   reliever. But pain medicine alone rarely gets rid of chronic pain.') ?>
									</li>
									<li><strong><?= __t('Hormone treatments.') ?></strong>
										<?= __t('Some people find that the   days when they have pelvic pain may overlap with a phase of their   period. When this is the case, birth control pills or other hormonal   medicines may help relieve pelvic pain.') ?>
									</li>
									<li><strong><?= __t('Antibiotics.') ?></strong>
										<?= __t('If an illness caused by bacteria is the source of your pain, you may need antibiotics.') ?>
									</li>
									<li><strong><?= __t('Antidepressants.') ?></strong>
										<?= __t('Some types of medicines that   treat depression also can be helpful for chronic pain. These include   tricyclic antidepressants, such as amitriptyline, nortriptyline   (Pamelor) and others. They also include serotonin norepinephrine   reuptake inhibitors, such as duloxetine (Cymbalta) and venlafaxine   (Effexor XR). They may help ease chronic pelvic pain even if you don\'t   have depression.') ?>
									</li>
									<li><strong><?= __t('Muscle relaxers.') ?></strong>
										<?= __t('Medicines such as cyclobenzaprine (Amrix) might help relax muscles linked with pelvic pain.') ?>
									</li>
								</ul>
								<img alt="Chronic Pelvic Pain - Diagnosis and treatment"
									src="images/chronic-pelvic-pain.svg" width="100%">
								<p><?= __t('&nbsp;') ?></p>
