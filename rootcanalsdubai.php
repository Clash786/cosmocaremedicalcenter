...
<head>
	...
	<meta name="description" content="<?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about') ?><?= __t($keyword) ?> <?= __t('with you. To schedule an appointment for') ?><?= __t($keyword) ?>? <?= __t('Please call at 04-3798747 or request an appointment online.') ?>">
	<meta name="keywords" content="<?= __t($keyword) ?>, <?= htmlspecialchars($company) ?>, <?= __t('dentures, cosmetic denture, treatment, dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>">
	<meta name="author" content="<?= htmlspecialchars($company) ?>">
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title>[<?= htmlspecialchars($dentaloffer) ?>] <?= __t('Looking for') ?> <?= __t($keyword) ?> <?= __t('in Dubai?') ?> <?= htmlspecialchars($company) ?></title>
	<!-- Stylesheets -->
				...
				<div class="row align-items-center">
					<div class="col-auto d-flex align-items-center">
						<div class="header-phone"><i class="icon-telephone"></i><a
								href="./../tel:04 379 8747"><?= __t('04 379 8747') ?></a></div>
						...
						<div class="header-info"><i class="icon-black-envelope"></i><a
								href="mailto:info@cosmocaremedicalcenter.com"><?= __t('info@cosmocaremedicalcenter.com') ?></a>
						</div>
					</div>
					...
					<div class="col-lg ml-auto header-nav-wrap">
						...
						<div class="header-search">
							<form action="#" class="form-inline">
								...
								<input type="text" placeholder="<?= __t('Search') ?>">
		...
		<div class="quickLinks js-quickLinks">
			<div class="container">
				<div class="row no-gutters">
					<div class="col">
						<a href="./../#" class="link">
							<i class="icon-placeholder"></i><span><?= __t('Location') ?></span>
						</a>
					...
					<div class="col">
						<a href="./../#" class="link">
							<i class="icon-emergency-call"></i><span><?= __t('Emergency Case') ?></span>
						</a>
						<div class="link-drop">
							...
							<ul class="icn-list">
								<li><i class="icon-telephone"></i><span
										class="phone"><?= __t('04 379 8747') ?><br><?= __t('050 373 4132') ?></span>
								</li>
					...
					<div class="col col-close"><a href="./../#" class="js-quickLinks-close"><i class="icon-top"
								data-toggle="tooltip" data-placement="top" title="<?= __t('Close panel') ?>"></i></a>
					</div>
				</div>
			</div>
			<div class="quickLinks-open js-quickLinks-open"><span data-toggle="tooltip" data-placement="left"
					title="<?= __t('Open panel') ?>">+</span></div>
		</div>
	</div>
	<!--//quick links-->
	<!--//header-->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link"
												href="./../fractional-laser.html"><?= __t('Fractional Laser') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
										...
										<li class="nav-item"><a class="nav-link"
												href="./../chemical-peeling.html"><?= __t('Chemical peeling') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu3">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link"
												href="./../herpes-treatment.html"><?= __t('Herpes Treatment') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu4">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link"
												href="./../hernia-treatment.html"><?= __t('Hernia Treatment') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu5">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link"
												href="./../cancer-screening.html"><?= __t('Cancer Screening') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= $keyword ?> <?= __t('Dubai |') ?> <?= htmlspecialchars($company) ?></h1>
							<p>
								<?= __t('Our doctors and staff at Cosmocare would be happy to discuss the details about') ?>
								<?= $keyword ?> <?= __t('with you. To schedule an appointment for') ?>
								<?= $keyword ?><?= __t('? Please call at 04-3798747 or request an appointment online. A denture or a complete denture as it is often called, is an appliance that is inserted in the mouth, replaces natural teeth, and provides support for the cheeks and lips.') ?>
							</p>
							<div class="service-img">
								<img src="images/root-canal-dubai.svg" width="100%" class="img-fluid"
									alt="<?= $keyword ?> dubai" />
							</div>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p>
									<?= __t('Dr. Lavanya/ Dr Samir and their staff at Cosmocare would be happy to discuss the details about') ?>
									<?= $keyword ?>
									<?= __t('with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?>
								</p>
								<p>
									<iframe alt="<?= $keyword ?> dubai" title="<?= $keyword ?> dubai"
			...
			<div class="row py-1 py-md-2 px-lg-0">
						...
						<div class="col-md">
							<div class="footer-text mt-1 mt-lg-2">
								<p><?= __t('To receive email releases, simply provide') ?>
									<br><?= __t('us with your email below') ?> </p>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="footer-post d-flex">
						...
						<div class="footer-post-text">
							<div class="footer-post-title"><a
									href="./../prp-therapy.html"><?= __t('PRP Therapy...') ?></a></div>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="h-decor"></div>
					<ul class="icn-list">
						<li><a href="https://maps.app.goo.gl/UnQLdp7uRi85HLP5A"><?= __t('Room# 07-08 1st Floor, Life Pharmacy') ?><br><?= __t('Building 2nd December Street, Al Satwa Roundabout') ?>
						...
						<li><i class="icon-telephone"></i><b><span class="phone"><span class="text-nowrap">04 379
										8747</span>, <span class="text-nowrap">050 373
										4132</span></span></b><br>(<?= __t('24/7 General inquiry') ?>)
						</li>
						<li><i class="icon-black-envelope"></i><a
				...
				<div class="row text-center text-md-left">
					<div class="col-sm"><?= __t('Copyright © 2010-2030') ?><a
						...
						<a href="http://www.dubaistdclinic.com/" target="_blank"
							title="std testing center"><?= __t('STD Clinicin Dubai') ?></a>
					</div>
					<div class="col-sm-auto ml-auto"><span class="d-none d-sm-inline"><a href="moh-license.pdf"
								target="_blank"><?= __t('MOH License #: RJRUI1TN-110225') ?></a>
							&nbsp;&nbsp;&nbsp;</span><i class="icon-telephone"></i>&nbsp;&nbsp;<b>04 379 8747</b></div>
				</div>
			</div>
		</div>
	</div>
