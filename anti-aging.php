...
<head>
	...
	<meta name="description" content="<?= __t('Discover non-invasive anti-aging, wrinkle reduction &amp; skin rejuvenation treatments. Contact us!.') ?>" />
	...
	<title><?= __t('Anti Aging in Dubai: Face Skin Rejuvenation: Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Anti Aging Treatment in Dubai: FACE SKIN REJUVENATION') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/acne.jpg" class="img-fluid" alt="acne treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('We all get them, and we all hate them. There are a number of products and procedures on the market today that help to smooth out unwanted lines, but most of them require the use of scary chemicals or even invasive surgery. Luckily, there is a way to achieve similar results to these traditional methods by using laser wrinkle reduction technology.') ?> <br>
								<strong><?= __t('What are Skin Treatments?') ?></strong> <br>
							</p>
							<div data-element-type="paragraph" id="1000850157"><?= __t('Laser wrinkle reduction is a fast, effective treatment to reduce the appearance of wrinkles. Using a yellow light laser, the procedure naturally stimulates the body’s own collagen to naturally replenish itself. This new collagen then naturally begins to gradually fill lines, wrinkles, and creases, allowing a more youthful you to shine through.') ?></div>
							<div><?= __t('At Cosmocare Medical Center, we offer the following:') ?></div>
							<div>
								<ul>
									<li><?= __t('Fractional non-ablative skin treatments') ?></li>
									<li><?= __t('IPL applications') ?></li>
									<li><?= __t('Pelleve® RF treatments (in package applications or individual treatments)') ?></li>
								</ul>
							</div>
