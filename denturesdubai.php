...
<head>
	...
	<meta name="description"content="<?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about') ?> <?php $_GET;$tourguide = $_GET['tourguide'];$tourguide = str_replace("-", " ", $tourguide);echo __t($tourguide); ?> <?= __t('with you. To schedule an appointment for') ?> <?php $_GET;$tourguide = $_GET['tourguide'];$tourguide = str_replace("-", " ", $tourguide);echo __t($tourguide); ?>? <?= __t('Please call at 04-3798747 or request an appointment online.') ?>" />
	<meta name="keywords"content="<?php $_GET;$tourguide = $_GET['tourguide'];$tourguide = str_replace("-", " ", $tourguide);echo __t($tourguide); ?> ,<?php include 'price.php';echo "$company"; ?>, <?= __t('dentures, cosmetic denture, treatment, dubai, treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title>[<?php include 'price.php';echo "$dentaloffer"; ?><?= __t('] ✅ Looking for') ?> <?php $_GET;$tourguide = $_GET['tourguide'];$tourguide = str_replace("-", " ", $tourguide);echo __t($tourguide); ?> <?= __t('in Dubai?') ?> <?php include 'price.php';echo __t("$company"); ?></title>
	<!-- Stylesheets -->
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-auto d-flex align-items-center">
						<div class="header-phone"><i class="icon-telephone"></i><a href="./../tel:04 379 8747">04 379
								8747</a></div>
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							$tourguide = str_replace("-", " ", $tourguide);
							echo __t($tourguide); ?> <?= __t('Dubai |') ?> <?php include 'price.php';
								  echo __t("$company"); ?></h1>
							<p><?= __t('Ours doctors and staff at Cosmocare would be happy to discuss the details about') ?> <?php $_GET;
							   $tourguide = $_GET['tourguide'];
							   $tourguide = str_replace("-", " ", $tourguide);
							   echo __t($tourguide); ?> <?= __t('with you. To schedule an appointment for') ?>
								<?php $_GET;
								$tourguide = $_GET['tourguide'];
								$tourguide = str_replace("-", " ", $tourguide);
								echo __t($tourguide); ?><?= __t('? Please call at 04-3798747 or request an appointment online. A denture or a complete denture as it is often called, is an appliance that is inserted in the mouth, replaces natural teeth, and provides support for the cheeks and lips.') ?>
							</p>
							...
							<div>
								...
								<p><?= __t('Dr. Lavanya/ Dr Samir and their staff at Cosmocare would be happy to discuss the details about') ?> <?php $_GET;
								   $tourguide = $_GET['tourguide'];
								   $tourguide = str_replace("-", " ", $tourguide);
								   echo __t($tourguide); ?>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<ul class="icn-list">
						<li><a href="https://maps.app.goo.gl/UnQLdp7uRi85HLP5A"><?= __t('Room# 07-08 1st Floor, Life Pharmacy') ?>
								<br>
								<?= __t('Building 2nd December Street, Al Satwa Roundabout') ?> <br>
								<?= __t('P.O Box 126590, Dubai,U.A.E.') ?></a>
							<br>
			...
			<div class="container">
				<div class="row text-center text-md-left">
					<div class="col-sm"><?= __t('Copyright © 2010-2030') ?><a
						...
						<a href="http://www.dubaistdclinic.com/" target="_blank" title="std testing center">STD Clinic
							in Dubai</a>
					</div>
