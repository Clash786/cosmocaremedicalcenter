...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare Medical Center dentist / surgeons are specially trained to perform all types of surgery that is needed after facial trauma. Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about Facial Trauma Surgery with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?>" />
	<meta name="keywords" content="<?= __t('facial trauma surgery, facial trauma treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Facial Trauma Surgery in Dubai | Specialist Facial Trauma Reconstruction | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="facial-trauma.php"><?= __t('Facial Trauma') ?></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Facial Trauma Surgery in Dubai') ?></h1>
							<p><?= __t('After a car accident or other facial trauma, you may require surgery to correct the damage. Cosmocare Medical Center dentist / surgeons are specially trained to perform all types of surgery that is needed after facial trauma. Facial trauma can be repaired in a local hospital or outpatient surgery center. Some of the types of facial trauma, which may require surgery, include') ?> <a href="https://cosmocaremedicalcenter.com/facial-lacerations.php"><?= __t('facial lacerations') ?></a><?= __t(', knocked out teeth, broken or fractures cheek, nose, jaw, or eye socket.') ?></p>
							<h2><?= __t('Correcting Facial Trauma') ?></h2>
							<p><?= __t('Facial trauma causes a high degree of physical and emotional trauma to the patient. Correcting facial trauma requires special training and an in depth understanding of the long term functioning and appearance of the face. Cosmocare Medical Center surgeons take into consideration the patient\'s prior appearance and any permanent damage that will affect the results.') ?> </p>
							<div class="service-img">
								<img src="images/facial-trauma-dubai.svg" width="100%" class="img-fluid" alt="Facial Trauma Surgery in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about Facial Trauma Surgery with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p>
