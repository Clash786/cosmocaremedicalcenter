...
<head>
	...
	<meta name="description" content="<?= __t('Consult a leading Keloid Removal Specialist in Dubai at Cosmocare Medical Center. Expert treatments to safely remove keloids and improve skin appearance. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Keloid removal Dubai, Keloid treatment specialist Dubai, Scar removal Dubai, Dermatologist for keloids Dubai, Cosmetic dermatology Dubai, Skin care specialist Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Keloid Removal Specialist in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Professional Keloid Removal Treatments') ?></li>
										<li><?= __t('Scar and Bump Reduction Procedures') ?></li>
										<li><?= __t('Safe and Effective Dermatology Solutions') ?></li>
										<li><?= __t('Advanced Laser and Injection Therapies') ?></li>
										<li><?= __t('Personalized Treatment Plans for Skin Healing') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Keloid Removal Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('keloid removal specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in dermatology, he provides advanced treatments for keloids, scars, and raised skin lesions, helping patients achieve smoother, healthier skin. Dr. Murtuza is dedicated to delivering personalized care and effective solutions for safe and long-lasting results.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines modern dermatological techniques with a patient-centered approach to treat keloids and related skin concerns. His expertise ensures precise, minimally invasive, and professional care, making him one of the most trusted') ?> <b><?= __t('dermatologists for keloid removal in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Keloid Removal & Skin Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/keloid-removal-dubai.jpg" class="img-fluid" alt="Expert Keloid Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/keloid-removal-dubai1.jpg" class="img-fluid" alt="Expert Keloid Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/keloid-removal-dubai2.jpg" class="img-fluid" alt="Expert Keloid Removal Treatments in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had stubborn keloids for years and was unsure about treatment options, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a significant improvement in just a few sessions. The treatment was professional, safe, and effective, leaving my skin smoother and more even. I highly recommend Dr. Murtuza for anyone seeking expert') ?> <b><?= __t('keloid removal in Dubai') ?></b>."</p>
							</div>
						</div>
