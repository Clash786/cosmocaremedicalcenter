...
<head>
	...
	<meta name="description" content="<?= __t('249 Mole Removal at Cosmocare Medical Center Dubai, we suggest you to visit our renowned and leading Dermatologist Dr Murtuza Bandukwala who has an expertise in removing such moles.  If you\'re looking for mole removal / treatment? Visit our Cosmocare Medical Center. If you have any further questions, feel free to call us at 04 379 8747 (Satwa / 04 353 6164 (Jumeirah 2 or email at info@cosmocaremedicalcenter.com for book an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('mole removal dubai, warts treatment') ?>" />
	...
	<title><?= __t('249aed Mole Removal Treatment by Specialist Doctor in Dubai | Mole Treatment Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Mole Removal (249 AED)') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/mole.jpg" class="img-fluid" alt="Mole Removal dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><strong><?= __t('What are Moles?') ?></strong></p>
							<p><a href="http://removalmole.com/" target="_blank"><strong><?= __t('Moles') ?></strong></a><?= __t('&nbsp;are usually harmless pigmented lesions. They are  made of Melanocytes cells , which are scattered all over the skin. They are  responsible to cause tanning of the skin by generating pigment called melanin.  When the melanocytes cell cluster together, a mole develops.') ?></p>
							<p><?= __t('Moles  come in many shapes and sizes they can be flat or raised dark or light brown.  Some may be fleshy and the same colour as the rest of the skin. Moles are  usually acquired after birth and may continue to appear up until the age of  40yrs. After which it is unusual to develop a new mole.') ?></p>
							<!-- Gulf news Article-->
							<h6 style="line-height:0px"><?= __t('Dr Murtuza Bandukwala') ?></h6>
							<p style="line-height:0px"><a target="_blank" href="https://gulfnews.com/friday/art-people/ask-the-experts-23-1.500049098"><?= __t('Specialist Dermatologist, Cosmocare Medical Center Gulf News') ?></a></p>
							<a target="_blank" href="https://gulfnews.com/friday/art-people/ask-the-experts-23-1.500049098"><img style="float:left; border: 1px solid #ddd; border-radius: 4px;padding: 5px;width: 150px;" src="https://media.assettype.com/gulfnews%2F2025-02-28%2Fvk4c6gmt%2FFRI250228Ask-the-expertsDr-Mortaza.JPG?rect=0%2C146%2C851%2C638&w=1200&auto=format%2Ccompress&fit=max" alt="Forest" style="width:150px"></a>
							...
							<p style="line-height:0px"><?= __t('Ebook link:') ?> <a target="_blank" href="https://features.gulfnews.com/books/plrt/#p=32">https://features.gulfnews.com/books/plrt/ </a></p>
							<p style="font-size:10px"><?= __t('Last updated: February 28, 2025 | 13:16') ?> <a target="_blank" href="https://gulfnews.com/friday/art-people/ask-the-experts-23-1.500049098"><?= __t('GULF NEWS FRIDAY') ?></a></p>
							<!-- End Gulf New Article-->
							<p><strong><?= __t('When  you should immediately consult the  Doctor?') ?></strong></p>
							<p><?= __t('Firstly, it is important to rule out any suspicion or risk for the moles and if there are any concerns about the mole being unusual, an assessment with a  doctor should be sought without delay.') ?></p>
							<ul>
								<li><?= __t('Moles with uneven coloring – most moles only have one or  two colors, but melanomas (cancerous regions) have lots of different shades') ?></li>
								<li><?= __t('Moles with an uneven or ragged edge – moles are usually  circular or oval with a smooth border') ?></li>
								<li><?= __t('Bleeding, itching, red, inflamed (swollen) or crusty  moles') ?></li>
								<li><?= __t('Moles that get a lot bigger – most moles are no bigger  than the width of a pencil') ?></li>
								<li><?= __t('A helpful way to remember what to look for is to use the  ABCDE method.') ?><br>
									<?= __t('A – asymmetry') ?><br>
									<?= __t('B – border irregularity') ?><br>
									<?= __t('C – color change') ?><br>
									<?= __t('D – diameter') ?><br>
									<?= __t('E – elevated (raised) or enlarged') ?></li>
							</ul>
							<p><strong><?= __t('Moles Removal at Cosmocare:') ?></strong></p>
							<p><?= __t('Our  leading, expert and renowned Dermatologist Dr Murtuza Bandukwala has been  providing treatment for mole removal since long. With his vast experience and  expertise in this field, you may expect satisfactory results. When the patient comes for consultation, the  Doctor examines the skin .If a mole is suspicious, a biopsy will be taken.') ?></p>
							<p><?= __t('Mole  removals are usually done due to the following reasons:') ?></p>
							<ul>
								<li><?= __t('If the Doctor suspects the mole to be malignant.') ?></li>
								<li><?= __t('If the mole is symptomatic (bleeds  with shaving, painful and uncomfortable)') ?></li>
								<li><?= __t('Foe Aesthetic, Cosmetic reasons. Mole removal can enhance your beauty , boost your  confidence and self esteem') ?></li>
							</ul>
							<p><strong><?= __t('Moles  In Children:') ?></strong></p>
							<p><?= __t('Dr Murtuza also offers treatment for children born with brown pigmented birthmarks  the so called congenital melanocytic naevus. They can be small or large and  require specialist review in a pediatric dermatology clinic.') ?></p>
							<p><strong><?= __t('Genital  Moles:') ?></strong></p>
							<p><?= __t('Moles can be found anywhere in the body, even those  intimate areas or genital region. Such moles leads to embarrassment,  uneasiness. Such moles might lead tothe loss of confidence and self-esteem in the patient. Sometimes, Genital moles are confused with  Genital warts therefore examination with the doctor is necessary.') ?></p>
							<p><?= __t('To overcome the side effects of this condition, we  suggest you to visit our renowned and leading Dermatologist Dr Murtuza  Bandukwala who has an expertise in removing such moles. We at cosmocare believe  in maintaining the privacy, confidentiality of the patient and provide safe secure and comfortable environment.') ?></p>
							<p><?= __t('If you\'re looking for mole removal / treatment? Visit our Cosmocare Medical Center. If you have any further questions, feel free to call us at 04 379 8747 (Satwa) / 04 353 6164 (Jumeirah 2) or email at info@cosmocaremedicalcenter.com for book an appointment.') ?></p>
						</div>
					</div>
				</div>
			</div>
