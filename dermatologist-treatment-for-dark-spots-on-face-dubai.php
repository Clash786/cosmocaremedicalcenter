...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$dermatologist_dark_spots_dubai"; ?> <?= __t('Expert Treatment for Dark Spots on Face in Dubai by Dr. AQR Providing advanced pigmentation correction and skincare treatments. For any queries, call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email') ?> <?php include 'price.php'; echo "$email"; ?> to BOOK an appointment." />
	<meta name="keywords" content="<?php include 'price.php'; echo "$dubai_keywords"; ?>, <?= __t('dark-spots-treatment-dubai, pigmentation-correction-dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$dermatologist_dark_spots_dubai"; ?> <?= __t('Treatment for Dark Spots on Face in Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<div class="title-wrap">
								...
								<h1><?= __t('Achieve Even-Toned, Radiant Skin') ?></h1>
								<h1><?= __t('Expert Care for Your Skin Confidence') ?></h1>

								<p><?= __t('At') ?>
									<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our specialists provide advanced treatments for dark spots and pigmentation issues under the expert care of Dr. Murtaza.Whether caused by sun exposure, acne scars, or aging, our personalized treatment plans help restore even skin tone and radiance.') ?>
								</p>
								<p><?= __t('Our team at') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong>
									<?= __t('focuses on effective dark spot removal and pigmentation correction using advanced techniques, ensuring minimal downtime and maximum results.') ?>
									<br><?= __t('Every treatment plan is customized to suit your unique skin tone, type, and concern.') ?>
								</p>

							</div>

							<div class="service-img">
								<a href="dermatologist-treatment-for-dark-spots-on-face-dubai.php">
									<img src="images/dermatologist-treatment-for-dark-spots-on-face-dubai.jpg"
										alt="Dermatologist Treatment for Dark Spots on Face in Dubai by Cosmocare Medical Center"
										style="width:80%; max-width:700px;" border="0" class="img-fluid" />
								</a>
							</div>
						</div>
						<br>

						<h3><?= __t('Expert Pigmentation & Dark Spots Correction by Dermatologist') ?></h3>

						<p><?= __t('At') ?>
							<strong><?php echo $company; ?></strong><?= __t(', our dermatologist specialists provide advanced treatments for dark spots, pigmentation, and uneven skin tone under the expert care of Dr. Murtaza.') ?>
							<br><?= __t('Whether caused by sun exposure, acne scars, or aging, we ensure your skin receives personalized attention for radiant and even-toned skin.') ?>
						</p>

						<p><?= __t('Our team offers targeted therapies, follow-ups, and long-term care to help you regain confidence in your skin while minimizing downtime.') ?>
						</p>

						<ul>
							<li><?= __t(' Personalized Treatment Plans by Dermatologist') ?></li>
							<li><?= __t(' Advanced FDA-approved Dermatology Equipment') ?></li>
							<li><?= __t(' Experienced Dermatologist Dr. Murtaza') ?></li>
							<li><?= __t(' Trusted by Patients Across Dubai (Satwa & Jumeirah 2)') ?></li>
						</ul>
