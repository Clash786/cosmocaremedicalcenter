...
<head>
	...
	<meta name="description" content="<?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about') ?> <?php $_GET; $tourguide = $_GET['tourguide']; $tourguide = str_replace("-", " ", $tourguide); echo $tourguide; ?> <?= __t('with you. To schedule an appointment for') ?> <?php $_GET; $tourguide = $_GET['tourguide']; $tourguide = str_replace("-", " ", $tourguide); echo $tourguide; ?>? <?= __t('Please call at 04-3798747 or request an appointment online.') ?>" />
	<meta name="keywords" content="<?php $_GET; $tourguide = $_GET['tourguide']; $tourguide = str_replace("-", " ", $tourguide); echo $tourguide; ?> ,<?php include 'price.php'; echo "$company"; ?>,<?= __t('dentures, cosmetic denture, treatment, dubai, treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title>[<?php include 'price.php'; echo "$dentaloffer"; ?><?= __t(']  Looking for') ?> <?php $_GET; $tourguide = $_GET['tourguide']; $tourguide = str_replace("-", " ", $tourguide); echo $tourguide; ?> <?= __t('in Dubai?') ?> <?php include 'price.php'; echo "$company"; ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							echo $tourguide; ?> <?= __t('Dubai |') ?> <?php include 'price.php';
								  echo "$company"; ?></h1>
							<p><?= __t('Ours doctors and staff at Cosmocare would be happy to discuss the details about') ?> <?php $_GET;
							   $tourguide = $_GET['tourguide'];
							   $tourguide = str_replace("-", " ", $tourguide);
							   echo $tourguide; ?> <?= __t('with you. To schedule an appointment for') ?>
								<?php $_GET;
								$tourguide = $_GET['tourguide'];
								$tourguide = str_replace("-", " ", $tourguide);
								echo $tourguide; ?><?= __t('? Please call at 04-3798747 or request an appointment online. A denture or a complete denture as it is often called, is an appliance that is inserted in the mouth, replaces natural teeth, and provides support for the cheeks and lips.') ?>
							</p>
