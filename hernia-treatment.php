...
<head>
	...
	<title><?= __t('Piles and Hernia Treatment in Dubai by Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu4">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="hernia-treatment.html"><?= __t('Hernia Treatment') ?></a></li>
