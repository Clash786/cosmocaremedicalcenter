...
// Safe initialization
$rootcanalnearme = 'root canal near me';
if (isset($_GET['rootcanalnearme'])) {
	$rootcanalnearme = str_replace("-", "root canal near me", $_GET['rootcanalnearme']);
}
$keyword = htmlspecialchars($rootcanalnearme);
...
<head>
	...
	<meta name="description" content="<?= __t($keyword) ?> <?= __t('in Dubai? To schedule an appointment, please call at 04-3798747 or request an appointment online.') ?>">
	...
	<title>[<?= htmlspecialchars($free) ?>] ✅ <?= __t($keyword) ?> <?= __t('in Dubai?') ?> <?= htmlspecialchars($company) ?>
	</title>
				...
				<div class="row align-items-center">
					<div class="col-auto d-flex align-items-center">
						...
						<div class="header-info"><a href="https://maps.app.goo.gl/NZ88cwEgg4BPeYtf8"
								target="_blank">Villa 464, Jumeirah 2, Dubai</a></div>
				...
				<div class="row no-gutters">
					...
					<div class="col">
						...
						<div class="link-drop">
							...
							<p><?= __t('This simply works as a guide and helps you to connect with dentists of your choice. Please confirm the doctors availability before leaving your premises.') ?>
							</p>
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t($keyword) ?> <?= __t('in Dubai') ?></h1>
							<p>
								<?= __t($keyword) ?> <?= __t('in Dubai? To schedule an appointment for ') ?>
								<?= __t($keyword) ?><?= __t('? Please call at 04-3798747 or request an appointment online.') ?>
							</p>
							<div class="service-img">
								<img src="images/root-canal-dubai.svg" width="100%" class="img-fluid"
									alt="<?= __t($keyword) ?> dubai" />
							</div>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and their staff at Cosmocare would be happy to discuss the details with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?>
								</p>
								<p>
									<iframe alt="<?= __t($keyword) ?> dubai" title="<?= __t($keyword) ?> dubai"
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row text-center text-md-left">
					<div class="col-sm"><?= __t('Copyright') ?> 2014 <a
