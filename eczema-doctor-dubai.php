...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$eczema_doctor_dubai"; ?> <?= __t('Expert Eczema Doctor in Dubai by Dr. AQR Providing advanced eczema care, skin treatments & personalized dermatology solutions. For any queries, call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('to BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$eczema_doctor_dubai"; ?>, <?= __t('eczema doctor dubai, eczema treatment dubai, dermatologist for eczema, skin specialist dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$eczema_doctor_dubai"; ?> <?= __t('Eczema Doctor in Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Eczema Doctor in Dubai') ?></h3>
							<h1><?= __t('Heal Your Skin. Regain Comfort. Feel Confident Again.') ?></h1>
							<p><?= __t('At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our expert dermatologists, led by') ?>
								<strong><?= __t('Eczema Specialist Dr. Murtaza') ?></strong><?= __t(', provide advanced eczema care and skin treatments tailored for all skin types.') ?>
								<br><?= __t('Whether you\'re dealing with flare-ups, dryness, or sensitive skin issues,') ?>
								<strong><?= __t('Dr. Murtaza') ?></strong>
								<?= __t('and his team are dedicated to restoring your skin\'s health, comfort, and confidence.') ?>
							</p>
							<p><?= __t('Our comprehensive eczema treatments at') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong>
								<?= __t('focus on reducing inflammation, soothing irritation, and preventing future flare-ups. We combine advanced topical therapies, lifestyle guidance, and gentle skin care routines to ensure your skin feels nourished, calm, and resilient.') ?>
							</p>
							<p><?= __t('Dr. Murtaza and the team prioritize a holistic approach, understanding that eczema affects not just your skin but also your overall well-being. With personalized care plans and continuous monitoring, we help you achieve long-lasting relief, improved skin barrier function, and renewed confidence in your appearance.') ?>
							</p>
						</div>
						<div class="service-img">
							<a href="eczema-doctor-dubai.php">
								<img src="images/eczema-doctor.jpg"
									alt="Eczema Doctor in Dubai by Cosmocare Medical Center" width="100%" border="0"
									class="img-fluid" />
							</a>
						</div>
						<br>
						<h1><?= __t('Expert Eczema Doctor in Dubai') ?></h1>
						<p><?= __t('At') ?>
							<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide advanced eczema and dermatology care under the expert guidance of') ?>
							<strong><?= __t('Dr. Murtaza') ?></strong>, one of Dubai's most trusted skin specialists.
							<br><?= __t('Whether you\'re dealing with chronic eczema, flare-ups, or sensitive skin issues, Dr. Murtaza and his team are dedicated to restoring your skin\'s health and comfort.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Eczema Care?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Personalized Treatment Plans:') ?></strong>
								<?= __t('Tailored therapies to manage and soothe eczema effectively.') ?></li>
							<li><strong><?= __t(' Advanced Dermatology Equipment:') ?></strong>
								<?= __t('Latest FDA-approved technology for safe and efficient results.') ?></li>
							<li><strong><?= __t(' Expert Care by Dr. Murtaza:') ?></strong>
								<?= __t('Over a decade of experience treating eczema and other skin conditions.') ?>
							</li>
							<li><strong><?= __t(' Trusted by Patients Across Dubai:') ?></strong>
								<?= __t('Conveniently located in Satwa and Jumeirah 2, providing high-quality care.') ?>
							</li>
						</ul>
						<p><?= __t(' Book your appointment today with') ?> <strong><?= __t('Dr. Murtaza') ?></strong>
							<?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong>
