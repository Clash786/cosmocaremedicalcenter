...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; ?><?= __t('Rejuvenation Dermatology in Dubai at') ?> <?php echo $company; ?> <?= __t('offering advanced skin rejuvenation, anti-aging treatments, and cosmetic dermatology solutions for a youthful, glowing appearance. For appointments, call ') ?><?php echo $contact; ?> <?= __t('(Satwa) / ') ?><?php echo $contactjumeirah; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo $email; ?>." />
	<meta name="keywords" content="<?php include 'price.php'; ?><?= __t(', rejuvenation-dermatology-dubai, skin-rejuvenation-dubai, anti-aging-treatments, cosmetic-dermatology, aesthetic-treatments-dubai,') ?> <?php echo $company; ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php';
			echo "$company"; ?> <?= __t('| Rejuvenation Dermatology in Dubai Satwa & Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Rejuvenation Dermatology in Dubai') ?></h3>
							<h1><?= __t('Restore Youthful Radiance & Healthy Skin') ?></h1>
							<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide advanced') ?> <strong><?= __t('rejuvenation dermatology') ?></strong> <?= __t('treatments designed to revitalize your skin and enhance its natural glow. Our expert dermatologists offer personalized solutions for fine lines, pigmentation, uneven texture, and signs of aging, ensuring visible and long-lasting results.') ?></p>
							<p><?= __t('Whether you want to improve skin tone, reduce wrinkles, or maintain a youthful appearance, our team combines cutting-edge technology with professional care to deliver safe and effective cosmetic dermatology services. With convenient locations in ') ?><strong><?= __t('Satwa') ?></strong> <?= __t('and') ?> <strong><?= __t('Jumeirah 2') ?></strong><?= __t(', achieving smooth, radiant, and healthy skin has never been easier.') ?></p>
						</div>
						<div class="service-img">
							<a href="rejuvenation-dermatology-dubai.php">
								<img src="images/rejuvenation-dermatology.jpg"
									alt="Rejuvenation Dermatology in Dubai by Cosmocare Medical Center"
						...
						<br>
						<h1><?= __t('Expert Dermatologist for Rejuvenation in Dubai') ?></h1>
						<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide advanced') ?> <strong><?= __t('skin rejuvenation') ?></strong> <?= __t('treatments designed to restore your skin\'s youthful glow and overall health.') ?>
							<br><?= __t('Our personalized approach addresses fine lines, pigmentation, uneven skin tone, and other signs of aging, ensuring visible and long-lasting results.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Skin Rejuvenation?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Customized Treatment Plans:') ?></strong> <?= __t('Every plan is tailored to your skin type and specific concerns.') ?></li>
							<li><strong><?= __t(' Cutting-Edge Technology:') ?></strong> <?= __t('We use the latest FDA-approved devices for safe and effective treatments.') ?></li>
							<li><strong><?= __t(' Experienced Dermatologists:') ?></strong> <?= __t('Our specialists have extensive expertise in aesthetic and rejuvenation procedures.') ?></li>
							<li><strong><?= __t(' Minimal Downtime:') ?></strong> <?= __t('Most treatments are quick and comfortable, allowing you to resume daily activities immediately.') ?></li>
							<li><strong><?= __t(' Convenient Dubai Locations:') ?></strong> <?= __t('Available at both') ?> <strong><?= __t('Satwa') ?></strong> <?= __t('and') ?> <strong><?= __t('Jumeirah 2') ?></strong> <?= __t('clinics for easy access.') ?></li>
						</ul>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Rejuvenation Dermatology Treatments in Dubai by Cosmocare Medical Center...'),
			'link' => 'rejuvenation-dermatology-dubai.php',
			'date' => 'July 25, 2021'
		],
	];
	$footer_nearby_areas = [
