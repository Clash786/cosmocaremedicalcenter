...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare provides treatment of Fractrured Lower Jaw including oral surgery treatments to the patients in Dubai. To book an appointment online: Cosmocare Medical Center Call now 043798747') ?>" />
	<meta name="keywords" content="<?= __t('fractured jaw surgery dubai, tmj specialist dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Fractured Jaw Surgery in Dubai | Specialist Fractured Jaw Treatment | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="fractured-jaws.php"><?= __t('Fractured jaws') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Fractured Jaw Surgery in Dubai') ?></h1>
							<p><?= __t('A broken lower jaw will need to be repaired under a general anesthetic. Typically the procedure will involve cutting the inside of the mouth along the gum line to access the broken bone and to place appropriate titanium plates and screws on it to keep it aligned while healing. It is important to stick to the prescribed soft food diet to ensure you do not bend or break the plate. If this happens you will need to undergo surgery again (the same goes for sports etc. where you can be injured or bumped on the face).') ?></p>
							<p><?= __t('Generally, after the jaw operation, it will be quite sore for a few days, with a general pain to last for a few weeks. Pain relief and antibiotics will be prescribed, if the bone gets infected it won\'t heal well. Cosmocare provides treatments for fractured jaw to patients in Dubai, UAE.') ?>
							</p>
							<div class="service-img">
								<img src="images/fractured-jaw-dubai.svg" width="100%" class="img-fluid" alt="fractured jaw surgery and treatment in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<h2><?= __t('Recovery From Fractured Lower Jaw') ?></h2>
								<p><?= __t('Normally the patient will stay in the hospital for at least one night and have a confirmation x-ray the next day before being released to ensure the jaw has stayed in place.') ?>
								</p>
								<p><?= __t('It is very important to follow the soft diet requirements for up to 6 weeks (the time it takes the bone to heal) or by the instructions from your facial surgeon.') ?>
								</p>
								<p><?= __t('Also ensure that the mouth is kept as clean as possible to prevent infection or healing issues with the internal stitches, clean where you can and use an appropriate mouthwash to help keep the cut site clean.') ?>
								</p>
								<p><?= __t('You will need to take some time off work, around a week is recommended.') ?>
								</p>
								<p><?= __t('Your oral surgeon will review you before you are released from the hospital and then you will typically have another appointment in 7-10 days.') ?>
								</p>
								<p><?= __t('For more information on Fractured Jaw Surgery in Dubai or for a consult please ask your dentist for a referral to Cosmocare and book an appointment with our friendly team.') ?>
								</p>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about fractured jaw surgery with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p></p>
								<p>
