...
// Fetch only pages marked as 'test'
$sql = "SELECT title, slug FROM std_keywords WHERE language = 'en' AND category = 'test' ORDER BY id ASC";
...
<head>
	...
	<meta name="description" content="<?= __t('STD Home Testing (STD testing) refers to many different tests you get at Cosmocare Medical Center to find out if you have a sexually transmitted infection. At-home STI testing is also an option. Testing involves giving samples of blood, urine or other bodily fluids. It\'s quick, painless and an important way to take care of yourself.') ?>" />
	<meta name="keywords" content="<?= __t('STD Home Testing , std, sti testing, hiv test, dubai, cosmocare') ?>" />
	<meta name="author" content="<?= __t('Cosmocare Medical Center') ?>" />	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title><?= __t('STD Home Testing (STD testing) at Cosmocare Medical Center | At-home STI testing in Dubai UAE') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link" href="invisible-aligners.php"><?= __t('Invisible Aligners') ?></a></li>										</ul>
								</div>
							</li>
							<li class="nav-item">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('(STD Home Testing) in Dubai') ?></h1>
							<p><?= __t('STI testing (STD testing) refers to many different tests you get at') ?> <a href="https://maps.app.goo.gl/cW2puYGvHJeEx7F57" target="_blank"><?= __t('Cosmocare Medical Center') ?></a> <?= __t('to find out if you have a sexually transmitted infection. At-home STI testing is also an option. Testing involves giving samples of blood, urine or other bodily fluids. It\'s quick, painless and an important way to take care of yourself.') ?></p> 
							<p>
							...
							<p>
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()) {
                                        echo '<a target="_blank" href="std-home/' . htmlspecialchars($row['slug']) . '.html">';
                                        echo  __t($row['title']); 
                                        echo '</a><br/>';
                                    }
                                } else {
                                    echo "<p>" . __t('No home tests found.') . "</p>";
                                }
                                ?>
							</p>
				  </div>
