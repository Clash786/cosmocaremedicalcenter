...
<head>
	...
	<meta name="description" content="<?= __t('Consult the best dermatologist for Basko Dermatology in Dubai at Cosmocare Medical Center. Expert treatments for skin care, acne, pigmentation, mole removal, and advanced dermatology solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Basko Dermatology Dubai, Best dermatologist Dubai, Skin care Dubai, Acne treatment Dubai, Mole removal Dubai, Pigmentation treatment Dubai, Dermatology clinic Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Basko Dermatology Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							...
							<tr>
								<td><?= __t('Degrees') ?></td>
								<td><?= __t('MD Dermatology, Fellowship in Cosmetic Dermatology') ?></td>
							</tr>
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Mole and Skin Lesion Removal') ?></li>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-3">
							<div class="doctor-info-name">
								...
								<h6> <?= __t('Basko Consultant Dermatologist & Skin Care Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading skin care specialists at') ?> <b><?= __t('Basko Dermatology, Cosmocare Medical Center Dubai') ?></b><?= __t('. With over two decades of experience in dermatology, he offers advanced solutions for a wide range of skin concerns, including acne, pigmentation, mole removal, and anti-aging treatments. His expertise includes laser therapies, PRP for skin rejuvenation, chemical peels, and non-surgical cosmetic procedures. Dr. Murtuza believes that every patient at Basko Dermatology deserves a customized approach to achieve healthy, radiant skin.') ?></p>
						<p><?= __t('As part of the expert team at') ?> <b><?= __t('Basko Dermatology, Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the root causes of skin issues, including hormonal changes, environmental factors, and lifestyle. He combines modern medical techniques with compassionate patient care to ensure safe and long-lasting results. His commitment to continuous learning and innovation keeps Basko Dermatology at the forefront of dermatology and cosmetic skin care in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Dermatology & Skin Care Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/basko-dermatology-dubai.jpg" class="img-fluid" alt="Basko Dermatology Specialist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/basko-dermatology-dubai1.jpg" class="img-fluid" alt="Basko Dermatology Specialist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/basko-dermatology-dubai2.jpg" class="img-fluid" alt="Basko Dermatology Specialist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been facing persistent skin issues for years, but after visiting Dr. Murtuza Bandukwala at Cosmocare Medical Center, I started noticing visible improvements in just a few sessions. He truly understands how to treat skin conditions effectively and helped me regain my confidence."') ?></p>
							</div>
						</div>
