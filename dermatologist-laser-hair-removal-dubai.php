...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; ?><?= __t('Consult the Best Dermatologist for Laser Hair Removal in Dubai at') ?> <?php echo $company; ?> <?= __t('offering advanced, safe, and effective hair removal treatments for men and women. For appointments, call ') ?><?php echo $contact; ?> <?= __t('(Satwa) / ') ?><?php echo $contactjumeirah; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo $email; ?>." />
	<meta name="keywords" content="<?php include 'price.php'; ?><?= __t(', dermatologist-laser-hair-removal-dubai, laser-hair-removal-dubai, hair-removal-treatment, painless-laser-hair-removal, professional-laser-clinic,') ?> <?php echo $company; ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$company"; ?> <?= __t('| Dermatologist Laser Hair Removal in Dubai Satwa & Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Dermatologist for Laser Hair Removal in Dubai') ?></h3>
							<h1><?= __t('Safe & Effective Laser Hair Removal Treatments') ?></h1>
							<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we offer professional') ?> <strong><?= __t('laser hair removal') ?></strong> <?= __t('services for men and women.') ?>
								<?= __t('Our advanced treatments target unwanted hair safely and effectively, leaving your skin smooth, soft, and hair-free. Whether you want to remove hair from the face, legs, arms, or other areas, our team ensures comfort, precision, and excellent results.') ?></p>
							<h1><?= __t('Why Choose Our Laser Hair Removal Services?') ?></h1>
							<p><?= __t('Our clinic provides personalized care with advanced technology and expert dermatologists. We prioritize safety, minimize discomfort, and deliver long-lasting results for all skin types. Conveniently located in') ?> <strong><?= __t('Satwa') ?></strong> <?= __t('and') ?> <strong><?= __t('Jumeirah 2') ?></strong><?= __t(', we make it easy to achieve smooth, radiant skin with professional guidance every step of the way.') ?></p>
						</div>
						<div class="service-img">
							<a href="dermatologist-laser-hair-removal-dubai.php">
								<img src="images/dermatologist-laser-hair-removal.jpg"
									alt="Laser Hair Removal in Dubai by Cosmocare Medical Center"
						...
						<br>
						<h1><?= __t('Expert Dermatologist for Laser Hair Removal in Dubai') ?></h1>
						<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide safe and effective') ?> <strong><?= __t('laser hair removal') ?></strong><?= __t(' treatments for men and women.') ?>
							<br><?= __t('Our advanced laser technology targets unwanted hair precisely, leaving your skin smooth, soft, and hair-free. Whether you\'re looking to remove hair from the face, legs, arms, or other areas, our specialists ensure comfort, safety, and lasting results.') ?>
						</p>
						<p><strong><?= __t('Why Choose Cosmocare for Laser Hair Removal?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Personalized Treatment Plans:') ?></strong> <?= __t('Each session is tailored to your skin type and hair removal needs.') ?></li>
							<li><strong><?= __t(' Advanced Laser Technology:') ?></strong> <?= __t('FDA-approved lasers for safe, precise, and effective results.') ?></li>
							<li><strong><?= __t(' Experienced Dermatologists:') ?></strong> <?= __t('Our team has extensive experience in hair removal and skin care.') ?></li>
							<li><strong><?= __t(' Minimal Downtime:') ?></strong> <?= __t('Treatments are quick, comfortable, and allow you to return to daily activities immediately.') ?></li>
							<li><strong><?= __t(' Convenient Dubai Locations:') ?></strong> <?= __t('Available at both') ?> <strong><?= __t('Satwa') ?></strong> <?= __t('and') ?> <strong><?= __t('Jumeirah 2') ?></strong> <?= __t('branches.') ?></li>
						</ul>
