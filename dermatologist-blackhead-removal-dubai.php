...
<head>
	...
	<meta name="description" content="<?= __t('Looking for the best dermatologist for blackhead removal in Dubai? Visit Cosmocare Medical Center for expert skin care solutions by Dr. Murtuza Bandukwala. Achieve clear, smooth, and healthy skin with safe and effective treatments. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dermatologist for blackhead removal Dubai, Blackhead removal Dubai, Skin care specialist Dubai, Best dermatologist Dubai, Acne treatment Dubai, Deep pore cleansing Dubai, Facial extraction Dubai, Skin rejuvenation Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dermatologist for Blackhead Removal in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Blackhead and Whitehead Removal Treatments') ?></li>
										<li><?= __t('Advanced Acne and Pigmentation Solutions') ?></li>
										<li><?= __t('Deep Pore Cleansing and Exfoliation') ?></li>
										<li><?= __t('Laser and Extraction Therapies for Clear Skin') ?></li>
										<li><?= __t('PRP and Rejuvenation Treatments for Smooth, Glowing Skin') ?></li>
									</ul>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Blackhead Removal Specialist') ?></h6>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('blackhead removal specialists') ?></b> <?= __t('and') ?> <b><?= __t('skin care doctors') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With years of expertise in dermatology, he provides advanced treatments for various') ?> <b><?= __t('skin concerns') ?></b> <?= __t('including blackheads, acne, pigmentation, mole removal, and anti-aging. Dr. Murtuza is committed to helping patients achieve smooth, clear, and radiant') ?> <b><?= __t('skin') ?></b> <?= __t('through safe, effective, and personalized care.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines modern dermatological technology with a patient-centered approach to treat') ?> <b><?= __t('blackheads') ?></b> <?= __t('and other skin impurities. His treatments focus on deep cleansing, pore purification, and long-term skin health, ensuring visible and lasting results for those seeking expert') ?> <b><?= __t('dermatologist care') ?></b> <?= __t('in Dubai.') ?></p>

						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Blackhead Removal Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/blackhead-removal-dubai.jpg" class="img-fluid" alt="Expert Blackhead Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/blackhead-removal-dubai1.jpg" class="img-fluid" alt="Expert Blackhead Removal Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/blackhead-removal-dubai2.jpg" class="img-fluid" alt="Expert Blackhead Removal Treatments in Dubai at Cosmocare Medical Center"></div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had persistent blackheads and clogged pores for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a remarkable improvement in my skin within just a few sessions. He expertly removed blackheads and provided treatments that left my skin clear, smooth, and healthy. I truly recommend Dr. Murtuza for anyone seeking effective blackhead removal in Dubai."') ?></p>
							</div>
						</div>
