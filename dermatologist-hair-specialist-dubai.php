...
<head>
	...
	<meta name="description" content="<?= __t('Consult the best dermatologist and hair specialist in Dubai at Cosmocare Medical Center. Expert care for hair loss, dandruff, scalp infections, acne, pigmentation, and other skin and hair concerns. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dermatologist Dubai, Hair specialist Dubai, Hair loss treatment Dubai, Scalp treatment Dubai, Dandruff treatment Dubai, Skin and hair clinic Dubai, Cosmetic dermatology Dubai, PRP hair treatment Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dermatologist & Hair Specialist in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Dermatologist & Hair Specialist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Hair Loss and Alopecia Treatments') ?></li>
										<li><?= __t('PRP Therapy for Hair Regrowth') ?></li>
										<li><?= __t('Scalp and Skin Rejuvenation') ?></li>
										<li><?= __t('Laser and Advanced Dermatology Treatments') ?></li>
										<li><?= __t('Comprehensive Hair and Skin Health Management') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Hair Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('hair specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With years of experience in dermatology and trichology, he provides advanced solutions for') ?> <b><?= __t('hair loss') ?></b>, <b><?= __t('scalp conditions') ?></b><?= __t(', and overall hair health. His expertise includes') ?> <b><?= __t('PRP therapy') ?>, <b><?= __t('mesotherapy') ?></b><?= __t(', and') ?> <b><?= __t('non-surgical hair restoration treatments') ?></b> <?= __t('designed to promote natural and long-lasting results.') ?></p>
						<p><?= __t('As part of the expert dermatology team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the underlying causes of') ?> <b><?= __t('hair thinning') ?></b> <?= __t('and') ?> <b><?= __t('alopecia') ?></b><?= __t(', such as hormonal imbalance, stress, or nutritional deficiencies. He combines modern medical approaches with personalized care to ensure effective, safe, and confidence-restoring results for every patient seeking the best') ?> <b><?= __t('dermatologist and hair specialist') ?></b> <?= __t('in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Hair & Scalp Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/dermatologist-hair-specialist-dubai.jpg" class="img-fluid" alt="Expert Hair and Scalp Treatments in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/dermatologist-hair-specialist-dubai2.jpg" class="img-fluid" alt="Expert Hair and Scalp Treatments in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been experiencing severe hair fall and scalp issues for months, but after consulting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I started seeing visible improvement within a few sessions. His expert diagnosis and treatment made a huge difference. My hair feels healthier and thicker now  I\'m truly thankful for his professional care and guidance."') ?></p>
							</div>
						</div>
