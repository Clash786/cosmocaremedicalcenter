...
<head>
	...
	<meta name="description" content="<?= __t('Achieve firmer and smoother skin with advanced Body Skin Tightening treatments in Dubai at Cosmocare Medical Center. Non-surgical solutions for sagging, loose, or aging skin. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Body skin tightening Dubai, non-surgical skin tightening Dubai, skin firming Dubai, sagging skin treatment Dubai, Cosmocare Medical Center, body contouring Dubai') ?>">
	...
	<title><?= __t('Body Skin Tightening Treatments in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Non-Surgical Body Skin Tightening for Sagging or Loose Skin') ?></li>
										<li><?= __t('Advanced Treatments for Cellulite and Skin Firming') ?></li>
										<li><?= __t('Laser and Radiofrequency-Based Skin Rejuvenation') ?></li>
										<li><?= __t('Personalized Body Contouring Solutions') ?></li>
										<li><?= __t('Comprehensive Skin Health and Aesthetic Management') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist in Body Skin Tightening & Aesthetic Treatments') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist in Body Skin Tightening and Aesthetic Treatments') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He provides advanced, non-surgical solutions to firm, lift, and rejuvenate sagging or loose skin, helping patients achieve smoother, healthier, and more youthful-looking bodies.') ?></p>
						<p><?= __t('Committed to the latest advancements in aesthetic dermatology,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('combines expertise with personalized care to deliver safe and effective body contouring treatments. His compassionate approach and dedication make him one of the most trusted specialists in Dubai for body skin tightening and aesthetic enhancement.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Body Skin Tightening & Aesthetic Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/body-skin-tightening-dubai.jpg" class="img-fluid" alt="<?= __t('Dr. Murtuza Bandukwala - Specialist in Body Skin Tightening and Aesthetic Treatments in Dubai at Cosmocare Medical Center') ?>"></div>
									<div class="col-sm-4"><img src="images/content/body-skin-tightening-dubai1.jpg" class="img-fluid" alt="<?= __t('Dr. Murtuza Bandukwala - Specialist in Body Skin Tightening and Aesthetic Treatments in Dubai at Cosmocare Medical Center') ?>"></div>
									<div class="col-sm-4"><img src="images/content/body-skin-tightening-dubai2.jpg" class="img-fluid" alt="<?= __t('Dr. Murtuza Bandukwala - Specialist in Body Skin Tightening and Aesthetic Treatments in Dubai at Cosmocare Medical Center') ?>"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to body skin tightening,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "The most rewarding part of my work is helping patients regain confidence and satisfaction with their appearance. Even subtle improvements in skin firmness and tone can have a significant impact on overall self-esteem. Helping people feel comfortable and confident in their own skin motivates me every day."') ?></p>
							</div>
						</div>
