...
<head>
	...
	<meta name="description" content="<?= __t('Genital herpes is a common sexually transmitted disease (STD that any sexually active person can get. Most people with the virus don’t have symptoms. Even without signs of the disease, herpes can still be spread to sex partners.') ?>" />
	...
	<title><?= __t('Gonorrhea Treatment by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu3">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="gonorrhea-treatment.html"><?= __t('Gonorrhea Treatment') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Gonorrhea Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/gonorrhea.jpg" class="img-fluid" alt="gonorrhea treatment">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Gonorrhea is a also common sexually transmitted disease (STD) that any sexually active person can get.') ?> </p>
							<h3><?= __t('What is gonorrhea?') ?></h3>
							<p><?= __t('Gonorrhea is a sexually transmitted disease (STD) that can infect both men and women. It can cause infections in the genitals, rectum, and throat. It is a very common infection, especially among young people ages 15-24 years.') ?></p>
							<h3><?= __t('How is gonorrhea spread?') ?></h3>
							<p><?= __t('You can get gonorrhea by having vaginal, anal, or oral sex with someone who has gonorrhea. A pregnant woman with gonorrhea can give the infection to her baby during childbirth.') ?></p>
							<p><?= __t('If you are sexually active, you can do the following things to lower your chances of getting gonorrhea:') ?></p>
							<ul>
								<li><?= __t('Being in a long-term mutually monogamous relationship with a partner who  has been tested and has negative STD test results;') ?></li>
								<li><?= __t('sing  latex condoms the right way every time you have sex.') ?> </li>
							</ul>
							<h3><?= __t('Am I at risk for gonorrhea?') ?></h3>
							<p><?= __t('Any sexually active person can get gonorrhea through unprotected vaginal, anal, or oral sex. If you are sexually active, have an honest and open talk with your health care provider and ask whether you should be tested for gonorrhea or other STDs. If you are a sexually active man who is gay, bisexual, or who has sex with men, you should be tested for gonorrhea every year. If you are a sexually active woman younger than 25 years or an older woman with risk factors such as new or multiple sex partners, or a sex partner who has a sexually transmitted infection, you should be tested for gonorrhea every year.') ?></p>
							<h3><?= __t('How do I know if I have gonorrhea?') ?></h3>
							<p><?= __t('Some men with gonorrhea may have no symptoms at all. However, men who do have symptoms, may have:') ?></p>
							<ul>
								<li><?= __t('A burning sensation when urinating;') ?></li>
								<li><?= __t('A white, yellow, or green discharge from the penis;') ?></li>
								<li><?= __t('Painful or swollen testicles (although this is less common).') ?></li>
							</ul>
							<p><?= __t('Most women with gonorrhea do not have any symptoms. Even when a woman has symptoms, they are often mild and can be mistaken for a bladder or vaginal infection. Women with gonorrhea are at risk of developing serious complications from the infection, even if they don’t have any symptoms. Symptoms in women can include:') ?></p>
							<ul>
								<li><?= __t('Painful or burning sensation when urinating;') ?></li>
								<li><?= __t('Increased vaginal discharge;') ?></li>
								<li><?= __t('Vaginal bleeding between periods.') ?></li>
								<li><?= __t('Rectal infections may either cause no symptoms or cause symptoms in both  men and women that may include: Discharge; Anal itching; Soreness; Bleeding;  Painful bowel movements.') ?> </li>
							</ul>
							<h3><?= __t('I was just diagnosed. What do I do now?') ?></h3>
							<p><?= __t('You should be examined by your doctor if you notice any of these symptoms or if your partner has an STD or symptoms of an STD, such as an unusual sore, a smelly discharge, burning when urinating, or bleeding between periods.') ?></p>
							<h3><strong><?= __t('How will my doctor know if I  have gonorrhea?') ?></strong></h3>
							<p><?= __t('Most of the time, urine can be used to test for  gonorrhea. However, if you have had oral and/or anal sex, swabs may be used to  collect samples from your throat and/or rectum. In some cases, a swab may be  used to collect a sample from a man’s urethra (urine canal) or a woman’s cervix  (opening to the womb).') ?></p>
							<h3><strong><?= __t('Can gonorrhea be cured?') ?></strong></h3>
							<p><?= __t('Yes, gonorrhea can be cured  with the right treatment. It is important that you take all of the medication  your doctor prescribes to cure your infection. Medication for gonorrhea should  not be shared with anyone. Although medication will stop the infection, it will  not undo any permanent damage caused by the disease.') ?></h3>
							<h3><strong><?= __t('Antibiotic-Resistant  Gonorrhea') ?></strong></h3>
							<p><?= __t('It is becoming harder to  treat some gonorrhea, as drug-resistant strains of gonorrhea are increasing. If  your symptoms continue for more than a few days after receiving treatment, you  should return to a health care provider to be checked again.') ?></p>
							<h3><strong><?= __t('I was treated for gonorrhea.  When can I have sex again?') ?></strong></h3>
							<p><?= __t('You should wait seven days  after finishing all medications before having sex. To avoid getting infected  with gonorrhea again or spreading gonorrhea to your partner(s), you and your  sex partner(s) should avoid having sex until you have each completed treatment.  If you’ve had gonorrhea and took medicine in the past, you can still get  infected again if you have unprotected sex with a person who has gonorrhea.') ?><br>
								<?= __t('Untreated gonorrhea may also  increase your chances of getting or giving HIV – the virus that causes AIDS.') ?></p>
						</div>
					</div>
				</div>
			</div>
