...
<head>
	...
	<meta name="description" content="<?= __t('Consult the top skin care specialist in Dubai at Cosmocare Medical Center. Expert treatments for acne, pigmentation, mole removal, anti-aging, and advanced dermatology solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Skin care specialist Dubai, Dermatologist Dubai, Acne treatment Dubai, Pigmentation treatment Dubai, Mole removal Dubai, Anti-aging treatments Dubai, Cosmetic dermatology Dubai, Skin rejuvenation Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Skin Care Specialist in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Care Doctor') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('skin care doctors') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With years of experience in dermatology, he offers advanced treatments for a variety of') ?> <b><?= __t('skin conditions') ?></b><?= __t(', including acne, pigmentation, mole removal, anti-aging, and overall skin rejuvenation. Dr. Murtuza is dedicated to helping patients achieve healthy, glowing, and youthful') ?> <b><?= __t('skin') ?></b> <?= __t('through personalized care and innovative treatment methods.') ?></p>
						<p><?= __t('As part of the expert dermatology team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on understanding the root causes of') ?> <b><?= __t('skin issues') ?></b> <?= __t('and developing customized solutions for each patient. His approach combines advanced dermatological technology with compassionate medical care, ensuring effective and long-lasting results for those seeking expert') ?> <b><?= __t('skin care doctors') ?></b> <?= __t('in Dubai.') ?></p>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with acne and pigmentation issues for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a remarkable improvement in my skin within just a few sessions. He truly understands how to address skin concerns effectively and helped me regain my confidence with clear, healthy, and radiant skin."') ?></p>
							</div>
						</div>
