...
<head>
	...
	<meta name="description" content="<?= __t('Chemical peel is a beneficial treatment for wrinkles, skin discoloration. After examining the condition of the patient,  our expert dermatologist Dr Murtuza Bandukwala decides which kind of peel will be used.') ?>" />
	<meta name="keywords" content="<?= __t('cheap Chemical peeling dubai, Chemical peeling price, chemical peel, chemical peel treatment dubai') ?>" />
	...
	<title><?= __t('99 AED Chemical peel Treatment by Specialist Doctor in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="chemical-peeling.html"><?= __t('Chemical peeling') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Chemical peeling') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/chemical-peels.jpg" class="img-fluid" alt="Chemical peeling dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Chemical peel is  a beneficial treatment for wrinkles, skin discoloration, light acne scarring  and irregular pigmentation such as freckles and age spots. Pre-cancerous  conditions such as keratosis (thick, rough, reddish growths) also respond well  to this procedure. A chemical peel is a very safe chemical exfoliation process that penetrates deeper in the skin so that the top layers of the skin start  shedding and the skin that grows back after this process is younger looking,  supple and smooth.') ?></p>
							<p><?= __t('At Cosmocare  Medical Center, we offer the following types of chemical peels:') ?></p>
							<ul>
								<li><?= __t('Light peels to remove superficial wrinkles') ?></li>
								<li><?= __t('Medium peels') ?></li>
								<li><?= __t('Deep peels for more severe conditions.') ?></li>
							</ul>
							<p><?= __t('After examining the condition of the patient, our expert dermatologist Dr Murtuza Bandukwala decides which  kind of peel will be used and if the treatment will be done alone or in  combination with other cosmetic procedures.') ?></p>
							<p><?= __t('After  thoroughly cleansing the skin, a small applicator is used to apply the chemical  solution to an area of the face. Excess solution is removed and the procedure  is repeated on other areas.') ?></p>
							<p><?= __t('The amount of  improvement varies and depends upon the initial condition of the patient’s  skin. Significant improvement of damaged skin has been achieved, which can  produce dramatic results.') ?></p>
							<p><strong><?= __t('Skin Rejuvenation') ?></strong></p>
							<p><?= __t('A skin rejuvenation program is often used in conjunction with either chemical  peels or laser wrinkle removal to reduce the fine wrinkles of the face, lighten  areas of hyperpigmentation and produce a softer texture to the skin. The  program can be accomplished separately or in conjunction with the other  procedures listed here and is followed at home by the patient after a  consultation and a treatment plan is established for the patient’s cosmetic  needs. Our skin care department is dedicated to providing you with the latest  and most effective skin treatments available.') ?></p>
							<p><?= __t('We invite you  to inquire about laser skin resurfacing and hope it can help you achieve  smoother, fresher, younger-looking skin.') ?></p>
						</div>
					</div>
				</div>
			</div>
