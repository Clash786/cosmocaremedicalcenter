...
<head>
	...
	<meta name="description" content="<?= __t('TPRX Meso Treatment') ?>  <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, <?= __t('TPRX Meso Treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('TPRX Meso Treatment Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="tprx-meso.php"><?= __t('Tprx Meso') ?></a></li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('TPRX MESO') ?></h1>
							<p><?= __t('Establishing the Power of Rejuvenation and Science Behind TPRX Mesotherapy at Cosmocare Medical Center') ?>
							</p>
							<div class="service-img">
								<a href="tprx-meso.php"><img src="images/mesotprx.jpg"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Establishing the Power of Rejuvenation and Science Behind TPRX Mesotherapy at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we\'re committed to providing cutting-edge solutions for achieving a youthful, radiant, and even-toned complexion. TPRX Mesotherapy offers a groundbreaking approach to address aging skin concerns, acne, pigmentation, and fine lines. This targeted treatment utilizes Dermapen technology and a scientifically formulated TPRX solution to gently exfoliate the skin, minimize the appearance of blemishes, and promote a smoother, firmer, and more youthful appearance.') ?>
							</p>
							<h3><?= __t('Demystifying the Power of the TPRX Formula') ?></h3>
							<p><?= __t('The success of TPRX Mesotherapy lies in its unique and potent formula:') ?></p>
							<ul>
								<li><?= __t(' Tartaric Acid: This alpha hydroxy acid gently exfoliates the surface layers of the skin, removing dead skin cells and promoting cell turnover. This helps reduce blemishes, fade pigmentation, and minimize the appearance of fine lines.') ?>
								</li>
								<li><?= __t(' Î±-Arbutin: A natural skin brightener, Î±-arbutin helps reduce hyperpigmentation by inhibiting the production of melanin, leading to a more even skin tone.') ?>
								</li>
								<li><?= __t(' Kojic Acid: Another natural skin lightening agent, kojic acid further combats hyperpigmentation and promotes a brighter complexion.') ?>
								</li>
								<li><?= __t(' Hydrogen Peroxide: This mild antiseptic helps cleanse the skin and create a more receptive environment for the other ingredients to penetrate deeper.') ?>
								</li>
							</ul>
							<h3><?= __t('A Harmonious Approach to Skin Rejuvenation') ?></h3>
							<p><?= __t('TPRX Mesotherapy works through a powerful combination of advanced technologies and a unique solution:') ?>
							</p>
							<ul>
								<li><?= __t(' Dermapen Technology: Microneedling with a Dermapen creates tiny channels in the skin, triggering the body\'s natural healing response. This stimulates collagen production and enhances the absorption of the potent TPRX solution.') ?>
								</li>
								<li><?= __t(' TPRX Solution: This proprietary blend of ingredients works synergistically to exfoliate, brighten, and stimulate skin regeneration, promoting a smoother, firmer, and more youthful appearance.') ?>
								</li>
								<li><?= __t(' Targeted Treatment: The treatment can be tailored to address specific areas of concern, ensuring optimal results.') ?>
								</li>
							</ul>
							<h3><?= __t('A Treatment Tailored for Oily Skin and Beyond') ?></h3>
							<p><?= __t('TPRX Mesotherapy offers a versatile solution for various skin concerns, but is particularly beneficial for those with oily skin:') ?>
							</p>
							<ul>
								<li><?= __t(' Regulates Oil Production: The treatment can help regulate oil production, preventing future breakouts and promoting a more balanced complexion.') ?>
								</li>
								<li><?= __t(' Minimizes Pores: By promoting cell turnover and reducing oil production, TPRX Mesotherapy helps minimize the appearance of enlarged pores.') ?>
								</li>
							</ul>
							<h3><?= __t('Releasing Visible Results: A Course of Treatment') ?></h3>
							<p><?= __t('Although TPRX Mesotherapy typically requires a series of treatments for optimal results, its unique composition, the solution acts very quickly, and almost instantly, penetrates the dermis, activates skin regeneration and renewal without harming the epidermis:') ?>
							</p>
							<h4><?= __t('3 Sessions:') ?></h4>
							<p> <?= __t('A series of 3 sessions spaced two weeks apart is typically recommended to achieve significant improvements.') ?>
							</p>
							<h3><?= __t('The Perfect Synergy: TPRX Mesotherapy and HydraFacial') ?></h3>
							<p><?= __t('For an even more comprehensive approach to achieving a clear and radiant complexion, consider combining TPRX Mesotherapy with a HydraFacial treatment:') ?>
							</p>
							<ul>
								<li><?= __t(' Deep Exfoliation and Hydration: HydraFacial gently exfoliates dead skin cells and impurities, while also delivering deep hydration. This prepares the skin for optimal absorption of the TPRX solution and promotes overall skin health.') ?>
								</li>
								<li><?= __t(' Enhanced Results: The combination of these treatments can lead to even more dramatic improvements in skin texture, tone, and overall appearance.') ?>
								</li>
							</ul>
							<div class="service-img">
