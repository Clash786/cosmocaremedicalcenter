...
<head>
	...
	<meta name="description" content="<?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about jaw tumor surgery or treatment with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?>" />
	<meta name="keywords" content="<?= __t('jaw tumor surgery dubai, jaw tumor treatment, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Jaw Tumor Surgery in Dubai | Specialist Jaw Tumor Treatment | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="tumor-of-jaw.php"><?= __t('Tumor of Jaw') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Jaw Tumor Surgery in Dubai') ?></h1>
							<p><?= __t('To gather more information about your jaw tumor or cyst, we may recommend tests prior to treatment. These tests may include:') ?></p>
							<ul>
								<li><?= __t('Imaging studies, such as X-ray, CT or MRI') ?></li>
								<li><?= __t('A biopsy to remove a sample of tumor or cyst cells for laboratory analysis') ?></li>
							</ul>
							<p><?= __t('Comocare use this information to put together a treatment plan that\'s best for you and the most effective option for treating your tumor or cyst.') ?>
							</p>
							<div class="service-img">
								<img src="images/tumor-of-jaw-dubai.svg" width="100%" class="img-fluid" alt="jaw tumor surgery and treatment in Dubai by Cosmocare Medical Center">
							</div>
							<div>
								<h2><?= __t('Jaw Tumor Treatment') ?></h2>
								<p><?= __t('Treatment options for jaw tumors and cysts vary, depending on the type of lesion you have, the lesion\'s stage of growth and your symptoms. Your treatment team also considers your treatment goals and your personal preferences when making a treatment recommendation.') ?>
								</p>
								<p><?= __t('Treatment of jaw tumors and cysts generally involves surgical care. In some cases, treatment may be medical therapy or a combination of surgery and medical therapy.') ?>
								</p>
								<p><?= __t('During surgery, your surgeon removes your jaw tumor or cyst, which may include removing nearby teeth, tissue and jawbone, and sends it to the lab for examination. A pathologist examines the removed tissue and reports a diagnosis during the procedure so that the surgeon can act on this information immediately.') ?>
								</p>
								<p><?= __t('Other treatments may include:') ?></p>
								<ul>
									<li><?= __t('Reconstruction of the jawbone or other structures') ?></li>
									<li><?= __t('Medical therapy for certain types of jaw tumors and cysts') ?></li>
									<li><?= __t('Supportive care to help maintain your quality of life, including   assisting with nutrition, speech and swallowing, and replacements for   missing teeth') ?></li>
								</ul>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p><?= __t('Dr. Lavanya/ Dr Samir and his staff at Cosmocare would be happy to discuss the details about jaw tumor surgery or treatment with you. To schedule an appointment in Dubai, UAE, please call our office at 04-3798747 or request an appointment online.') ?></p>
								<p></p>
								<p>
