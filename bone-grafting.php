...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare offers Bone Grafting: Laying the Groundwork for Dental Implants in Dubai. What is bone grafting? Bone grafting is a very common procedure during which we implant donated bone (usually from elsewhere in your body Call now 043798747') ?>" />
	<meta name="keywords" content="<?= __t('bone grafting, dental implants, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Bone Grafting for Dental Implants in Dubai | General Cosmetic Dentist  | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="bone-grafting.php"><?= __t('Bone Grafting') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Bone Grafting Dubai') ?></h1>
							<h4><?= __t('Bone Grafting: Laying the Groundwork for Dental Implants') ?></h4>
							<p><?= __t('In order to place a dental implant, there must first be adequate jawbone. Without sufficient bone mass, the dental implant is more likely to fail early or have trouble fusing with the existing bone at all. For this reason, bone grafting is sometimes required before the implant is placed.') ?></p>
							<div class="service-img">
								<img src="images/bone-grafting-dubai.svg" width="100%" class="img-fluid" alt="Bone Grafting: Laying the Groundwork for Dental Implants in Dubai by Cosmocare Medical Center">
							</div>
							<h4><?= __t('Dental Implants: Will I need bone grafting?') ?></h4>
							<p><?= __t('Only a thorough examination in our office can tell us if you will   need a bone graft, but here are a few commonly occurring instances that   often indicate its necessity:') ?></p>
							<ul>
								<ul>
									<li><strong><?= __t('When a tooth has been missing for several months') ?></strong> <?= __t('or   more. If you lost a tooth or had an extraction and didn\'t have an   implant or graft placed at the same time, your jawbone has likely   deteriorated.') ?></li>
									<li><?= __t('You experienced') ?> <strong><?= __t('trauma or infection') ?></strong> <?= __t('that caused defect in the bone.') ?></li>
									<li><strong><?= __t('Missing front teeth.') ?> </strong><?= __t('The walls of the front teeth sockets are often very thin and have a difficult time regenerating on their own.') ?></li>
									<li><strong><?= __t('Sinus cavities that are very large') ?></strong> <strong><?= __t('or low.') ?> </strong><?= __t('In this case, a œsinus lift may be required to help restore the bone height needed for implant placement.') ?></li>
								</ul>
							</ul>
							<h4><?= __t('What is bone grafting?') ?></h4>
							<p><?= __t('Bone grafting is a very common procedure during which we implant donated bone (usually from elsewhere in your body) and a special grafting material into the site that needs bulking up. The jaw is then left to heal for several months while your body grows new bone in the area.') ?></p>
							<h4><?= __t('Does bone grafting add more time to the implant process?') ?></h4>
							<p><?= __t('Yes, it takes several months for new bone to grow in the jaw. Once the bone is adequately rejuvenated, Dr. Lavanya, and Dr. Samir can resume the implant process.') ?></p>
							<h4><?= __t('What is recovery from bone grafting like?') ?></h4>
							<p><?= __t('Bone grafting may cause some post-op soreness for a few days, but typically this mild pain can be managed with over-the-counter medications. Any necessary prescriptions will be discussed at your appointment.') ?><br>
								<?= __t('For more details on bone grafting and to find out how soon you can have your implants placed, please give us a call!') ?></p>
							<p></p>
							<p>
