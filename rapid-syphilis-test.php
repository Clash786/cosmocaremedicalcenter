...
<head>
	...
	<meta name="description" content="<?= __t('Get a Rapid Syphilis Test at Cosmocare Medical Center, Dubai. Quick, accurate, and confidential STD testing and treatment by expert healthcare professionals. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>" />
	<meta name="keywords" content="<?= __t('Rapid Syphilis Test Dubai, STD testing Dubai, syphilis testing Dubai, confidential STD test, Cosmocare Medical Center, sexual health clinic Dubai') ?>" />
	...
	<title><?= __t('Rapid Syphilis Test | STD Testing & Treatment Dubai - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Rapid Syphilis Testing with Accurate Results') ?></li>
										<li><?= __t('Comprehensive STD Screening and Diagnosis') ?></li>
										<li><?= __t('Confidential and Private Consultations') ?></li>
										<li><?= __t('Same-Day Testing and Treatment Options') ?></li>
										<li><?= __t('Expert Sexual Health Advice by Qualified Doctors') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Sexual Health & STD Specialist') ?></h6>
							</div>
						...
						<p><?= __t('At Cosmocare Medical Center, our team provides expert and confidential rapid syphilis testing in Dubai. Our specialists ensure accurate results and offer comprehensive guidance on prevention, treatment, and overall sexual health. We prioritize patient comfort, privacy, and timely care.') ?></p>
						<p><?= __t('With years of experience in sexual health and infectious disease management, our doctors combine medical precision with personalized care to help patients maintain safe and healthy lifestyles. Our commitment to excellence and confidentiality makes us one of the most trusted centers in Dubai for rapid STD testing and sexual health services.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Sexual Health & Rapid STD Testing by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/rapid-syphilis-test1.jpg" class="img-fluid" alt="Rapid Syphilis Test at Cosmocare Medical Center Dubai - Accurate and Same-Day Results"></div>
									<div class="col-sm-4"><img src="images/content/rapid-syphilis-test.jpg" class="img-fluid" alt="Rapid Syphilis Test at Cosmocare Medical Center Dubai - Accurate and Same-Day Results"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked what makes sexual health care so rewarding, Dr. Murtuza said, "My work is fulfilling because timely testing and treatment, even for a single patient, can significantly improve their health, confidence, and peace of mind. Helping people take charge of their sexual well-being is what motivates me every day."') ?></p>
							</div>
						</div>
