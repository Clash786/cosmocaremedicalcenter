...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$mouthguard"; ?><?= __t('Custom Sports Mouthguard in Dubai for Boxing, Rugby, Sports and Martial Arts designed by Dr. AQR Expert in sports dentistry and orthodontics. Cosmocare offers most affordable sports mouthguard just') ?> <?php include 'price.php'; echo "$mouthguard"; ?> <?= __t('only. If you have any further questions, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('custom sports mouthguard dubai, braces in Dubai, Satwa Jumeirah 2, Tooth Extraction, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$mouthguard"; ?><?= __t('Custom Sports Mouthguard Dubai? for Boxing, Rugby, Sports and Martial Arts |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							echo "$mouthguard"; ?><?= __t('Custom Sports Mouthguard in Dubai') ?></h1>
							<h4><?= __t('Sports Dentistry in Dubai') ?></h4>
							<p><?= __t('At Cosmocare Medical Center, we provide an exceptional quality of Sports Mouthguards in jumeirah Dubai. The dental center is managed by a team of qualified professionals with a wide range of experience in hospital management.') ?>
							</p>
							<h1><?= __t('Custom Mouthguards That Protect & Perform') ?> </h1>
							<p><?= __t('One hit can change the gameand your smile.  At Cosmocare Medical Center, we craft custom-fit mouthguards designed by Dr.  AQR for ultimate protection, comfort, and performance. Whether you\'re a pro  athlete or part of a school sports team, our mouthguards help you play with  confidence and protect what matters mostyour teeth.') ?>
							</p>
							...
							<p><strong><?= __t('Why Choose a Custom Sports Mouthguard?') ?></strong></p>
							<p><?= __t('Perfect  Fit, Maximum Comfort Designed to fit your exact bite, allowing easy speech  and breathing.') ?>
								<br>
								<?= __t('Advanced  Protection Reduces the risk of broken teeth, jaw injuries, and  concussions.') ?>
								<br>
								<?= __t('Built to  Last High-quality materials ensure durability through every season.') ?>
								<br>
								<?= __t('Stylish  &amp; Branded Customize with team colors, logos, and your name!') ?>
							</p>
							<p><strong><?= __t('Who Needs a Sports Guard?') ?></strong></p>
							<p><?= __t('Custom dental guards are essential for:') ?><br>
								- <strong><?= __t('Contact Sports') ?></strong>
								<?= __t('Rugby, boxing,  football, martial arts, basketball, hockey') ?> <br>
								- <strong><?= __t('Action Sports') ?></strong>
								<?= __t('Skateboarding,  cycling, gymnastics, horse riding') ?> <br>
								- <strong><?= __t('Youth &amp; School Athletes') ?></strong>
								<?= __t(' Ideal for kids, teens, and young adults in active sports programs') ?></p>
							<p><strong><?= __t('Types of Mouthguards') ?></strong></p>
							<ul>
								<li><?= __t('Stock Guards Basic, low-cost,  but offer minimal fit or protection') ?>
								</li>
								<li><?= __t('Boil &amp; Bite Semi-custom,  better than stock but still limited in performance') ?>
								</li>
								<li><strong><?= __t('Custom Mouthguards') ?></strong>
									<?= __t('(Recommended) Precision-fit, high-impact resistance, long  wear-time') ?>
								</li>
							</ul>
							<p><?= __t('&nbsp;') ?></p>
							<p><?= __t('At Cosmocare Medical Center, we offer  digitally designed, custom-fit guards crafted using 3D scans for the most  secure and comfortable fit.') ?>
							</p>
							<p><strong><?= __t('Team Mouthguards for Schools &amp;  Sports Clubs') ?></strong></p>
							<ul>
								<li><?= __t('School &amp; University  Teams') ?> </li>
								<li><?= __t('Professional Sports Clubs') ?> </li>
								<li><?= __t('Community Sports Groups') ?></li>
							</ul>
							<p><?= __t('&nbsp;') ?></p>
							<p><?= __t('Stand out on the field and stay protected.  We design team-branded mouthguards with logos, player names, and colorsgreat  for team spirit and sponsorship visibility.') ?>
							</p>
							<p><?= __t('Partner with Dr AQR and Cosmocare Medical  Center as your official Teeth Protection Partner') ?>
								<br>
								<?= __t('We offer special packages and bulk rates  for schools, universities, and clubs looking to equip their teams with  high-performance, custom-branded sports guards.') ?>
							</p>
							<p><?= __t('Why Custom Mouthguards @Cosmocare Medical  Center?') ?></p>
							<ul>
								<li><?= __t('Designed by Dr. AQR Expert in sports dentistry and  orthodontics') ?> </li>
								<li><?= __t('Digital Precision Advanced 3D scanning ensures exact fit and  comfort') ?>
								</li>
								<li><?= __t('Trusted by Athletes From amateurs to professionals across  Dubai') ?> </li>
								<li><?= __t('High-Performance Materials Built for impact, designed for  endurance') ?>
								</li>
							</ul>
							<p><?= __t('&nbsp;') ?></p>
							<p><strong><?= __t('Let\'s Keep That Winning Smile Safe') ?> </strong></p>
							<p><?= __t('Protect your teeth while giving your best  on the field. Whether you\'re playing for fun or representing your school or  country, your gear isn\'t complete without a custom mouthguard.') ?>
							</p>
							<p><?= __t('Book your fitting today or Contact us to become an official mouthguard  partner for your team or academy.') ?>
							</p>
							<div>
								<h3><?= __t('Quality aligners') ?></h3>
							</div>
							<p><?= __t('Our aligners are produced in our state-of-the-art facility to the highest international standards meaning you get quality invisible teeth aligners.') ?>
							</p>
							<div>
								<h3><?= __t('Clear and') ?> <a
										href="tooth-colored-fillings.php"><?= __t('Tooth Colored') ?></a>
									<?= __t('Aligner') ?></h3>
							</div>
							<p><?= __t('Cosmocare Medical Center Dubai is a specialized Dental Clinic to provide cutting-edge cosmetic dentistry procedures called Short Term Orthodontics:') ?>
							</p>
							<div>
								<h3><?= __t('Invisible Aligner') ?></h3>
							</div>
							<p><?= __t('This Aligner /') ?> <a href="braces.php"><?= __t('Braces') ?></a>
								<?= __t('Straightens your teeth using a series of nearly clear, removable aligners / braces that are custom made specifically for your teeth.') ?>
							</p>
							<div class="service-img">
								<a href="invisible-aligners.php"><img src="images/invisible-aligner.svg"
										alt="Invisible Aligner in Dubai by Cosmocare Medical Center" width="100%"
