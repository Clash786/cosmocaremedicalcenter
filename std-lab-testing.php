...
<head>
	...
	<meta name="description" content="<?= __t('Get confidential and accurate STD lab testing at Cosmocare Medical Center Dubai. Expert medical guidance for all STD tests including herpes, HIV, syphilis, and more. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('STD Lab Testing Dubai, STD Tests Dubai, Herpes Test Dubai, HIV Test Dubai, Syphilis Test Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('STD Lab Testing in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Expert in STD Lab Testing and Treatments') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('STD specialist') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. He provides comprehensive and accurate') ?> <b><?= __t('STD lab testing') ?></b> <?= __t('along with effective treatment options for various') ?> <b><?= __t('sexually transmitted infections (STIs)') ?></b> <?= __t('and related skin conditions. Dr. Murtuza ensures complete confidentiality, compassionate care, and advanced dermatological solutions for patients seeking reliable and safe results.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala specializes in detecting and managing') ?> <b><?= __t('herpes simplex virus (HSV)') ?></b>, <b><?= __t('HIV') ?></b>, <b><?= __t('syphilis') ?></b>, <b><?= __t('trichomoniasis') ?></b><?= __t(', and other') ?> <b><?= __t('STD-related skin issues') ?></b> <?= __t('through professional lab testing and expert treatments. His patient-centered approach, combined with advanced dermatology techniques, ensures accurate diagnosis, safe care, and optimal recovery for those seeking trusted') ?> <b><?= __t('STD testing and treatment in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD Lab Testing & Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai.jpg" class="img-fluid" alt="STD Lab Testing and Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai1.jpg" class="img-fluid" alt="STD Lab Testing and Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai2.jpg" class="img-fluid" alt="STD Lab Testing and Dermatology Treatments in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was concerned about possible STD symptoms and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. The testing and consultation were handled with exceptional care and professionalism.') ?> <b><?= __t('Dr. Murtuza') ?></b> <?= __t('explained the process clearly, ensured my confidentiality, and made me feel completely at ease. I\'m truly grateful for his expertise and the accurate, reliable results provided."') ?></p>
							</div>
						</div>
