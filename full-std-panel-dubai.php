...
<head>
	...
	<meta name="description" content="<?= __t('Get a Full STD Panel Test in Dubai at Cosmocare Medical Center. We offer confidential, accurate, and comprehensive STD testing for HIV, Hepatitis, Syphilis, Herpes, and more. Call 04 379 8747 or email info@cosmocaremedicalcenter.com for same-day appointments.') ?>">
	<meta name="keywords" content="<?= __t('Full STD panel Dubai, STD test Dubai, HIV test Dubai, Syphilis test Dubai, Hepatitis test Dubai, Herpes test Dubai, STD screening Dubai, Sexual health clinic Dubai, Confidential STD testing Dubai, Cosmocare Medical Center') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Full STD Panel Test in Dubai | Confidential STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive Full STD Panel Testing') ?></li>
										<li><?= __t('HIV, Hepatitis B & C, and Syphilis Tests') ?></li>
										<li><?= __t('Herpes, Chlamydia & Gonorrhea Screening') ?></li>
										<li><?= __t('Confidential & Accurate Laboratory Results') ?></li>
										<li><?= __t('Same-Day Appointments and Discreet Consultations') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('General Physician & STD Testing Specialist') ?></h6>
							</div>
						...
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', our expert general physicians and laboratory specialists provide comprehensive and confidential') ?> <b><?= __t('Full STD Panel Testing') ?></b> <?= __t('in Dubai. We ensure accurate and reliable results for all major sexually transmitted infections, including HIV, Hepatitis B & C, Syphilis, Herpes, Chlamydia, and Gonorrhea. Our goal is to offer quick, private, and professional testing services in a safe and comfortable environment.') ?></p>
						<p><?= __t('Whether you need routine screening or have specific symptoms, our medical team ensures complete discretion and professional care throughout the process. The') ?> <b><?= __t('Full STD Panel Test') ?></b> <?= __t('helps in early detection, effective treatment, and peace of mind. At Cosmocare Medical Center, your privacy and health are our top priorities.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD Testing & Sexual Health Services at') ?> <span class="theme-color text-nowrap"><?= __t('Cosmocare Medical Center') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/full-std-panel-test-dubai.jpg" class="img-fluid" alt="Confidential Full STD Panel Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/std-blood-test-panel-dubai1.jpg" class="img-fluid" alt="Confidential Full STD Panel Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/std-blood-test-panel-dubai2.jpg" class="img-fluid" alt="Confidential Full STD Panel Testing in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was very anxious about getting tested, but the team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b> <?= __t('made the entire') ?> <b><?= __t('STD testing') ?></b> <?= __t('process completely private and professional. The staff was understanding and respectful, and I received my') ?> <b><?= __t('Full STD Panel') ?></b> <?= __t('results quickly and confidentially. I truly appreciate their compassionate care and recommend Cosmocare to anyone seeking reliable') ?> <b><?= __t('STD testing in Dubai') ?></b>."</p>
							</div>
						</div>
