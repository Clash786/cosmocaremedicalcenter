...
<head>
	...
	<meta name="description" content="<?= __t('A quality-switched laser (Q-Switched is a non-invasive laser that creates high-intensity pulsed beam light. Our Expert Dermatologist Dr Murtuza Bandukwala, depending upon the condition of the patient decides the mode of treatment.') ?>" />
	<meta name="keywords" content="<?= __t('Q Switched laser, Q Switched laser treatment dubai') ?>" />
	...
	<title><?= __t('Q Switched laser by Specialist Doctor in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu2">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="q-switch-laser.html"><?= __t('Q Switch laser') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Q Switched laser') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/qswitched-laser.jpg" class="img-fluid" alt="Q Switched laser dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('A quality-switched laser (Q-Switched) is a  non-invasive laser that creates high-intensity pulsed beam light. The  Q-Switched laser beam pulses last a mere billionth of a second. The energy  emitted from a Q-switched laser is concentrated into very powerful pulses. it can be naturally reabsorbed and disposed of  by the body.') ?> </p>
							<p><?= __t('Q-Switched lasers are  able to shatter tiny fragments of pigmentation or ink, stimulate collagen  production or kill fungus since their contact with the skin is less than other  lasers, Q-Switched lasers are known for not damaging surrounding tissue and  causing unwanted side effects.') ?></p>
							<p><?= __t('We at Cosmocare Medical Center,  have the latest and most advanced laser machine from Quanta System . Quanta is  an100% Italian company and the Global  leader in manufacturing laser products since 1985.. The Q Plus series is the ideal solution to perform a great range of treatments like:') ?></p>
							<ul type="disc">
								<li><a href="https://www.verywellhealth.com/laser-tattoo-removal-q-a-with-dr-will-kirby-facos-2710228"><?= __t('Tattoo removal') ?></a> </li>
								<li><?= __t('Skin resurfacing') ?></li>
								<li><?= __t('Skin /Facial rejuvenation') ?></li>
								<li><?= __t('Hair Bleaching') ?></li>
								<li><?= __t('Age spots removal') ?></li>
								<li><?= __t('Sunspots removal') ?> </li>
								<li><?= __t('Birthmarks removal') ?></li>
								<li><?= __t('Freckles removal') ?></li>
								<li><?= __t('Carbon Peeling') ?></li>
								<li><?= __t('Pigmentation') ?></li>
							</ul>
							<p><?= __t('Our Expert Dermatologist  Dr Murtuza Bandukwala, depending upon the condition of the patient decides the  mode of treatment.') ?></p>
							<p><?= __t('The latest generation Q switched laser technology, associated  with Quanta System’s laser treatment, ensures not only complete tattoo, age  spots, birthmarks, freckle, sunspots removal but also an effect of skin  regeneration bringing the skin close to its original texture. This is an ideal  solution to perform the greatest range of benign pigmented lines, tattoo  removal and skin resurfacing treatment with fast treatments and safety.') ?></p>
						</div>
					</div>
				</div>
			</div>
