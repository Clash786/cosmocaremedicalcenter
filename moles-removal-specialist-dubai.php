...
<head>
	...
	<meta name="description" content="<?= __t('Consult the top mole removal specialist in Dubai at Cosmocare Medical Center. Expert treatments for mole removal, skin lesion management, dermatology care, and advanced skin solutions. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Mole removal Dubai, Dermatologist Dubai, Skin lesion treatment Dubai, Cosmetic dermatology Dubai, Dermatology clinic Dubai, Skin care specialist Dubai, Mole treatment Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Mole Removal Specialist in Dubai | Dermatology at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Dermatologist & Mole Removal Specialist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Cosmetic Dermatology Procedures') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Mole Removal Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('Mole Removal Specialist') ?></b> <?= __t('at Cosmocare Medical Center Dubai. With extensive experience in dermatology, he provides advanced solutions for various skin concerns, including mole and skin lesion removal, pigmentation treatments, acne management, and overall skin rejuvenation. Dr. Murtuza ensures that every patient receives a personalized approach for safe and effective results.') ?></p>
						<p><?= __t('As part of the expert team at Cosmocare Medical Center, Dr. Murtuza Bandukwala focuses on identifying the root causes of skin problems and designing treatment plans that combine modern medical techniques with compassionate care. His dedication to innovation and continuous learning ensures that patients receive the most effective and professional mole removal and dermatology services in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Mole Removal Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/moles-removal-specialist-dubai2.jpg" class="img-fluid" alt="Expert Mole Removal Treatments in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/moles-removal-specialist-dubai.jpg" class="img-fluid" alt="Expert Mole Removal Treatments in Dubai"></div>
									<div class="col-sm-4"><img src="images/content/moles-removal-specialist-dubai1.jpg" class="img-fluid" alt="Expert Mole Removal Treatments in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had a large mole that I wanted safely removed, and after consulting Dr. Murtuza Bandukwala at Cosmocare Medical Center, the procedure was smooth and painless. The mole was removed perfectly, and my skin looks flawless now. Dr. Murtuza truly understands how to provide expert dermatology care."') ?></p>
							</div>
						</div>
