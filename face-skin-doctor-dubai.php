...
<head>
	...
	<meta name="description" content="<?= __t('Consult the best face skin doctor in Dubai at Cosmocare Medical Center. Expert in acne, pigmentation, facial rejuvenation, mole removal, and advanced skin treatments. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Face skin doctor Dubai, Skin care specialist Dubai, Dermatologist Dubai, Acne treatment Dubai, Pigmentation treatment Dubai, Facial rejuvenation Dubai, Mole removal Dubai, Anti-aging treatments Dubai, Cosmetic dermatology Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Face Skin Doctor in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Acne and Pigmentation Treatments for Face') ?></li>
										<li><?= __t('Mole and Skin Lesion Removal on Facial Skin') ?></li>
										<li><?= __t('Anti-Aging and Facial Skin Rejuvenation') ?></li>
										<li><?= __t('Laser Therapies for Facial Skin Conditions') ?></li>
										<li><?= __t('PRP Therapy for Facial Skin Rejuvenation') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Facial Skin Specialist') ?></h6>
							</div>
						...
						<p><b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('is a board-certified dermatologist and a leading') ?> <b><?= __t('facial skin specialist') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center Dubai') ?></b><?= __t('. With extensive experience in dermatology, he provides advanced solutions for a wide range of') ?> <b><?= __t('facial skin concerns') ?></b><?= __t(', including acne, pigmentation, mole removal, anti-aging, and overall facial rejuvenation. Dr. Murtuza believes in delivering personalized treatment plans to help patients achieve clear, healthy, and radiant') ?> <b><?= __t('facial skin') ?></b>.</p>
						<p><?= __t('As part of the expert team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on identifying the root causes of') ?> <b><?= __t('facial skin problems') ?></b> <?= __t('and designing treatments that combine modern medical techniques with compassionate patient care. His commitment to continuous learning and adopting innovative dermatology methods ensures safe, effective, and long-lasting results for all patients seeking the best') ?> <b><?= __t('facial skin care') ?></b> <?= __t('in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Facial Skin Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="row row-sm-space pt-2">
										<div class="col-sm-4"> <img src="images/content/face-skin-doctor-dubai.jpg" class="img-fluid" alt="Expert Facial Skin Treatments in Dubai at Cosmocare Medical Center"></div>
										<div class="col-sm-4"> <img src="images/content/face-skin-doctor-dubai1.jpg" class="img-fluid" alt="Expert Facial Skin Treatments in Dubai at Cosmocare Medical Center"></div>
										<div class="col-sm-4"> <img src="images/content/face-skin-doctor-dubai2.jpg" class="img-fluid" alt="Expert Facial Skin Treatments in Dubai at Cosmocare Medical Center"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had been struggling with acne and uneven skin tone on my face for years, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a remarkable improvement in my facial skin within a few sessions. He truly understands how to treat facial skin concerns effectively and helped me regain my confidence with healthy, radiant skin."') ?></p>
							</div>
						</div>
