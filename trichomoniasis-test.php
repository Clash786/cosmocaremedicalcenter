...
<head>
	...
	<meta name="description" content="<?= __t('Get accurate Trichomoniasis testing in Dubai at Cosmocare Medical Center. Confidential and reliable STD testing with expert care. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Trichomoniasis test Dubai, STD testing Dubai, Sexual health clinic Dubai, Trichomoniasis diagnosis Dubai, Confidential STD test Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Trichomoniasis Test in Dubai | Accurate STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Trichomoniasis Testing and Diagnosis') ?></li>
										<li><?= __t('Comprehensive STD Screening') ?></li>
										<li><?= __t('Rapid and Accurate Laboratory Tests') ?></li>
										<li><?= __t('Sexually Transmitted Infection (STI) Consultation') ?></li>
										<li><?= __t('Confidential and Professional Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Expert in Trichomoniasis and STD Testing') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('STD and Trichomoniasis testing specialist') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in sexually transmitted infection diagnosis, he provides accurate') ?> <b><?= __t('Trichomoniasis testing') ?></b> <?= __t('and effective management of various') ?> <b><?= __t('STDs') ?></b><?= __t('. Dr. Murtuza ensures personalized care, confidentiality, and reliable results for every patient seeking professional STD services.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala focuses on early detection and expert management of') ?> <b><?= __t('Trichomoniasis and other sexually transmitted infections') ?></b><?= __t('. His expertise and patient-centered approach ensure accurate testing, safe care, and optimal recovery for those seeking trusted STD testing in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Trichomoniasis & STD Testing Services by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test-dubai.jpg" class="img-fluid" alt="Trichomoniasis and STD Testing Services in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test-dubai1.jpg" class="img-fluid" alt="Trichomoniasis and STD Testing Services in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/trichomoniasis-test-dubai3.jpg" class="img-fluid" alt="Trichomoniasis and STD Testing Services in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was concerned about a possible Trichomoniasis infection and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. The testing and consultation were handled with exceptional care and professionalism.') ?> <b><?= __t('Dr. Murtuza') ?></b> <?= __t('explained every step clearly, ensured my confidentiality, and provided accurate results with a personalized care plan. I\'m truly grateful for his expertise and the reliable testing services."') ?></p>
							</div>
						</div>
