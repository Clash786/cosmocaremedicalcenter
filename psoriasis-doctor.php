...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$psoriasis_doctor"; ?> <?= __t('Expert Psoriasis Doctor in Dubai by Dr. Murtaza Providing advanced psoriasis care, personalized treatments & skin management. For any queries, call us at ') ?><?php echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo "$email"; ?> <?= __t('to BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$psoriasis_keywords"; ?>, <?= __t('psoriasis-doctor-dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$psoriasis_doctor"; ?> <?= __t('- Psoriasis Doctor in Dubai |') ?> <?php echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<div class="title-wrap">
								...
								<h1><?php echo $psoriasis_consultation; ?> <?php echo $psoriasis_doctor; ?>
									<?= __t('Treatment in Dubai') ?></h1>
								<h3><?= __t('Psoriasis Treatment in Dubai') ?></h3>
								<h1><?= __t('Restore Healthy Skin. Regain Confidence. Feel Your Best.') ?></h1>
								<h1><?= __t('Achieve Clearer Skin and Confidence') ?></h1>
								<p><?= __t('At') ?>
									<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our specialists provide tailored psoriasis treatments, combining advanced therapies with compassionate care.') ?>
									<br><?= __t('From flare-up management to long-term skin health, Dr. Murtaza ensures your skin receives expert attention for lasting results.') ?>
								</p>
							</div>
							<div class="service-img">
								<a href="psoriasis-doctor.php">
									<img src="images/psoriasis-doctor1.jpg"
										alt="Psoriasis Doctor in Dubai by Cosmocare Medical Center"
										style="width:90%; max-width:400px;" border="0" class="img-fluid" />
								</a>
							</div>
						</div>
						<br>
						<h1><?= __t('Expert Psoriasis Doctor in Dubai') ?></h1>
						<p><?= __t('At') ?>
							<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we offer advanced psoriasis treatments under the expert care of') ?>
							<strong><?= __t('Dr. Murtaza') ?></strong><?= __t(', one of Dubai\'s most trusted dermatologists.') ?>
							<br><?= __t('Whether you\'re dealing with chronic psoriasis, flare-ups, or skin irritation, Dr. Murtaza and his team are dedicated to restoring your skin\'s health and confidence.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Psoriasis Treatment?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Personalized Treatment Plans:') ?></strong>
								<?= __t('Each patient receives a tailored treatment designed for their severity and skin type.') ?>
							</li>
							<li><strong><?= __t(' Advanced Dermatology Equipment:') ?></strong>
								<?= __t('We use the latest FDA-approved technology for safe and effective psoriasis management.') ?>
							</li>
							<li><strong><?= __t(' Expert Care by Dr. Murtaza:') ?></strong>
								<?= __t('Over a decade of experience in treating psoriasis and other chronic skin conditions.') ?>
							</li>
							<li><strong><?= __t(' Trusted by Patients Across Dubai:') ?></strong>
								<?= __t('Conveniently located in Satwa and Jumeirah 2, providing high-quality and compassionate care.') ?>
							</li>
						</ul>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Psoriasis Doctor in Dubai...'),
			'link' => 'psoriasis-doctor.php',
			'date' => 'July 25, 2021'
		],
	];
	$footer_nearby_areas = [
