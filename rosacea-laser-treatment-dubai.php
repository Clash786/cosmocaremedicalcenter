...
<head>
	...
	<meta name="description" content="<?= __t('Get expert Rosacea Laser Treatment in Dubai at Cosmocare Medical Center. Advanced solutions for rosacea, skin redness, and facial skin rejuvenation. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Rosacea laser treatment Dubai, Rosacea treatment Dubai, Laser skin treatment Dubai, Skin care specialist Dubai, Dermatologist Dubai, Skin rejuvenation Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Rosacea Laser Treatment in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Rosacea and Redness Reduction Treatments') ?></li>
										...
										<li><?= __t('Laser Therapies for Various Skin Conditions') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Rosacea Laser Treatment Specialist') ?></h6>
							</div>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/rosacea-laser-treatment-dubai.jpg" class="img-fluid" alt="Expert Rosacea Laser Treatment and Skin Care in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/rosacea-laser-treatment-dubai1.jpg" class="img-fluid" alt="Expert Rosacea Laser Treatment and Skin Care in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/rosacea-laser-treatment-dubai2.jpg" class="img-fluid" alt="Expert Rosacea Laser Treatment and Skin Care in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
