...
<head>
	...
	<meta name="description" content="<?= __t('cosmocare medical center Dental Clinic offers affordable Tooth Extraction in Dubai. Your modern dental clinic at 2nd December Street, Dubai. Call at ☎ 043798747 or email at info@cosmocaremedicalcenter.com for book an appointment') ?>" />
	<meta name="keywords" content="<?= __t('Tooth Extraction in Dubai, Tooth Extraction, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Affordable Tooth Extraction in Dubai | Tooth extraction in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="tooth-extractions.html"><?= __t('Tooth Extractions') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Vaccinate your child to strengthen his immune system.') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/child-vaccination-immunization.svg" width="100%" class="img-fluid" alt="child vaccination immunization in Dubai by Cosmocare Medical Center">
						</div>
						<div>
							<h2><?= __t('Why vaccinate your child?') ?></h2>
							<p>
								<?= __t('Vaccines use a tiny amount of antigens to help your child’s immune system recognize and learn to fight serious diseases.( Antigens are parts of germs that cause the body’s immune system to go to work). Without vaccines, we are at risk of serious illnesses like measles, meningitis, tetanus and polio. Many of these diseases can be life-threatening. WHO estimates that vaccines save between 2 and 3 million lives every year.') ?>
							</p>
							<h2><?= __t('Are vaccines safe?') ?></h2>
							<p>
								<?= __t('Safety of vaccines is well researched and documented. Several rounds of research, surveillance and clinical trials are carried out before a vaccine is approved for use. Billions of vaccine doses have been administered for almost 50 years and adverse effects are rare.') ?>
							</p>
							<h2><?= __t('When should I get my child vaccinated?') ?></h2>
							<p>
								<?= __t('Vaccines protect us throughout life and at different ages, from birth to teenagers and also old age. You will be given a vaccination card that tells you what vaccines you or your child have hadand when the next vaccines or booster doses are due. It is important to make sure that all these vaccines are up to date.') ?>
							</p>
							<h2><?= __t('I have delayed vaccination for my child. Can I still get him vaccinated?') ?></h2>
							<p>
								<?= __t('For most vaccines, it’s never too late to catch up. Talk to doctor about how to get any missed vaccination doses for yourself or your child.') ?>
							</p>
							<h2><?= __t('Can vaccines cause autism and/or mercury poisoning?') ?></h2>
							<p>
								<?= __t('No. Vaccines have been rumored to cause autism, but studies show no correlation between vaccines and autism. Some vaccine contains minute amount of thimerosol, but this is not enough to cause mercury poisoning.') ?>
							</p>
							<h6><?= __t('Here at Cosmocare Medical Center, our skilled and experienced dentists regularly perform dental procedures.') ?></h6>
