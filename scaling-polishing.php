...
<head>
	...
	<meta name="description" content="<?= __t('cosmocare medical center Dental Clinic offers affordable teeth scaling and polishing in Dubai. Your modern dental clinic at 2nd December Street, Dubai. Cosmocare Medical Center | Orthodontics✓ Children&#039;s dentist✓ Implantology✓ Dental aesthetics✓ ☎ 043798747') ?>" />
	<meta name="keywords" content="<?= __t('scaling and polishing, teeth scaling, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Affordable Teeth scaling and polishing Dental Clinic in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="scaling-polishing.html"><?= __t('Scaling and Polishing') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Teeth scaling &amp; polishing in Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/teeth-scaling-polishing.svg" width="100%" class="img-fluid" alt="Teeth scaling &amp; polishing and dental specialist Doctor in Dubai by Cosmocare Medical Center">
						</div>
						<div>
