...
<head>
	...
	<meta name="description" content="<?= __t('Get a same day herpes test in Dubai at Cosmocare Medical Center. Confidential, accurate, and rapid herpes testing with quick results. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Same day herpes test Dubai, Rapid herpes test Dubai, STD testing Dubai, Herpes diagnosis Dubai, Confidential herpes test Dubai, Sexual health clinic Dubai, Quick herpes results Dubai, Cosmocare Medical Center Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Same Day Herpes Test in Dubai | Rapid STD Testing at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Same-Day Herpes Testing and Diagnosis') ?></li>
										<li><?= __t('Confidential STD Screening') ?></li>
										<li><?= __t('Skin Lesion and Rash Evaluation') ?></li>
										<li><?= __t('Viral Skin Infection Management') ?></li>
										<li><?= __t('Comprehensive Sexual Health Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Expert in Same-Day Herpes and STD Treatments') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and a leading') ?> <b><?= __t('STD specialist') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. He provides rapid and accurate') ?> <b><?= __t('same-day herpes testing') ?></b> <?= __t('along with effective treatment options for various') ?> <b><?= __t('sexually transmitted skin conditions') ?></b><?= __t('. Dr. Murtuza ensures complete confidentiality, compassionate care, and advanced dermatological solutions for patients seeking fast and reliable results.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala specializes in detecting and managing') ?> <b><?= __t('herpes simplex virus (HSV)') ?></b> <?= __t('and other') ?> <b><?= __t('STD-related skin issues') ?></b> <?= __t('through same-day testing and expert treatments. His patient-centered approach, combined with advanced dermatology techniques, ensures quick diagnosis, safe care, and optimal recovery for those seeking trusted') ?> <b><?= __t('herpes and STD testing in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Same-Day Herpes & STD Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai.jpg" class="img-fluid" alt="Same-Day Herpes Test and STD Dermatology Treatments in Dubai"></div>
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai1.jpg" class="img-fluid" alt="Same-Day Herpes Test and STD Dermatology Treatments in Dubai"></div>
									<div class="col-sm-4"> <img src="images/content/rapid-herpes-test-dubai2.jpg" class="img-fluid" alt="Same-Day Herpes Test and STD Dermatology Treatments in Dubai"></div>
								</div>
							</div>
						</div>
