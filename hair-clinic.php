...
<head>
	...
	<title><?= __t('Hair Loss Treatment by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="hair-clinic.html"><?= __t('Hair Clinic') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Hair Loss Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/hair.jpg" class="img-fluid" alt="hair loss treatment">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Hair loss can affect just your scalp or your entire body. It can be the  result of') ?></p>
							<ul>
								<li><?= __t('heredity,') ?> </li>
								<li><?= __t('hormonal changes,') ?> </li>
								<li><?= __t('medical conditions,') ?></li>
								<li><?= __t('Medications.') ?> </li>
							</ul>
							<p><?= __t('Both Male and female can be affected by the hair loss.') ?><br>
								<?= __t('Hair loss is divided into') ?> </p>
							<ul>
								<li><strong><?= __t('Scaring ALopecia') ?> </strong></li>
								<li><strong><?= __t('Non scaring Alopecia') ?> </strong><?= __t('(includes Alopecia Areata, Androgenic alopecia, Male pattern of Baldnes and  Female pattern of Baldness, Telogen Effluvium etc)') ?></li>
							</ul>
							<p><?= __t('Baldness typically refers to excessive hair loss from your scalp.  Hereditary hair loss with age is the most common cause of baldness. Some people  prefer to let their hair loss run its course untreated and unhidden. Others may  cover it up with hairstyles, makeup, hats or scarves. And still others choose  one of the treatments available to prevent further hair loss and to restore  growth.') ?><br>
								<?= __t('Before pursuing hair loss treatment, talk with your doctor about the cause  of your hair loss and treatment options.') ?><br>
								<strong><?= __t('Risk factors') ?></strong><br>
								<?= __t('A number of factors can increase your risk of hair loss, including:') ?>
							</p>
							<ul>
								<li><?= __t('Family history of balding, in either of your parent\'s families') ?></li>
								<li><?= __t('Age') ?></li>
								<li><?= __t('Significant weight loss') ?></li>
								<li><?= __t('Certain medical conditions, such as diabetes and lupus') ?></li>
								<li><?= __t('Stress') ?></li>
							</ul>
							<p><?= __t('Hair loss in women often has a greater impact than hair loss does on men,  because it\'s less socially acceptable for them. Alopecia can severely affect a  woman\'s emotional well-being and quality of life.') ?> <br>
								<?= __t('So at our Hair clinic we take all step to diagnose and adress the hair loss  treatment according to cause of the hair loss.') ?></p>
							<p><strong><?= __t('TREATMENT') ?></strong><br>
								<?= __t('Treatments for hair loss include medications, Non invasive procedures and  surgery Like FUE and FUT hair transplant.') ?><br>
								<strong><?= __t('Medication') ?></strong> <?= __t('include') ?><br>
								<?= __t('Minoxidil, Anti Androgens, Finestride and Nurtitional Supplements') ?>
							</p>
							<p><strong><?= __t('Non Invasive procedure') ?></strong> <?= __t('Include') ?></p>
							<ul>
								<li><?= __t('Plasma Rich Platelet Therapy for Hair') ?></li>
								<li><?= __t('Mesotherapy') ?> </li>
								<li><?= __t('Stem cell therapy') ?></li>
								<li><?= __t('Acell with PRP treatment') ?></li>
								<li><?= __t('Scalp Micropigmentation') ?></li>
								<li><?= __t('Low level Laser') ?> </li>
							</ul>
							<p><strong><?= __t('Surgery') ?></strong> <?= __t('Include') ?></p>
							<ul>
								<ul>
									<li><?= __t('FUE (Folliclar unit Extraction) Hair transplantation') ?></li>
									<li><?= __t('FUT Hair transplantation') ?></li>
								</ul>
								<p><?= __t('&nbsp;') ?></p>
								<p></p>
						</div>
