...
// // Safe initialization
// $stitest = 'std test';
// if (isset($_GET['stitest'])) {
// 	$stitest = str_replace("-", " ", $_GET['stitest']);
// }
// $keyword = htmlspecialchars($stitest);
// // Include price.php once and reuse its variables
// include 'price.php';

// 1. Get the Slug from URL (htaccess passes it as 'stitest')
// The htaccess rule should be: RewriteRule ^std/(.*)\.html$ stdtest.php?stitest=$1 [L,QSA]
$slug = isset($_GET['stitest']) ? $_GET['stitest'] : '';

// 2. Default Variables (Fallback)
$page_title = __t('STD Testing in Dubai | Cosmocare Medical Center');
$meta_desc = __t('STD testing services in Dubai. Confidential and fast results.');
$meta_keys = __t('std test, dubai, cosmocare');
$content_title = __t('STD Testing');

// 3. Database Lookup
if (!empty($slug)) {
    // Prepare statement to prevent SQL Injection
    $stmt = $conn->prepare("SELECT * FROM std_keywords WHERE slug = ? AND category = 'home' LIMIT 1");
    ...
    if ($result->num_rows > 0) {
        ...
        $page_title = $row['meta_title'] ?? $row['title'];
        $meta_desc = $row['meta_description'];
        $meta_keys = $row['meta_keywords'];
        $content_title = $row['title'];
        // You can add a 'content' column to your DB later for the body text
    } else {
        // 404 - Page Not Found
        header("HTTP/1.0 404 Not Found");
        echo "Page not found"; // Or include your 404.php
        exit;
    }
}
...
<head>
	...
	<?php $keyword = $content_title; ?>
	<meta name="description" content="<?= __t('At Cosmocare, we would be happy to discuss the details about') ?> <?= __t($keyword) ?> <?= __t('with you. To schedule an appointment for') ?> <?= __t($keyword) ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> <?= __t('(Satwa) /') ?> <?= htmlspecialchars($contactjum) ?> (Jumeirah 2) <?= __t('to book an appointment.') ?>">
	<meta name="keywords" content="<?= __t($keyword) ?>, <?= htmlspecialchars($company) ?>, <?= __t('cosmocare, testing, treatment, dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>">
	<meta name="author" content="<?= htmlspecialchars($company) ?>">
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title>[<?= htmlspecialchars($hiv) ?>] ✅<?= __t('Looking for') ?> <?= __t($keyword) ?> <?= __t('in Dubai?') ?> <?= htmlspecialchars($company) ?></title>
	<!-- Stylesheets -->
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-auto d-flex align-items-center">
						<div class="header-phone"><i class="icon-telephone"></i><a href="tel:043798747">04 379 8747</a> <a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank">(Satwa)</a> / <a href="tel:043536164">04 353 6164</a> <a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank">(Jumeirah 2)</a>
						</div>
						<div class="header-info"><i class="icon-black-envelope"></i><a href="mailto:info@cosmocaremedicalcenter.com">info@cosmocaremedicalcenter.com</a></div>
					</div>
				...
				<div class="row no-gutters">
					<div class="col">
						...
						<div class="link-drop p-0">
							<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14440.378170371352!2d55.248548!3d25.200034!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bafc69af5ed%3A0xf076886ec5abfaf9!2sCosmocare%20Dermatology%2C%20PRP%20Hair%20Face%20Treatment%2C%20STD%20Testing%20Center!5e0!3m2!1sen!2sae!4v1732976241776!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
					</div>
					<div class="col">
						<a href="./../#" class="link">
						...
						<div class="link-drop">
							...
							<form id="requestForm" method="post" novalidate>
								...
								<div class="input-group">
									...
									<input name="requestname" type="text" class="form-control" placeholder="<?= __t('Your Name') ?>" />
								</div>
								<div class="row row-sm-space mt-1">
									<div class="col">
										<div class="input-group">
											...
											<input name="requestemail" type="text" class="form-control" placeholder="<?= __t('Your Email') ?>" />
										</div>
									</div>
									<div class="col">
										<div class="input-group">
											...
											<input name="requestphone" type="text" class="form-control" placeholder="<?= __t('Your Phone') ?>" />
										</div>
									</div>
								</div>
								...
								<div class="row row-sm-space mt-1">
									<div class="col-sm-6">
										<div class="input-group flex-nowrap">
											...
											<div class="datepicker-wrap">
												<input name="requestdate" type="text" class="form-control datetimepicker" placeholder="<?= __t('Date') ?>" readonly>
											</div>
										</div>
									</div>
									<div class="col-sm-6 mt-1 mt-sm-0">
										<div class="input-group flex-nowrap">
											...
											<div class="datepicker-wrap">
												<input name="requesttime" type="text" class="form-control timepicker" placeholder="<?= __t('Time') ?>" readonly>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col">
						<a href="./../#" class="link">
							<i class="icon-emergency-call"></i><span></span><?= __t('Emergency Case') ?></span></a>
						<div class="link-drop">
							...
							<ul class="icn-list">
								...
								<li><i class="icon-black-envelope"></i><a href="mailto:info@cosmocaremedicalcenter.com">info@cosmocaremedicalcenter.com</a></li>
							</ul>
			...
			<div class="breadcrumbs-wrap">
				<div class="container">
					<div class="breadcrumbs">
						<a href="./../index.php"><?= __t('Home') ?></a>
						<a href="./../services.php"><?= __t('Services') ?></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
						...
						<ul class="services-nav flex-column flex-nowrap">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu3">
									<ul class="flex-column nav">
										<li class="nav-item"><a class="nav-link  active" href="./../std-hiv-testing.html"><?= __t('STD HIV Test') ?></a></li>
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link" href="./../gum-disease.php"><?= __t('Gum Disease') ?></a></li>
										<li class="nav-item"><a class="nav-link" href="./../facial-trauma.php"><?= __t('Facial Trauma') ?></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1>✅ <?= __t($keyword) ?></h1>
							<p>
								<?= __t('Looking for the best place for') ?> <?= __t($keyword) ?><?= __t('? We provide fast, accurate, and confidential testing and treatment. Our doctors and staff at Cosmocare would be happy to discuss the details about') ?> <?= __t($keyword) ?> <?= __t('with you. To schedule an appointment for') ?> <?= __t($keyword) ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> ( <a href="./../https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Medical Center') ?></a> ) / <?= htmlspecialchars($contactjum) ?> <a href="./../https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank"><?= __t('(Jumeirah 2 Medical Center)') ?></a> <?= __t('to book an appointment.') ?>
							<div class="service-img">
								<img src="./../images/std-hiv-testing-center-dubai.svg" width="100%" class="img-fluid" alt="<?= __t($keyword) ?> dubai" />
							</div>
							</p>
							<div>
								<h2><?= __t('How Can I Get Started?') ?></h2>
								<p>
									<?= __t('To schedule an appointment for') ?> <?= __t($keyword) ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> ( <a href="./../https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Medical Center') ?></a> ) / <?= htmlspecialchars($contactjum) ?>
								</p>
		...
		<div class="container">
			...
			<div class="row py-1 py-md-2 px-lg-0">
				<div class="col-lg-4 footer-col1">
					<div class="row flex-column flex-md-row flex-lg-column">
						<div class="col-md col-lg-auto">
							...
							<div class="footer-social d-lg-none"> <a href="https://www.facebook.com/cosmocaremedicalcenter/" target="blank" class="hovicon"><i class="icon-facebook-logo"></i></a>
								<a href="https://www.youtube.com/@cosmocaremedicalcenterdubai" target="blank" class="hovicon"><i class="icon-twitter-logo"></i></a>
								<a href="https://www.instagram.com/cosmocare_dxb/" target="blank" class="hovicon"><i class="icon-instagram"></i></a>
							</div>
						</div>
						<div class="col-md">
							<div class="footer-text mt-1 mt-lg-2">
								<p><?= __t('To receive email releases, simply provide') ?>
									<br><?= __t('us with your email below') ?>
								</p>
							...
							<div class="footer-social d-none d-lg-block"> <a href="https://www.facebook.com/cosmocaremedicalcenter/" target="blank" class="hovicon"><i class="icon-facebook-logo"></i></a>
								<a href="https://www.youtube.com/@cosmocaremedicalcenterdubai" target="blank" class="hovicon"><i class="icon-twitter-logo"></i></a>
								<a href="https://www.instagram.com/cosmocare_dxb/" target="blank" class="hovicon"><i class="icon-instagram"></i></a>
							</div>
						</div>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="footer-post d-flex">
						...
						<div class="footer-post-text">
							<div class="footer-post-title"><a href="./../piles-hernia-doctor.html"><?= __t('New Doctor On Our Panel') ?></a></div>
					...
					<div class="footer-post d-flex">
						...
						<div class="footer-post-text">
							<div class="footer-post-title"><a href="./../tooth-colored-fillings.php"><?= __t('Colored Tooth Filling') ?></a></div>
					...
					<div class="footer-post d-flex">
						...
						<div class="footer-post-text">
							<div class="footer-post-title"><a href="./../prp-therapy.html"><?= __t('PRP Therapy...') ?></a></div>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<div class="h-decor"></div>
					<ul class="icn-list">
						<li><a href="https://maps.app.goo.gl/UnQLdp7uRi85HLP5A">Room# 107 1st Floor, Life Pharmacy <br>
								Building, Al Satwa Roundabout, Dubai,U.A.E.</a>
							<br><br>
							<a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank">Villa No. 464 Al Wasl Rd - opposite Pizzahut - Jumeirah - Jumeirah 2 - Dubai.</a> <a href="./../contact.html" class="btn btn-xs btn-gradient"><span><?= __t('Get directions on the map') ?></span></a>
						</li>
						<li><i class="icon-telephone"></i><b><span class="phone"><span class="text-nowrap">04 379 8747</span>, <span class="text-nowrap">050 373 4132</span></span></b>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row text-center text-md-left">
					<div class="col-sm"><?= __t('Copyright 2014-2030') ?> <a href="./../"><?= __t('Cosmocare Medical Cente') ?>r</a><span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
						<a href="http://www.dubaistdclinic.com/" target="_blank" title="std testing center"><?= __t('STD Clinic in Dubai') ?></a>
					</div>
					<div class="col-sm-auto ml-auto"><span class="d-none d-sm-inline"><a href="moh-license.pdf" target="_blank"><?= __t('MOH License #: RJRUI1TN-110225') ?></a> &nbsp;&nbsp;&nbsp;</span><i class="icon-telephone"></i>&nbsp;&nbsp;<b>04 379 8747</b></div>
				</div>
			</div>
		</div>
	</div>
