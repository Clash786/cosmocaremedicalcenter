...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$specialist_dermatologist_jumeirah2"; ?> <?= __t('Expert Specialist Dermatologist in Jumeirah 2 Providing advanced dermatology treatments for acne, pigmentation, skin conditions & anti-aging. Call ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('to BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('specialist dermatologist Jumeirah 2, dermatology clinic Dubai, acne treatment Dubai, pigmentation treatment Dubai') ?>, <?php include 'price.php'; echo "$dubai_keywords"; ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$specialist_dermatologist_jumeirah2"; ?> <?= __t('Specialist Dermatologist in Jumeirah 2 |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Specialist Dermatologist in Jumeirah 2') ?></h3>
							<h1><?= __t('Expert Care for Your Skin. Restore Confidence. Feel Your Best.') ?></h1>
							<p><?= __t('At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our specialist dermatologists, led by') ?>
								<strong><?= __t('Dr. Murtaza') ?></strong><?= __t(', provide advanced skin care treatments tailored for all skin types and conditions.Whether you\'re dealing with acne, pigmentation, eczema, or aging signs,') ?>
								<strong><?= __t('Dr. Murtaza') ?></strong>
								<?= __t('and the team ensure personalized care to help you achieve healthy, radiant skin.') ?>
							</p>
							<p><?= __t('Our clinic focuses on delivering personalized dermatology care, combining the latest technology with proven treatment protocols. From routine skin check-ups to complex cosmetic procedures, we ensure every patient receives safe and effective results tailored to their skin type. At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', patient comfort and satisfaction are our top priorities. Our team not only treats skin conditions but also educates patients on long-term skin health, helping you maintain radiant and healthy skin for years to come.') ?>
							</p>
						</div>
						<div class="service-img">
							<div class="service-img">
								<a href="specialist-dermatologist-jumeirah-2.php">
									<img src="images/specialist-dermatologist-jumeirah.jpg"
										alt="Specialist Dermatologist in Jumeirah 2 by Cosmocare Medical Center"
										style="width:60%; max-width:900px;" border="0" class="img-fluid" />
								</a>
							</div>
						</div>
						<br>
						<h1><?= __t('Expert Specialist Dermatologist in Jumeirah 2') ?></h1>
						<p><?= __t('At') ?>
							...
							<strong><?= __t('Dr. Murtaza') ?></strong><?= __t(', one of Dubai\'s most trusted specialist dermatologists.') ?>
							<br><?= __t('Whether you\'re struggling with acne, pigmentation, eczema, or aging signs, Dr. Murtaza and his team are dedicated to restoring your skin\'s natural glow and health.') ?>
						</p>
						...
						<ul>
							...
							<li><strong><?= __t(' Expert Care by Dr. Murtaza:') ?></strong>
								<?= __t('Over a decade of experience in treating all types of skin conditions.') ?></li>
							<li><strong><?= __t(' Trusted by Patients Across Dubai:') ?></strong>
								<?= __t('Conveniently located in Jumeirah 2, providing affordable and high-quality care.') ?>
							</li>
						</ul>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Specialist Dermatologist in Jumeirah 2...'),
			'link' => 'specialist-dermatologist-jumeirah-2.php',
			'date' => 'July 25, 2021'
		],
	];
	$footer_nearby_areas = [
