...
<head>
	...
	<meta name="description" content="<?= __t('Meso Open Pores & Scars Treatment') ?>  <?php include 'price.php'; echo "$meso"; ?> <?= __t('in our') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Dubai, feel free to call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$meso_keywords"; ?>, <?= __t('Meso Open Pores & Scars Treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$meso"; ?> <?= __t('Meso Open Pores & Scars Treatment Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active"
												href="meso-open-pores-acne-scars.php"><?= __t('Meso Open Pores & Scars') ?></a>
										</li>
										<li class="nav-item"><a class="nav-link"
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1><?= __t('MESO OPEN PORES & SCARS') ?></h1>
							<p><?= __t('Combat Blemishes and Achieve Smoother Skin: Mesotherapy for Open Pores & Acne Scars at Cosmocare Medical Centerr') ?>
							</p>
							<div class="service-img">
								<a href="meso-open-pores-acne-scars.php"><img src="images/mesoopenporesscars.png"
										alt=" Mesotherapy in Dubai by Cosmocare Medical Center" width="100%" border="0"
										class="img-fluid" /></a>
							</div>
							<p>
								</pack>
							<h3><?= __t('Combat Blemishes and Achieve Smoother Skin: Mesotherapy for Open Pores & Acne Scars at Cosmocare Medical Center') ?>
							</h3>
							<p><?= __t('At Cosmocare Medical Center, we understand the struggle to achieve a smooth and even complexion after dealing with acne. Our Mesotherapy for Open Pores & Acne Scars offers a targeted approach to minimize the appearance of acne scars, refine pores, and reveal a healthier, more radiant skin texture. This innovative treatment utilizes Dermapen technology and a powerful meso cocktail to tackle these concerns simultaneously, leading to a noticeably smoother and clearer complexion.') ?>
							</p>
							<p><?= __t('Mesotherapy for Open Pores & Acne Scars offers a multitude of benefits for those seeking to minimize acne\'s aftermath:') ?>
							</p>
							<ul>
								<li><?= __t(' Scar Reduction: The meso cocktail, containing ingredients like retinol and glycolic acid, can help diminish the appearance of acne scars by promoting collagen production and cellular renewal.') ?>
								</li>
								<li><?= __t(' Refined Pores: This treatment helps regulate oil production and minimize the appearance of enlarged pores, promoting a smoother and more even skin texture.') ?>
								</li>
								<li><?= __t(' Pigmentation Reduction: Glycolic acid and other lightening agents in the cocktail can help fade hyperpigmentation often left behind by acne breakouts.') ?>
								</li>
								<li><?= __t(' Skin Rejuvenation: Hyaluronic acid hydrates and plumps the skin, promoting a healthy and youthful appearance.') ?>
								</li>
							</ul>
							<h3><?= __t('Discover the Science Behind the Treatment') ?></h3>
							<p><?= __t('Mesotherapy for Open Pores & Acne Scars works through a multifaceted approach:') ?>
							</p>
							<ul>
								<li><?= __t(' Dermapen Technology: Microneedling with a Dermapen creates tiny channels in the skin, triggering the body\'s natural healing response. This stimulates collagen production and enhances the absorption of the beneficial ingredients in the meso cocktail.') ?>
								</li>
								<li><?= __t(' Targeted Meso Cocktail: A customized blend of active ingredients, including retinol, glycolic acid, and hyaluronic acid, is delivered directly into the deeper layers of the skin, where they can have the most significant impact.') ?>
								</li>
								<li><?= __t(' Precise Treatment: The treatment can be tailored to address specific concerns like acne scars or enlarged pores, ensuring optimal results.') ?>
								</li>
							</ul>
							<h3><?= __t('A Course of Treatment for Optimal Results') ?></h3>
							<p><?= __t('Mesotherapy for Open Pores & Acne Scars is particularly beneficial for those with oily skin:') ?>
							</p>
							<ul>
								<li><?= __t(' 3-4 Sessions: A series of 3 to 4 sessions spaced two weeks apart is typically recommended to achieve significant improvements.') ?>
								</li>
								<li><?= __t(' Maintenance: Regular maintenance sessions may be recommended to maintain results and prevent future breakouts.') ?>
								</li>
							</ul>
							<h3><?= __t('The Perfect Synergy: Mesotherapy and HydraFacial') ?></h3>
							<p><?= __t('For an even more comprehensive approach to achieving a clear and radiant complexion, consider combining Mesotherapy for Open Pores & Acne Scars with a HydraFacial treatment:') ?>
							</p>
							<ul>
								<li><?= __t(' Deep Exfoliation and Hydration: HydraFacial gently exfoliates dead skin cells and impurities, while also delivering deep hydration. This prepares the skin for optimal absorption of the beneficial ingredients in the meso cocktail.') ?>
								</li>
