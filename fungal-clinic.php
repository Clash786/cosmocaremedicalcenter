...
<head>
	...
	<meta name="description" content="<?= __t('When the patient comes to Cosmocare, our certified dermatologist Dr Murtuza Bandukwala diagnoses fungal skin infections through physical examination, review of medical history and investigations.') ?>" />
	<meta name="keywords" content="<?= __t('fungal Treatment dubai, fungal laser treatment') ?>" />
	...
	<title><?= __t('Fungal Infection by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="fungal-clinic.html"><?= __t('Fungal Clinic') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Fungal Infection') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/fungal.jpg" class="img-fluid" alt="fungal treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Fungal infection is also known as mycoses. Fungi are single or multi-cellular  organisms that cause skin infections. Fungi are single or multi-cellular organisms that cause  skin infections. Fungi can be true pathogens, which cause infections in healthy  people, or opportunistic pathogens, which cause infections in  immune-compromised patients. They most of the time affect the outer layer of skin,  hair and nails but it may become matter of concern as it can cause serious  disease') ?> </p>
							<p><?= __t('There are different types of fungal infections, and each can appear in different  areas of the body. Some symptoms include: rash, itchy blisters, cracking of the  skin, and skin irritation.') ?></p>
							<p><strong><?= __t('Cause:') ?></strong></p>
							<p><?= __t('Fungal infections can be caused by a variety of conditions and medication-use. Some risk factors for developing a  fungal infection include:') ?></p>
							<p><strong><?= __t('Antibiotics:') ?></strong></p>
							<p><?= __t('Antibiotics decrease the amount of helpful bacteria living in the body. When  these levels are decreased, fungi have an opportunity to invade and colonize.') ?></p>
							<p><strong><?= __t('Cortisteroids:') ?></strong></p>
							<p><?= __t('Cortisteroids are often used to reduce inflammation and treat other skin  disorders. They sometimes lower immune responses, and thereby create favorable  conditions for fungal growth.') ?></p>
							<p><strong><?= __t('Medical  Conditions:') ?></strong></p>
							<p><?= __t('People suffering from diabetes and some forms of cancer are more prone to  fungal infections.') ?></p>
							<p><strong><?= __t('Compromised  Immune System:') ?></strong></p>
							<p><?= __t('When immune systems are weakened, such as when a patient undergoes  chemotherapy, or for those inflicted with Acquired Immune Deficiency Syndrome  (AIDS), fungi have better opportunities to grow, causing more infections.') ?></p>
							<p><strong><?= __t('Environmental  Factors:') ?></strong></p>
							<p><?= __t('Fungi grow and reproduce in moist areas. Sweaty shoes and clothes can therefore  help increase fungi production and lead to infection.') ?></p>
							<p><strong><?= __t('Heredity:') ?></strong></p>
							<p><?= __t('Some people are genetically predisposed toward fungal infections. They are more  likely to contract a fungal infection when exposed to infectious conditions.') ?></p>
							<p><strong><?= __t('Treatment:') ?></strong></p>
							<p><?= __t('When the patient comes to Cosmocare, our certified dermatologist Dr Murtuza Bandukwala diagnoses fungal skin infections through physical examination, review of medical history and investigations. These days there is more persistent and  resistant fungal infection is common in the society, which needs regular follow  up and longer treatment than usual fungal infections.') ?></p>
							<p></p>
						</div>
					</div>
				</div>
