...
<head>
	...
	<meta name="description" content="<?= __t('Cosmocare offers invisible aligner or teeth straightening treatment in Dubai. The Most Affordable Invisalign Alternative just') ?> <?php include 'price.php'; echo $aligner;  __t('only.  Contact ') ?> <?php include 'price.php'; echo $contact; __t('today or email at') ?> <?php include 'price.php'; echo $email; __t('for book an appointment for invisible teeth aligner .') ?>" />
	<meta name="keywords" content="<?= __t('braces in Dubai, Tooth Extraction, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo $dentaloffer; __t('Invisible Aligner') ?> <?php include 'price.php'; echo $aligner; __t('only | Teeth Straightening') ?> <?php include 'price.php'; echo $areas; ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
						...
						<div class="row d-flex flex-column flex-sm-row flex-md-column mt-3">
							<div class="col-auto col-sm col-md-auto">
								<div class="contact-box contact-box-1">
									...
									<ul class="icn-list">
										<li><i class="icon-clock"></i><?= __t('Sat-Thu 08:00 - 21:00') ?>
											<br><?= __t('Friday OFF') ?>
										</li>
									</ul>
								</div>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							echo __t('$aligner'); ?> <?= __t('Invisible Aligner in Dubai') ?></h1>
							<h4><?= __t('The Specialized Teeth Straightening Treatment in Dubai') ?></h4>
							<p><?= __t('At Cosmocare Medical Center, we provide an exceptional quality of invisible aligner or teeth straightening treatment in Dubai. The dental center is managed by a team of qualified professionals with a wide range of experience in hospital management.') ?>
							</p>
							<h1><?= __t('Why Invisible Aligner?') ?></h1>
							<div>
								<h3><?= __t('Beautiful and fast results') ?> <br>
								</h3>
							</div>
							<p><?= __t('Our quality clear aligners and effective treatment plans ensure receiving the smile you\'ve always dreamt of. You can count on guaranteed results in record time.') ?>
							</p>
							<div>
							...
							<div class="service-img">
								<img src="images/invisible-aligner.svg" width="100%" class="img-fluid"
									alt="Invisible Aligner in Dubai by Cosmocare Medical Center">
							</div>
							<br>
							<br>
							...
							<p><?= __t('Braces slowly move teeth into their proper positions. This is performed by using a selection of corrective appliances, including teeth braces, ceramic braces and metal braces.') ?><br>
								<?= __t('Cosmocare Medical Center is one of the most visited dental clinic in Dubai delivering best quality dental braces at lowest price of aed499 by expert orthodontist dentists in Dubai. No Hidden Cost. Know More about braces in Dubai.') ?>
							</p>
							<div class="service-img">
								<a href="braces.php">
									<img src="images/braces.svg" width="100%" class="img-fluid"
										alt="up and down braces in Dubai by Cosmocare Medical Center">
								</a>
							</div>
							<p></p>
							<p>
