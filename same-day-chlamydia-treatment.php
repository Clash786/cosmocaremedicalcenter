...
<head>
	...
	<meta name="description" content="<?= __t('Get same day chlamydia treatment in Dubai with full privacy and expert care. Cosmocare Medical Center offers confidential STD testing and treatment by experienced doctors. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>" />
	<meta name="keywords" content="<?= __t('chlamydia treatment Dubai, same day STD treatment Dubai, STD clinic Dubai, sexual health clinic Dubai, confidential STD testing Dubai, chlamydia test Dubai, STI treatment Dubai, Cosmocare Medical Center') ?>" />
	...
	<title><?= __t('Same Day Chlamydia Treatment in Dubai | Confidential STD Care - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Confidential Chlamydia Testing and Diagnosis') ?></li>
										<li><?= __t('Same Day Chlamydia Treatment in Dubai') ?></li>
										<li><?= __t('Comprehensive STD & STI Screening') ?></li>
										<li><?= __t('Expert Sexual Health Consultation') ?></li>
										<li><?= __t('Follow-up Care and Prevention Counseling') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist in Sexual Health & STD Treatment') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist in Sexual Health and Dermatology') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He provides') ?> <strong><?= __t('Same Day Chlamydia Testing and Treatment in Dubai') ?></strong><?= __t(', offering patients quick, confidential, and effective care. With years of expertise in managing sexually transmitted infections (STIs), Dr. Murtuza ensures accurate diagnosis and evidence-based treatment in a private and comfortable setting.') ?></p>
						<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong>, <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('focuses on patient comfort, privacy, and fast recovery. He believes that early detection and prompt treatment are essential for maintaining both physical and emotional well-being. His compassionate approach and commitment to excellence make him one of the most trusted specialists for') ?> <strong><?= __t('Same Day Chlamydia Treatment in Dubai') ?></strong> <?= __t('and other STD-related services.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Same Day Chlamydia & STD Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/same-day-chlamydia.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center offering Chlamydia Treatment"></div>
									<div class="col-sm-4"> <img src="images/content/same-day-chlamydia1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center offering Chlamydia Treatment"></div>
									<div class="col-sm-4"> <img src="images/content/same-day-chlamydia2.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist Dermatologist in Dubai at Cosmocare Medical Center offering Chlamydia Treatment"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to patient care, Dr. Murtuza said, "Providing same-day chlamydia treatment is not just about quick recovery  it\'s about helping patients regain peace of mind, comfort, and confidence in their health. Ensuring timely and discreet care is my top priority."') ?></p>
							</div>
						</div>
