...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$laser_skin_rejuvenation_dubai"; ?> <?= __t('Expert Laser Skin Rejuvenation in Dubai by Dr. AQR Advanced treatments for wrinkles, pigmentation & skin renewal. For any queries, call us at ') ?><?php include 'price.php'; echo "$contact"; ?> <?= __t('(Satwa) / ') ?><?php include 'price.php'; echo "$contactjumeirah"; ?> <?= __t('(Jumeirah 2) or email') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('to BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$laser_skin_rejuvenation_dubai"; ?><?= __t(', laser skin rejuvenation Dubai, anti-aging treatment Dubai, skin renewal Dubai,') ?> <?php echo $dubai_keywords; ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$laser_skin_rejuvenation_dubai"; ?> <?= __t('Laser Skin Rejuvenation in Dubai |') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Laser Skin Rejuvenation in Dubai') ?></h3>
							<h1><?= __t('Revitalize Your Skin. Restore Youthful Glow. Feel Confident Again.') ?></h1>
							<p><?= __t('At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our expert dermatologists, led by') ?>
								<strong><?= __t('Dr. Murtaza') ?></strong>,
								<?= __t('provide advanced laser skin treatments tailored for all skin types.') ?>
								<br><?= __t('Whether you\'re dealing with wrinkles, pigmentation, or uneven skin texture,') ?>
								<strong><?= __t('Dr. Murtaza') ?></strong>
								<?= __t('and his team ensure your skin regains its natural radiance and health.') ?>
							</p>
						</div>
						<div class="service-img">
							<a href="laser-skin-rejuvenation-dubai.php">
								<img src="images/skin-laser.jpg"
									alt="Laser Skin Rejuvenation in Dubai by Cosmocare Medical Center"
									style="width:60%; max-width:800px;" border="0" class="img-fluid" />
							</a>
						</div>
						<br>
						<h1><?= __t('Advanced Laser Skin Rejuvenation in Dubai') ?></h1>
						<p><?= __t('At') ?> <strong><?= __t('Cosmocare Medical Center') ?></strong>,
							<?= __t('we provide cutting-edge laser treatments to rejuvenate your skin, reduce wrinkles, pigmentation, and improve overall skin texture.') ?>
							<br><?= __t('Dr. Murtaza and his team ensure personalized care, delivering safe and effective results tailored to each patient\'s needs.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Laser Skin Rejuvenation?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Personalized Treatment Plans:') ?></strong>
								<?= __t('Each patient receives a customized laser therapy plan for their unique skin concerns.') ?>
							</li>
							<li><strong><?= __t(' Advanced Laser Technology:') ?></strong>
								<?= __t('FDA-approved equipment for safe and effective skin rejuvenation.') ?></li>
							<li><strong><?= __t(' Expert Care by Dr. Murtaza:') ?></strong>
								<?= __t('Years of experience in laser dermatology and aesthetic treatments.') ?></li>
