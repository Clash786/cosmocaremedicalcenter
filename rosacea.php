...
<head>
	...
	<meta name="description" content="<?= __t('The treatment of rosacea depends on the nature of disease and the present situation of the person’s skin. . Our internationally acclaimed Dermatologist Dr Murtuza Bandukwala can help you determine which method is best for you.') ?>" />
	<meta name="keywords" content="<?= __t('rosacea treatment dubai, fungal laser treatment') ?>" />
	...
	<title><?= __t('Rosacea Treatment by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="rosacea.html"><?= __t('Rosacea') ?> </a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Rosacea Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/rosacea.jpg" class="img-fluid" alt="Rosacea Treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Rosacea is a chronic, non-contagious, inflammatory skin condition. It is characterized by a flushing redness of the cheeks, chin, nose and  forehead, and may produce small, red, pus-filled bumps or pustules. Rosacea  appears to affect more fair-skinned people than dark, though it can affect any  skin type. As the condition progresses, flushing becomes more persistent and  noticeable. In severe cases, most of the face is affected. The disorder affects  more women than men, but is generally more severe for men. Sometimes, permanent  facial changes can occur for men, such as thickening of the skin on the nose.') ?><br>
								<strong><?= __t('Causes:') ?></strong>
							</p>
							<p><?= __t('The cause of rosacea is currently unknown. However there  are triggers which might develop  rosacea, like prolonged sunlight exposure, exposure to extreme heat, exercises,  depression, and anxiety. Some researchers have shown that genetic  predisposition combined with environmental factors may be the cause.') ?><br>
								<?= __t('It could also be caused by a disorder of the blood  vessels that triggers them to swell, leading to flushing.') ?><br>
								<strong><?= __t('Treatment:') ?></strong>
							</p>
							<p><?= __t('The treatment  of rosacea depends on the nature of disease and the present situation of the  person’s skin. . Our internationally acclaimed Dermatologist Dr Murtuza Bandukwala  can help you determine which method is best for you.   Typically, improvements should be noticed within 1 to 2 months of treatment.') ?><br>
								<?= __t('The following are the treatment for Rosacea:') ?><br>
								<?= __t('Topical Medications:&nbsp;Medications  you apply to your skin once or twice daily, such as antibiotics, benzoyl  peroxide, and azelaic acid can help reduce inflammation and redness. Recently  newer topical medicine is available which is more effective and reduce the  rosacea symptoms for the longer period. These creams and lotions are generally used  in combination with other treatment, such as :') ?></p>
							<ul>
								<ul>
									<li><?= __t('Oral Antibiotics:&nbsp;') ?></li>
									<li><?= __t('Isoretinoin (Accutane)') ?> </li>
									<li><?= __t('Laser Treatment: &nbsp;Enlarged  blood vessels may become permanent. If this occurs, surgical options such as  laser therapy may help reduce the visibility of these vessels, The laser  therapy is a safe and effective alternative and we at Cosmocare have the  experience of treating rosacea successfully with 100% satisfied patients.') ?> </li>
								</ul>
								<p></p>
						</div>
					</div>
