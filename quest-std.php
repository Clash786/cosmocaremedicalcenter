...
<head>
	...
	<meta name="description" content="<?= __t('Get reliable and confidential Quest STD testing in Dubai at Cosmocare Medical Center. We offer same-day STD tests and fast, accurate results in a private and professional environment. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Quest STD Dubai, STD test Dubai, same day STD test Dubai, HIV test Dubai, chlamydia test Dubai, gonorrhea test Dubai, syphilis test Dubai, sexual health clinic Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('Quest STD Testing Dubai | Same Day STD Test at Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Comprehensive STD and STI Testing (including HIV, Syphilis, Chlamydia, Gonorrhea)') ?></li>
										<li><?= __t('Same-Day Quest STD Test Results') ?></li>
										<li><?= __t('Confidential and Discreet Consultations') ?></li>
										<li><?= __t('Expert Guidance and Treatment by Qualified Doctors') ?></li>
										<li><?= __t('Follow-Up Counseling and Preventive Care') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist Dermatologist & STD Testing Expert') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly skilled') ?> <strong><?= __t('Specialist Dermatologist') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t(', recognized for his expertise in diagnosing and managing various') ?> <strong><?= __t('sexually transmitted diseases (STDs)') ?></strong> <?= __t('and skin infections. He provides') ?> <strong><?= __t('accurate, confidential, and same-day Quest STD testing') ?></strong> <?= __t('using advanced diagnostic methods to ensure fast and reliable results for every patient.') ?></p>
						<p><?= __t('With years of experience and a patient-centered approach,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('delivers compassionate care in a private and professional setting. His goal is to help individuals regain their') ?> <strong><?= __t('confidence, health, and peace of mind') ?></strong> <?= __t('through discreet and effective treatment. Trusted across Dubai, he is one of the leading experts for') ?> <strong><?= __t('Quest STD Testing and Sexual Health Care') ?></strong>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD Testing & Sexual Health Services by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/quest-std-testing-dubai1.webp" class="img-fluid" alt="Quest STD Testing in Dubai by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/quest-std-testing-dubai2.jpg" class="img-fluid" alt="Quest STD Testing in Dubai by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/quest-std-testing-dubai.jpg" class="img-fluid" alt="Quest STD Testing in Dubai by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to patient care,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "') ?><strong><?= __t('Providing accurate and confidential Quest STD testing') ?></strong> <?= __t('is about more than just diagnosis  it\'s about helping patients feel') ?> <strong><?= __t('safe, informed, and confident') ?></strong> <?= __t('about their health. My goal is to ensure every patient receives') ?> <strong><?= __t('timely results, compassionate care,') ?></strong> <?= __t('and full privacy in a') ?> <strong><?= __t('judgment-free environment') ?></strong><?= __t('."') ?></p>
							</div>
						</div>
