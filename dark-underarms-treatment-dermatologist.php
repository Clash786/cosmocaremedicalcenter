...
<head>
	...
	<meta name="description" content="<?= __t('Get expert Dark Underarms Treatment in Dubai by top dermatologists at Cosmocare Medical Center. We offer safe laser and skin whitening treatments for smooth, even-toned underarms. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>" />
	<meta name="keywords" content="<?= __t('Dark underarms treatment Dubai, underarm whitening Dubai, dermatologist for dark underarms, skin lightening Dubai, laser treatment for dark underarms, Cosmocare Medical Center, skin specialist Dubai') ?>" />
	<meta name="author" content="<?= __t('Cosmocare Medical Center - Dermatology, Laser Treatments, Skin Whitening, Cosmetic Dermatology Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dark Underarms Treatment Dermatologist | Skin Lightening & Whitening Dubai - Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Specialist Dermatologist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
								<td><?= __t('MD Dermatology') ?></td>
							</tr>
							<tr>
								<td><?= __t('Areas of Expertise') ?></td>
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Professional Dark Underarms Evaluation and Diagnosis') ?></li>
										<li><?= __t('Laser Skin Lightening and Whitening Treatments') ?></li>
										<li><?= __t('Chemical Peels and Exfoliation for Underarm Pigmentation') ?></li>
										<li><?= __t('Safe and Effective Skin Brightening Procedures') ?></li>
										<li><?= __t('Personalized Underarm Care and Maintenance Plans') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
						...
						<div class="sidebar mt-4">
							...
							<ul class="nav flex-column">
								...
								<li class="nav-item"><a class="nav-link" href="dark-underarms-treatment-dermatologist.php"><?= __t('Dark Underarms Treatment Dermatologist') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="dermatologist-recommended-body-wash-for-eczema.php"><?= __t('Dermatologist Recommended Body Wash For Eczema') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="same-day-chlamydia-treatment.php"><?= __t('Same Day Chlamydia Treatment') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="quest-std.php"><?= __t('Quest Std') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="std-test-price.php"><?= __t('STD Test Price') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="scalp-dermatologist.php"><?= __t('Scalp Dermatologist') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="the-dermatologist-specialist.php"><?= __t('The Dermatologist Specialist') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="laser-dermatology.php"><?= __t('Laser Dermatology') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="instant-herpes-test.php"><?= __t('Instant Herpes Test') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="body-skin-tightening.php"><?= __t('Body Skin Tightening') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="hair-specialist-dermatologist.php"><?= __t('Hair Specialist Dermatologist') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="folliculitis-treatments.php"><?= __t('Folliculitis Treatments') ?></a></li>
								<li class="nav-item"><a class="nav-link" href="rapid-syphilis-test.php"><?= __t('Rapid Syphilis Test') ?></a></li>
							</ul>
						</div>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist Dermatologist') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong><?= __t(', a highly reputed') ?> <strong><?= __t('Specialist Dermatologist at Cosmocare Medical Center, Dubai') ?></strong><?= __t(', is renowned for his advanced expertise in') ?> <strong><?= __t('skin-lightening and pigmentation correction') ?></strong><?= __t('. He provides safe and effective') ?> <strong><?= __t('Dark Underarms Treatment') ?></strong> <?= __t('through modern dermatological techniques such as') ?> <strong><?= __t('laser therapy, chemical peels, and medical-grade skincare') ?></strong><?= __t('all tailored to restore a smooth, even, and brighter underarm tone.') ?></p>
						<p><?= __t('With extensive experience in') ?> <strong><?= __t('dermatology and aesthetic medicine') ?></strong><?= __t(', Dr. Murtuza combines scientific precision with compassionate, personalized care. His commitment to achieving natural-looking, long-lasting results has helped countless patients regain confidence and feel more comfortable in their skin. For those seeking') ?> <strong><?= __t('underarm whitening and pigmentation treatment in Dubai') ?></strong><?= __t(', Dr. Murtuza Bandukwala stands among the most trusted and recommended dermatologists.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Dark Underarms Treatment by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/dark-underarms-treatment-dubai.jpg" class="img-fluid" alt="Dark Underarms Treatment by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
									<div class="col-sm-4"><img src="images/content/dark-underarms-treatment-dubai1.jpg" class="img-fluid" alt="Dark Underarms Treatment by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
									<div class="col-sm-4"><img src="images/content/dark-underarms-treatment-dubai2.jpg" class="img-fluid" alt="Dark Underarms Treatment by Dr. Murtuza Bandukwala - Specialist Dermatologist at Cosmocare Medical Center Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked what makes dermatology so rewarding,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('shared, œHelping patients overcome concerns like') ?> <strong><?= __t('dark underarms') ?></strong> <?= __t('is deeply fulfilling. Even a small visible improvement can significantly boost their self-confidence and comfort. Seeing people feel proud and comfortable in their own skin is what truly motivates me every day.') ?></p>
							</div>
						</div>
