...
<head>
	...
	<meta name="description" content="<?= __t('Affordable Dental Crown & Bridges procedure at cosmocare medical center in Dubai. Your modern dental clinic at 2nd December Street, Dubai. Cosmocare Medical Center | Orthodontics✓ Children&#039;s dentist✓ Implantology✓ Dental aesthetics✓ ☎ 043798747') ?>" />
	<meta name="keywords" content="<?= __t('Crown & Bridges, crown bridges, dental clinic in dubai, cheap dental clinic') ?>" />
	...
	<title><?= __t('Affordable Dental Crown & Bridges | Crown & Bridges Dental Clinic in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
						...
						<ul class="services-nav flex-column flex-nowrap">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu7">
									<ul class="flex-column nav">
										<li class="nav-item"><a class="nav-link active" href="crown-bridge.html"><?= __t('Crown and Bridge') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Affordable Dental Crown & Bridges') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/dental-crown-bridge.svg" width="100%" class="img-fluid" alt="Dental Crown & Bridges and dental specialist Doctor in Dubai by Cosmocare Medical Center">
						</div>
						<h2 id="1" itemprop="name"><?= __t('What are Dental Bridges?') ?></h2>
						<p><span itemprop="acceptedAnswer"><?= __t('A dental bridge is a prosthetic device used to fill a gap created by one or more missing teeth. It is mounted onto existing teeth or implants and cemented into shape, bridging the gap to create a full and natural-looking smile.') ?></span></p>
						<p><?= __t('A missing tooth can make you feel shy and self-conscious. You can regain your confidence by restoring your smile with a dental bridge.') ?></p>
						<p><?= __t('Dental bridges are ideal for filling gaps and creating a happy smile to enhance your natural beauty. If missing teeth have you feeling insecure, your smile.com.au approved dentist can offer a solution with affordable dental bridge treatment.') ?></p>
						<h2 id="3" itemprop="name"><?= __t('Am I Suitable for a Dental Bridge Treatment?') ?></h2>
						<span>
							<p><?= __t('The treatment required to replace a missing tooth varies from patient to patient.') ?></p>
							<p><?= __t('The suitability of a candidate for dental bridge treatment can depend on factors including:') ?></p>
							<ul>
								<li><?= __t('Oral health diagnosis') ?></li>
								<li><?= __t('Jawbone density') ?></li>
								<li><?= __t('Personal preference') ?></li>
							</ul>
						</span>
						<p><?= __t('Our dental services at the 2nd December Street, Near Satwa Roundabout location range from modern orthodontics, endodontics and implantology up to children\'s dentistry, dental aesthetics, prevention and oral surgery.') ?></p>
						<div class="pt-2 pt-md-4">
							<h2><?= __t('Dentistry with Cosmocare Medical Center') ?></h2>
							<p><?= __t('Here at Cosmocare Medical Center, our skilled and experienced dentists regularly perform dental procedures.') ?></p>
