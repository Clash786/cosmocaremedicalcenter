...
<head>
	...
	<meta name="description" content="<?= __t('Book a confidential STD appointment in Dubai at Cosmocare Medical Center. Our expert doctors provide private consultations, rapid STD testing, and professional care. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('STD appointment Dubai, Book STD test Dubai, Confidential STD consultation Dubai, Sexual health clinic Dubai, STD testing Dubai, Cosmocare Medical Center Dubai, Rapid STD test Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Book STD Appointment in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Confidential STD Consultations') ?></li>
										<li><?= __t('Rapid STD Testing and Diagnosis') ?></li>
										<li><?= __t('Comprehensive Sexual Health Screening') ?></li>
										<li><?= __t('Professional Advice and Treatment Plans') ?></li>
										<li><?= __t('Follow-up and Preventive Care Services') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Physician & STD Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified physician and one of the leading') ?> <b><?= __t('STD specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in sexual health, he provides confidential consultations, rapid testing, and professional care for a variety of') ?> <b><?= __t('sexually transmitted infections (STIs)') ?></b><?= __t('. Dr. Murtuza is committed to helping patients maintain their sexual health with privacy, professionalism, and effective treatment plans.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines modern diagnostic technology with compassionate patient care to provide accurate') ?> <b><?= __t('STD testing') ?></b> <?= __t('and personalized treatment. His approach ensures confidentiality, peace of mind, and long-term sexual health for those seeking expert') ?> <b><?= __t('STD appointments and consultations in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('STD Consultation & Testing by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/std-consultation-dubai.jpg" class="img-fluid" alt="Confidential STD Consultation and Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/std-consultation-dubai1.jpg" class="img-fluid" alt="Confidential STD Consultation and Testing in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/std-consultation-dubai2.jpg" class="img-fluid" alt="Confidential STD Consultation and Testing in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was concerned about a possible STD and wanted a confidential consultation. After visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I felt completely at ease. The testing and consultation were professional, private, and thorough. Thanks to Dr. Murtuza, I received accurate results and the right guidance, and I now feel confident about my sexual health. I highly recommend him for anyone seeking expert') ?> <b><?= __t('STD consultation in Dubai') ?></b><?= __t('."') ?></p>
							</div>
						</div>
