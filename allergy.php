...
<head>
	...
	<meta name="description" content="<?= __t('What is an allergic reaction? In the event of an allergy, your immune system will mistake a normally harmless substance for something that is dangerous to your body. This reaction will cause your immune system to produce antibodies called “immunoglobulin E” (IgE, which attack the “danger” to protect you.') ?>" />
	<meta name="keywords" content="<?= __t('Allergy Treatment dubai, allergy test dubai') ?>" />
	...
	<title><?= __t('Allergy Treatment by Specialist Doctor in Dubai| Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
						...
						<ul class="services-nav flex-column flex-nowrap">
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link" href="acne-treatment.html"><?= __t('Allergy Treatment') ?></a></li>
										...
										<li class="nav-item"><a class="nav-link active" href="allergy.html"><?= __t('Allergy') ?></a></li>
							...
							<li class="nav-item">
								...
								<div class="collapse" id="submenu3">
									<ul class="flex-column nav">
										<li class="nav-item"><a class="nav-link" href="preventive-sexual-health-checkups.html"><?= __t('Preventive Sexual Health Checkups') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Allergy Treatment Dubai') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/allergy.svg" class="img-fluid" alt="Allergy Treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<h2 dir="ltr"><?= __t('What is an allergic reaction?') ?></h2>
							<p dir="ltr"><?= __t('In   the event of an allergy, your immune system will mistake a normally   harmless substance for something that is dangerous to your body. This   reaction will cause your immune system to produce antibodies called   “immunoglobulin E” (IgE), which attack the “danger” to protect you. Once   they get to work, the antibodies create a range of minor or even   serious symptoms. This reaction can occur when a person touches,   swallows or inhales an allergen (the substance causing the reaction).') ?></p>
							<h2 dir="ltr"><?= __t('What are a few of the most common allergens?') ?></h2>
							<p><?= __t('Any substance can cause an allergic reaction, but here are some of the most common allergies we see in adults and children:') ?></p>
							<ul>
								<li><?= __t('Food: peanuts, milk, egg, tree nuts') ?></li>
								<li><?= __t('Insect stings: stings from bees, wasps, and hornets') ?></li>
								<li><?= __t('Drug: penicillin, sulfa drugs, and insulin') ?></li>
								<li><?= __t('Chemicals: Latex') ?></li>
								<li><?= __t('Pets: dogs, cats, horses') ?></li>
								<li><?= __t('Environmental Factors: dust mites, mold') ?></li>
							</ul>
							<h2 dir="ltr"><?= __t('What are some common allergy symptoms?') ?></h2>
							<p><?= __t('When a person is having an allergic reaction they may experience the following:') ?></p>
							<ul>
								<li><?= __t('Runny nose') ?></li>
								<li><?= __t('Nasal congestion') ?></li>
								<li><?= __t('Swelling') ?></li>
								<li><?= __t('Hives or Itching') ?></li>
								<li><?= __t('Watery eyes') ?></li>
								<li><?= __t('Wheezing') ?></li>
								<li><?= __t('Difficulty breathing') ?></li>
								<li><?= __t('Anaphylaxis') ?></li>
							</ul>
							<h2 dir="ltr"><?= __t('How can you diagnose and treat an allergy?') ?></h2>
							<p><?= __t('A medical specialist or allergist can diagnose an allergic condition through skin testing. This test helps determine what a person is allergic to by causing an allergic reaction in a controlled environment.') ?></p>
							<p><?= __t('In   most cases, avoiding the allergen completely is the most effective way   to prevent a reaction. However, sometimes the allergen is unavoidable,   especially in the case of inhalant allergies and stinging insect   allergies. If this is your situation, your allergy specialist may   prescribe medications such as antihistamines, leukotriene modifiers, and   inhaled steroids or inhalers. For more long-term relief from allergies,   allergy shots - also known as immunotherapy - are recommended.') ?></p>
							<h2 dir="ltr"><?= __t('How does immunotherapy work?') ?></h2>
							<p><?= __t('Immunotherapy   happens in several phases. During the ‘build up’ phase, your doctor   will provide increasing doses of allergy injections once or twice a week   until a predetermined target (or ‘maintenance’) dose is reached.') ?></p>
							<p><?= __t('Shots   are usually administered every 1-4 weeks over the next several years of   treatment, and symptoms will usually improve within the first year. In a   small percentage of patients, there is no improvement; if this happens,   your immunotherapy may be discontinued or you may be retested for a   different allergy. However, when symptoms do improve, injections are   usually continued for 4 to 5 years of maintenance therapy. At that time,   you and your doctor will make a joint decision about whether to   gradually taper and discontinue injections or to continue your treatment   plan.') ?></p>
