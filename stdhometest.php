...
if (!empty($slug)) {
    ...
    $stmt = $conn->prepare("SELECT * FROM std_keywords WHERE slug = ? AND category = 'test' LIMIT 1");
...
<head>
	...
	<meta name="description" content="<?= __t('At Cosmocare, we would be happy to discuss the details about') ?> <?= $keyword ?> <?= __t('with you. To schedule an appointment for') ?> <?= $keyword ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> <?= __t('(Satwa) /') ?> <?= htmlspecialchars($contactjum) ?> (Jumeirah 2) <?= __t('to book an appointment for home testing.') ?>">
	<meta name="keywords" content="<?= $keyword ?>, <?= htmlspecialchars($company) ?>, <?= __t('cosmocare, testing, treatment, dubai, bone grafting dubai, polishing, dental clinic in dubai, cheap dental clinic') ?>">
	<meta name="author" content="<?= htmlspecialchars($company) ?>">
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<title>[<?= htmlspecialchars($hiv) ?>] ✅<?= __t('Looking for') ?> <?= __t($keyword) ?>? <?= htmlspecialchars($company) ?></title>
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							...
							<h1>✅ <?= __t($keyword) ?></h1>
							<p>
								<?= __t('Looking for the best place for') ?> <?= __t($keyword) ?><?= __t('? We provide fast, accurate, and confidential testing and treatment. Our doctors and staff at Cosmocare would be happy to discuss the details about') ?> <?= __t($keyword) ?> <?= __t('with you. To schedule an appointment for') ?> <?= __t($keyword) ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> (
								<a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Medical Center') ?></a>
								) / <?= htmlspecialchars($contactjum) ?>.
								<a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank"><?= __t('(Jumeirah 2 Medical Center)') ?></a>
								<?= __t('to book an appointment for home test.') ?>
							</p>
							...
							<div>
								...
								<p>
									<?= __t('To schedule an appointment for') ?> <?= __t($keyword) ?><?= __t('? Please call at') ?> <?= htmlspecialchars($contact) ?> (
									<a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Medical Center') ?></a>
									) / <?= htmlspecialchars($contactjum) ?>
								</p>
					...
					<div class="row flex-column flex-md-row flex-lg-column">
						...
						<div class="col-md">
							<div class="footer-text mt-1 mt-lg-2">
								<p><?= __t('To receive email releases, simply provide us with your email below.') ?>
								</p>
				...
				<div class="col-sm-6 col-lg-4">
					...
					<ul class="icn-list">
						<li><a href="https://maps.app.goo.gl/UnQLdp7uRi85HLP5A">Room# 107 1st Floor, Life Pharmacy <br>
							...
							<br><br>
							<a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank">Villa No. 464 Al Wasl Rd - opposite Pizzahut - Jumeirah - Jumeirah 2 - Dubai.</a> <a href="./../contact.html" class="btn btn-xs btn-gradient"><span>Get directions on the map</span></a>
						</li>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row text-center text-md-left">
					<div class="col-sm"><?= __t('Copyright 2014-2030') ?> <a href="./../"><?= __t('Cosmocare Medical Center') ?></a><span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
