...
<head>
	...
	<meta name="description" content="<?= __t('Get professional Dark Lips Treatment by a leading dermatologist in Dubai at Cosmocare Medical Center. Safe, effective, and customized solutions to restore natural lip color and enhance confidence. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dark lips treatment Dubai, Dermatologist for dark lips Dubai, Lip pigmentation treatment Dubai, Cosmetic lip treatment Dubai, Skin care specialist Dubai, Cosmocare Medical Center Dubai, Lip rejuvenation Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dark Lips Treatment by Dermatologist in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Professional Dark Lips Treatment') ?></li>
										<li><?= __t('Lip Pigmentation Correction') ?></li>
										<li><?= __t('Safe and Customized Dermatology Solutions') ?></li>
										<li><?= __t('Lip Rejuvenation and Natural Color Restoration') ?></li>
										<li><?= __t('Advanced Cosmetic Treatments for Healthy Lips') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Dark Lips Treatment Specialist') ?></h6>
							</div>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('dark lips treatment specialists') ?></b> <?= __t('and') ?> <b><?= __t('skin care doctors') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With years of experience in dermatology, he provides advanced solutions for various') ?> <b><?= __t('lip pigmentation concerns') ?></b><?= __t(', helping patients restore natural lip color and achieve healthy, rejuvenated lips. Dr. Murtuza is committed to delivering personalized care using safe and effective techniques.') ?></p>
						<p><?= __t('At') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala combines modern dermatological technology with a patient-centered approach to address dark lips and other cosmetic concerns. His treatments focus on improving lip appearance, enhancing confidence, and maintaining long-term lip health, making him one of the most trusted') ?> <b><?= __t('dermatologists for dark lips treatment in Dubai') ?></b>.</p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Care Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"><img src="images/content/dark-lips-treatment-dubai.jpg" class="img-fluid" alt="Expert Dark Lips Treatment by Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/dark-lips-treatment-dubai1.jpg" class="img-fluid" alt="Expert Dark Lips Treatment by Dermatologist in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"><img src="images/content/dark-lips-treatment-dubai2.jpg" class="img-fluid" alt="Expert Dark Lips Treatment by Dermatologist in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I had dark lips for years and was hesitant to seek treatment, but after visiting') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', I noticed a significant improvement in just a few sessions. The treatment was safe, professional, and effective, leaving my lips naturally pink and rejuvenated. I highly recommend Dr. Murtuza for anyone seeking expert') ?> <b><?= __t('dark lips treatment in Dubai') ?></b>."</p>
							</div>
						</div>
