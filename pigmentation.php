...
<head>
	...
	<title><?= __t('Pigmentation / Skin Discoloration Treatment by Specialist Doctor in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										...
										<li class="nav-item"><a class="nav-link active" href="pigmentation.html"><?= __t('Pigmentation') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Pigmentation/ Skin Discoloration Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/pigmentation.jpg" class="img-fluid" alt="pigmentation Treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><a name="_GoBack"><strong><?= __t('Skin Discoloration/Pigmentation:') ?></strong></a><strong> </strong><br>
								<?= __t('Skin  discoloration or Pigmentation is a common condition that occurs mostly from sun  exposure, and leads the skin to become darkened in certain areas or patches.  These areas, usually brown, are a collection of pigment called melanin. Melanin  is produced by the skin, and absorbs ultraviolet rays to protect the body from  the sun. Increased melanin leads to increased discoloration. Anyone can be  affected by skin discoloration, but generally lighter-skinned individuals are  at greater risk for discoloration and cancer.') ?><br>
								<strong><?= __t('Some  common forms of skin discoloration include Freckles, Melasma, and Age Spots:') ?></strong>
							</p>
							<ul>
								<li><strong><?= __t('Freckles:') ?></strong><?= __t('&nbsp;Freckles,  medically known as are small brown spots found on the skin, most commonly on  the arms and face. Freckles are extremely common, especially among  light-skinned people, and those with red or light hair. Freckles are caused by  genetics and sun exposure, and tend to darken in the summer or when exposed  more often to the sun. People with a lot of freckles should avoid the sun and  always wear sunscreen, as they are more susceptible to skin cancer. Because  freckles are harmless, they do not need to be treated. However, if you are  unhappy with the appearance of your freckles, there are several steps you can  take to prevent further development, and to fade existing freckles.') ?> </li>
								<li><strong><?= __t('Melasma (“Pregnancy Mask”):') ?></strong><?= __t('&nbsp;Melasma  is a dark skin discoloration that occurs on sun-exposed areas of the face. It  is generally characterized by a brown color over the cheeks, forehead, nose  and/or upper lip. It is often symmetrical, matching on both sides of the face.  Melasma is sometimes referred to as “pregnancy mask,” because it has been  linked to the female hormones estrogen and progesterone. Therefore, pregnant  women, or those taking some forms of birth control pills are most likely to  develop Melasma. For these women, melasma generally disappears after delivery,  or when pill taking is terminated. If melasma does not go away of its own, it  can be treated with chemical peels, and some creams or topical steroids.') ?> </li>
								<li><strong><?= __t('Age Spots:&nbsp;') ?></strong><?= __t('Age spots are flat  gray, brown or black spots found on the skin, and caused by sun exposure.') ?> <strong> </strong></li>
							</ul>
							<p> <?= __t('Cosmocare Medical Center offers the following  treatment for Pigmentation/Discoloration:') ?></p>
							<ul>
								<li><?= __t('Chemical  Peeling: The&nbsp;pigmentation&nbsp;treatment involves&nbsp;chemical peels&nbsp;with 20%-50% salicylic acid concentrations, or  trichloroacetic acid (TCA). The&nbsp;chemical  peel&nbsp;also reduces the appearance of acne and makes fine lines and  wrinkles less visible') ?> </li>
								<li><?= __t('Q Switched  Laser: It is the latest  technology to treat uneven skin tone and hyper-pigmentation. It is a  revolutionary service that uses a&nbsp;') ?><strong>Q</strong>-<strong><?= __t('Switched laser') ?></strong><?= __t('&nbsp;that  is highly safe for all kind of skin to  treat unwanted pigmentation on skin.') ?> </li>
							</ul>
							<ul>
								<li><?= __t('Fractional Laser') ?><strong>: </strong><?= __t('Laser treatment&nbsp;is one of the most advanced  treatments for') ?>&nbsp;<?= __t('removing') ?>&nbsp;<?= __t('unwanted') ?>&nbsp;<?= __t('pigmentation') ?>&nbsp;<?= __t('on the skin such as  age spots, sun spots, and freckle  Fractional Lasers') ?>&nbsp;<?= __t('break up the') ?>&nbsp;<?= __t('laser') ?>&nbsp;<?= __t('energy into thousands of tiny beams to') ?>&nbsp;<?= __t('treat') ?>&nbsp;<?= __t('only a') ?>&nbsp;<?= __t('fraction') ?>&nbsp;<?= __t('of the skin in the area,  which reduces downtime.') ?>&nbsp;<?= __t('Fractional  lasers') ?>&nbsp;<?= __t('can be ablative or non-ablative, and are used to') ?>&nbsp;<?= __t('treat') ?>&nbsp;<?= __t('a number of age-related  blemishes.') ?> </li>
							</ul>
							<ul>
								<li><?= __t('IPL( Intense pulsed light): ') ?>&nbsp;<?= __t('Depending  on the wavelength setting, this technology is used to reduce skin') ?>&nbsp;<?= __t('pigmentation. This is a suitable way  to treat both brown skin') ?>&nbsp;<?= __t('pigmentation') ?>&nbsp;<?= __t('(sun  damage and hormone related melasma) as well as red skin pigmentation (eg  rosacea and fine thread veins).') ?> </li>
							</ul>
						</div>
					</div>
				</div>
