...
<head>
	...
	<meta name="keywords" content="<?= __t('warts removal dubai, warts treatment, hpv treatment') ?>" />
	...
	<title><?= __t('Warts Treatment by Specialist Doctor in Dubai | Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
							...
							<li class="nav-item">
								...
								<div class="collapse show" id="submenu1">
									<ul class="flex-column nav">
										<li class="nav-item"><a class="nav-link active" href="warts-treatment.html"><?= __t('Warts Treatment') ?></a></li>
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Warts Treatment') ?></h1>
						</div>
						<div class="service-img">
							<img src="images/warts.jpg" class="img-fluid" alt="Warts Treatment dubai">
						</div>
						<div class="pt-2 pt-md-4">
							<p><?= __t('Warts  are skin growths caused by the Human Papillomavirus (HPV). There are about 130  known types of HPV, some of which cause the skin to produce warts. HPV  stimulates accelerated growth of cells on the skin’s outer layer, resulting in  the wart. Warts are caused through direct contact with someone who has HPV,  which is contagious. They can also be spread by an object used by the person  with the virus.') ?><br>
								<strong><?= __t('Types of Warts:') ?></strong>
							</p>
							<ul>
								<li><strong><?= __t('Common:') ?></strong><?= __t('&nbsp;A common wart is a raised  wart with a rough surface that can occur anywhere on the body, but is most  often found on the hands.') ?></li>
								<li><strong><?= __t('Flat:') ?></strong><?= __t('&nbsp;Flat warts are smoother,  flatter, and smaller than common warts, and generally occur on the face. This  type of wart is more common in children than adults.') ?></li>
								<li><strong><?= __t('Plantar:&nbsp;') ?></strong><?= __t('Plantar warts usually appear as  flesh-colored or light brown lumps that are flecked with small blood vessels,  which appear as black dots. Plantar warts occur on the bottom of the feet.') ?></li>
								<li><strong><?= __t('Genital:') ?></strong><?= __t('&nbsp;Genital warts can appear in  the pubic region, on the genitals, in or around the anus, and in the vagina.') ?></li>
							</ul>
							<p><?= __t('&nbsp;') ?></p>
							<p><strong><?= __t('Treatment:') ?></strong><br>
								<br>
								<?= __t('Warts are generally harmless, but genital warts should be taken seriously.  There are many treatment options for warts, although often warts reappear after  treatment, and sometimes multiple types of treatment are necessary. We at  Cosmocare provide the following kind of treatment for removal of Warts under  the guidance of our certified trained Dermatologist Dr. Murtuza Bandukwala.') ?><br>
								<br>
								<strong><?= __t('Some options include:') ?></strong>
							</p>
							<ul>
								<ul>
									<li><strong><?= __t('Freezing:') ?></strong><?= __t('&nbsp;In this treatment, liquid  nitrogen is used to freeze the wart. A blister forms around the wart, and the  dead tissue falls off within about a week.') ?></li>
									<li><strong><?= __t('Medications:') ?></strong><?= __t('&nbsp;Some medications such as  Cantharidin, Bleomycin, Aldara are used for Mole treatment.') ?></li>
									<li><strong><?= __t('Minor  Surgery:') ?></strong><?= __t('&nbsp;When other treatments  fail, minor surgery may be considered. The wart will be cut away, and then the  base of the wart will be destroyed using an electric needle or by deep freezing  (') ?><strong><?= __t('Cryosurgery).') ?></strong></li>
									<li><strong><?= __t('Laser  Surgery:') ?></strong><?= __t('&nbsp;This procedure  uses an intense beam of light (the laser) to burn and destroy wart tissue.') ?></li>
								</ul>
						</div>
					</div>
				</div>
