...
<head>
	...
	<meta name="description" content="<?= __t('Specialized Zirconia Crowns by Cosmocare Medical Center in Dubai. The most affordable zirconia teeth crowns in Dubai.  Contact') ?>  <?php include 'price.php'; echo "$contact"; ?> <?= __t('today or email at') ?> <?php include 'price.php'; echo "$email"; ?> <?= __t('for book an appointment for invisible teeth aligner .') ?>" />
	...
	<title><?php include 'price.php'; echo "$dentaloffer"; ?> <?= __t('Specialized Zirconia Crowns | Teeth Zirconia Crown') ?> <?php include 'price.php'; echo "$areas"; ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Zirconia Crowns in Dubai') ?></h1>
							<h4><?= __t('Specialized Zirconia Crowns by Cosmocare Medical Center') ?></h4>
							<p><?= __t('Dental crowns are caps that cover a tooth or a dental implant. Dentists often recommend crowns as a way to support broken, weak, or misshapen teeth.') ?>
							</p>
							<p><?= __t('Dental crowns can also be used to cover up a tooth that\'s very worn down or severely discolored. They can also be used in conjunction with bridges to strengthen multiple teeth.') ?>
							</p>
							<div class="service-img">
								<a href="zirconia-crown.php">
									<img src="images/zirconia-crown.svg"
										alt="Zirconia Crown in Al Hudaiba, Al Satwa, Al Mankhool, jumeirah 1, al jafiliya, Al Raffa Dubai by Cosmocare Medical Center"
										width="100%" border="0" class="img-fluid">
								</a>
							</div>
							...
							<div class="service-img">
								<a href="invisible-aligners.php">
									<img src="images/invisible-aligner.svg"
