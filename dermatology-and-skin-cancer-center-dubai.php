...
<head>
	...
	<meta name="description" content="<?= __t('Consult expert dermatologists at the Dermatology and Skin Cancer Center in Dubai, Cosmocare Medical Center. Specialized care for skin cancer screening, mole evaluation, and advanced dermatology treatments. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Dermatology clinic Dubai, Skin cancer center Dubai, Mole check Dubai, Skin cancer screening Dubai, Dermatologist Dubai, Skin lesion treatment Dubai, Cosmetic dermatology Dubai, Skin care clinic Dubai') ?>">
	<meta name="author" content="<?= __t('Cosmocare Medical Center, Dubai') ?>" />
	<meta name="format-detection" content="telephone=no">
	<title><?= __t('Dermatology and Skin Cancer Center in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
					...
					<div class="col-md">
						...
						<table class="table doctor-page-table">
							<tr>
								...
								<td><?= __t('Dermatologist & Skin Cancer Specialist') ?></td>
							</tr>
							<tr>
								<td><?= __t('Degrees') ?></td>
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										...
										<li><?= __t('Mole and Lesion Evaluation') ?></li>
										<li><?= __t('Dermatologic Surgery for Skin Cancer') ?></li>
										<li><?= __t('Laser and Cryotherapy Treatments') ?></li>
										<li><?= __t('Comprehensive Skin Health Management') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Consultant Dermatologist & Skin Cancer Doctor') ?></h6>
						...
						<p><?= __t('Dr. Murtuza Bandukwala is a board-certified dermatologist and one of the leading') ?> <b><?= __t('skin cancer specialists') ?></b> <?= __t('in Dubai at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. With extensive experience in dermatology, he provides advanced diagnosis and treatment for various') ?> <b><?= __t('skin conditions') ?></b><?= __t(', including mole and lesion removal, acne management, pigmentation issues, anti-aging, and overall skin rejuvenation. Dr. Murtuza is committed to offering safe, effective, and personalized care to help patients maintain healthy and radiant') ?> <b><?= __t('skin') ?></b>.</p>
						<p><?= __t('As part of the expert dermatology team at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t(', Dr. Murtuza Bandukwala specializes in identifying and managing early signs of') ?> <b><?= __t('skin cancer') ?></b> <?= __t('while focusing on preventive skin health. His patient-centered approach, combined with advanced dermatological techniques, ensures accurate diagnosis and effective treatments for all types of') ?> <b><?= __t('skin concerns') ?></b> <?= __t('in Dubai.') ?></p>

						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Skin Cancer & Dermatology Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/dermatology-and-skin-cancer-center-dubai2.jpg" class="img-fluid" alt="Expert Skin Cancer and Dermatology Treatments in Dubai"></div>
									<div class="col-sm-4"> <img src="images/content/dermatology-and-skin-cancer-center-dubai1.jpg" class="img-fluid" alt="Expert Skin Cancer and Dermatology Treatments in Dubai"></div>
									<div class="col-sm-4"> <img src="images/content/dermatology-and-skin-cancer-center-dubai.jpg" class="img-fluid" alt="Expert Skin Cancer and Dermatology Treatments in Dubai"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('"I was diagnosed with a suspicious mole and decided to consult') ?> <b><?= __t('Dr. Murtuza Bandukwala') ?></b> <?= __t('at') ?> <b><?= __t('Cosmocare Medical Center') ?></b><?= __t('. The diagnosis and removal procedure were handled with great care and precision. Dr. Murtuza explained everything clearly and made me feel completely comfortable throughout the treatment. I\'m grateful for his expertise and professionalism in managing my skin health."') ?></p>
							</div>
						</div>
