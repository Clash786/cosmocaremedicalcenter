...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$std_checkup_dubai"; ?> <?= __t('STD Check-up in Dubai Confidential and Professional Testing at Cosmocare Medical Center. For any queries, call us at ') ?><?php echo $contact; ?> <?= __t('(Satwa) / ') ?><?php echo $contactjumeirah; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo $email; ?> <?= __t('to BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?php include 'price.php'; echo "$std_checkup_dubai"; ?>, <?= __t('STD Testing Dubai, Private STD Check-up, Cosmocare Medical Center') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$std_checkup_dubai"; ?> <?= __t('STD Check-up in Dubai |') ?> <?php echo "$company"; ?> <?= __t('Satwa & Jumeirah 2') ?>
	</title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Private STD Check-up in Dubai') ?></h3>
							<h1><?= __t('Confidential & Accurate STD Testing') ?></h1>
							<p><?= __t('At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide professional and discreet STD testing services.') ?>
								<br><?= __t('Our team ensures accurate results with privacy and comfort, helping you take charge of your sexual health with confidence.') ?>
							</p>
							<h1><?= __t('Comprehensive Screening & Support') ?></h1>
							<p><?= __t('Whether you need routine screening or specific STD tests, our experienced staff guides you through the process with care.') ?>
								<br><?= __t('We prioritize confidentiality, quick results, and professional support at every step.') ?>
							</p>
						</div>
						<div class="service-img">
							<a href="std-check-up-dubai.php">
								<img src="images/std-check-up-dubai.jpg"
									alt="Confidential STD Check-up in Dubai by Cosmocare Medical Center"
									style="width:90%; max-width:400px;" border="0" class="img-fluid" />
							</a>
						</div>
						<br>
						<h1><?= __t('Professional STD Check-up in Dubai') ?></h1>
						<p><?= __t('At') ?>
							<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we provide comprehensive and confidential STD testing services.') ?>
							<br><?= __t('Whether you require routine screening or specific tests, our experienced team ensures accurate results while maintaining your privacy and comfort.') ?>
						</p>
						<p><strong><?= __t(' Why Choose Cosmocare for Your STD Screening?') ?></strong></p>
						<ul>
							<li><strong><?= __t(' Personalized Testing Plans:') ?></strong>
								<?= __t('Each patient receives tailored testing based on their needs and risk factors.') ?>
							</li>
							<li><strong><?= __t(' Advanced Laboratory Facilities:') ?></strong>
								<?= __t('We use the latest technology to deliver reliable and fast results.') ?></li>
							<li><strong><?= __t(' Expert & Discreet Care:') ?></strong>
								<?= __t('Professional guidance with strict confidentiality for every patient.') ?></li>
							<li><strong><?= __t(' Trusted by Residents Across Dubai:') ?></strong>
								<?= __t('Conveniently located in Satwa and Jumeirah 2, providing affordable and high-quality sexual health services.') ?>
							</li>
						</ul>
