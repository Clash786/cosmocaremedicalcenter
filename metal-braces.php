...
<head>
	...
	<meta name="description" content="<?= __t('Getting your crooked teeth straightened is no longer an issue. With our cheap braces in Jumeirah 2 Dubai. Please call at 04 379 8747 (Satwa / 04 353 6164. (Jumeirah 2 Medical Center for BOOK an appointment.') ?>" />
	<meta name="keywords" content="<?= __t('metal braces in Dubai, Tooth Extraction, polishing, dental clinic in dubai, cheap dental clinic') ?>" />
	<meta name="format-detection" content="telephone=no">
	<meta name="robots" content="noodp, noydir">
	<meta name="GOOGLEBOT" content="index, follow">
	<?php include('meta.php'); ?>
	<title><?= __t(' Price Metal Braces in Jumeirah 2 Dubai Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h1><?= __t('Teeth Metal Braces in Dubai') ?></h1>
							<h4><?= __t('Never Too Late to Get the Smile You Want') ?></h4>
							<p><?= __t('Does smiling in front of people make you conscious? Do you feel bad in a room full of people? Do you also want perfect teeth and a hollywood smile? Well, no need to worry.') ?> <strong><?= __t('Metal dental braces') ?></strong> <?= __t('are the ultimate solution for your problem.') ?><br>
								<?= __t('With the help of dental braces, you will have straight teeth and a perfect smile to rock with. Metal Braces will help you achieve your ideal teeth and ideal face profile you\'ve always wanted. It will make you confident and help you achieve your goals.') ?><br>
								<?= __t('If you\'re ready to make your smile perfect, continue reading the benefits of teeth braces in') ?> <a href="https://maps.app.goo.gl/LHeAK6tK9hwqohoDA"><?= __t('Jumeirah 2, Dubai') ?></a><?= __t('. It will for sure help you towards a better you.') ?></p>
							<p> <?= __t('To schedule an appointment for Metal') ?> <a href="braces.php"><?= __t('Braces') ?> </a><?= __t('in Dubai? Please call at 04 379 8747 (') ?><a href="https://maps.app.goo.gl/EZXkURZnoFurmUwV6" target="_blank"><?= __t('Satwa Meidcal Center') ?></a><?= __t(') / 04 353 6164.') ?><a href="https://maps.app.goo.gl/q4g5dazuAMN9Q5X79" target="_blank"><?= __t('(Jumeirah 2 Medical Center)') ?></a><?= __t('for BOOK an appointment.') ?></p>
							<div class="service-img">
								<img src="images/metal-braces-cosmocare.svg" width="100%" class="img-fluid" alt="metal braces in Dubai by Cosmocare Medical Center">
							</div>
							<br>
							<br>
							<h2><?= __t('Adult Braces Price in Dubai') ?></h2>
							<p><?= __t('Braces slowly move teeth into their proper positions. This is performed by using a selection of corrective appliances, including teeth braces, ceramic braces and metal braces.') ?><br>
								<?= __t('Cosmocare Medical Center is one of the most visited dental clinic in Dubai delivering best quality dental braces at lowest price of aed499 by expert orthodontist dentists in Dubai. No Hidden Cost. Know More about braces in Dubai.') ?></p>
							<div class="service-img">
								<a href="tooth-colored-fillings.php">
							...
							<p></p>
							<p>
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.194026910072!2d55.24358817511469!3d25.196678431722262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43c07cee99eb%3A0xa189474bca806682!2s49AED%20Teeth%20Cleaning%2C%20Teeth%20Filling%2C%20Extractions%2C%20TMJ%20Treatment%20Cosmocare%20Jumeirah!5e0!3m2!1sen!2sae!4v1737725575752!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							</p>
							<p>
						</div>
					</div>
