...
<head>
	...
	<meta name="description" content="<?php include 'price.php'; echo "$cosmetic_dermatology_dubai"; ?> <?= __t('Cosmetic Dermatology in Dubai Offering advanced skin treatments, cosmetic procedures, and aesthetic solutions. For appointments, call us at ') ?><?php echo $contact; ?> <?= __t('(Satwa) / ') ?><?php echo $contactjumeirah; ?> <?= __t('(Jumeirah 2) or email') ?> <?php echo $email; ?>." />
	<meta name="keywords" content="<?php include 'price.php'; echo "$cosmetic_dermatology_dubai"; ?>, <?= __t('cosmetic-dermatology-dubai, skin care, aesthetic treatments, skin rejuvenation, pigmentation treatment') ?>" />
	<meta name="format-detection" content="telephone=no">
	<?php include('meta.php'); ?>
	<title><?php include 'price.php'; echo "$cosmetic_dermatology_dubai"; ?> <?= __t('Cosmetic Dermatology in Dubai') ?> <?php include 'price.php'; echo "$company"; ?> <?= __t('Satwa Jumeirah 2') ?></title>
	<!-- Stylesheets -->
...
<body class="shop-page">
				...
				<div class="row">
					...
					<div class="col-md-8 col-lg-9 mt-4 mt-md-0">
						<div class="title-wrap">
							<h3><?= __t('Cosmetic Dermatology in Dubai') ?></h3>
							<h1><?= __t('Reveal Your Best Skin. Enhance Your Natural Beauty.') ?></h1>
							<p><?= __t('At') ?>
								<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', our specialists provide advanced cosmetic dermatology treatments, including skin rejuvenation, pigmentation correction, and anti-aging therapies.') ?>
								<br><?= __t('Whether you\'re looking to improve skin texture, reduce dark spots, or restore youthful radiance, our team is dedicated to helping you achieve healthy and glowing skin.') ?>
							</p>
						</div>
						<div class="service-img">
							<a href="skin-specialist-doctor.php">
								<img src="images/cosmetic-dermatology-dubai.jpg"
									alt="Cosmetic Dermatology Treatments in Dubai by Cosmocare Medical Center"
									style="width:60%; max-width:800px;" border="0" class="img-fluid" />
							</a>
						</div>
						<br>
						<h1><?= __t('Expert Skin Specialist in Cosmetic Dermatology in Dubai') ?></h1>
						<p><?= __t('At') ?>
							<strong><?= __t('Cosmocare Medical Center') ?></strong><?= __t(', we offer advanced cosmetic dermatology and aesthetic skin treatments.') ?>
							<br><?= __t('Whether you\'re looking to improve skin texture, reduce dark spots, or address signs of aging, our team is dedicated to restoring your skin\'s natural glow and health.') ?>
						</p>
						<p><strong><?= __t('Why Choose Cosmocare for Cosmetic Dermatology?') ?></strong></p>
						<ul>
							...
							<li><strong><?= __t(' Expert Care:') ?></strong>
								<?= __t('Over a decade of experience in cosmetic dermatology treatments.') ?></li>
							<li><strong><?= __t(' Trusted Across Dubai:') ?></strong>
	...
	$footer_blogs = [
		...
		[
			...
			'title' => __t('Cosmetic Dermatology Treatments in Dubai...'),
			'link' => 'cosmetic-dermatology-dubai.php',
			'date' => 'July 25, 2021'
		],
	];
	$footer_nearby_areas = [
