...
<head>
	...
	<title><?= __t('Schedule - Dermatology, Laser hair Removal, Mole Removal Dental Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
		...
		<div class="section page-content-first">
			...
			<div class="container">
				...
				<div class="nav nav-pills justify-content-center" role="tablist">
					<a class="nav-link active" data-toggle="pill" href="#tab-A" role="tab" aria-expanded="true"><?= __t('Dermatology') ?></a>
					<a class="nav-link" data-toggle="pill" href="#tab-B" role="tab" aria-expanded="false"><?= __t('Piles Hernia Surgeon') ?></a>
					<a class="nav-link" data-toggle="pill" href="#tab-C" role="tab" aria-expanded="false"><?= __t('STD Specialist') ?></a>
				</div>
							...
							<div class="events">
								<ul>
									<li class="events-group">
										...
										<ul>
											<li class="doctor-card" data-start="09:00" data-end="13:30" data-event="event-1">
												<a href="dermatologist.html">
													...
													<div class="doctor-name">Dr. Murtuza Bandukwala</div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
												</a>
											</li>
											<li class="doctor-card" data-start="17:00" data-end="20:30" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-01-sm.jpg" alt="Murtuza Banduklwala Skin Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Bandukwala') ?></div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
												</a>
											</li>
										</ul>
									...
									<li class="events-group">
										...
										<ul>
											<li class="doctor-card" data-start="09:00" data-end="14:00" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-01-sm.jpg" alt="Murtuza Banduklwala Skin Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Bandukwala') ?></div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
									...
									<li class="events-group">
										...
										<ul>
											<li class="doctor-card" data-start="10:00" data-end="14:00" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-01-sm.jpg" alt="Murtuza Banduklwala Skin Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Bandukwala') ?></div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
											...
											<li class="doctor-card" data-start="16:00" data-end="19:00" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-01-sm.jpg" alt="Murtuza Banduklwala Skin Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Bandukwala') ?></div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
									...
									<li class="events-group">
										...
										<ul>
											...
											<li class="doctor-card" data-start="18:00" data-end="20:30" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-01-sm.jpg" alt="Murtuza Banduklwala Skin Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Bandukwala') ?></div>
													<div class="doctor-position"><?= __t('Derma') ?></div>
								...
								<ul>
									<li class="events-group">
										...
										<ul>
											<li class="doctor-card" data-start="09:00" data-end="13:30" data-event="event-1">
												<a href="dermatologist.html">
													<div class="doctor-photo"><img src="images/content/doctop-02-sm.jpg" alt="Murtuza Pithawala Piles Hernia Specialist in Dubai"></div>
													<div class="doctor-name"><?= __t('Dr. Murtuza Pithawala') ?></div>
													<div class="doctor-position"><?= __t('Surgeon') ?></div>
												</a>
											</li>
											<li class="doctor-card" data-start="17:00" data-end="20:30" data-event="event-1">
												<a href="dermatologist.html">
