...
<head>
	...
	<meta name="description" content="<?= __t('Experience advanced laser dermatology treatments in Dubai at Cosmocare Medical Center. Expert solutions for acne scars, pigmentation, hair removal, and skin rejuvenation. Call 04 379 8747 or email info@cosmocaremedicalcenter.com.') ?>">
	<meta name="keywords" content="<?= __t('Laser dermatology Dubai, laser skin treatment Dubai, acne scar laser treatment Dubai, pigmentation laser treatment Dubai, hair removal laser Dubai, skin rejuvenation Dubai, Cosmocare Medical Center') ?>">
	...
	<title><?= __t('Advanced Laser Dermatology Treatments in Dubai | Cosmocare Medical Center') ?></title>
	<!-- Stylesheets -->
							...
							<tr>
								...
								<td>
									<ul class="marker-list-md">
										<li><?= __t('Advanced Laser Treatments for Acne Scars, Pigmentation & Wrinkles') ?></li>
										<li><?= __t('Laser Hair Removal for Safe and Effective Results') ?></li>
										<li><?= __t('Fractional and CO‚‚ Laser Skin Rejuvenation') ?></li>
										<li><?= __t('Laser Therapy for Warts, Lesions, and Skin Imperfections') ?></li>
										<li><?= __t('Personalized Laser-Based Aesthetic and Skin Health Solutions') ?></li>
									</ul>
								</td>
							</tr>
							<tr>
					...
					<div class="col-lg-8 mt-4 mt-lg-0">
						<div class="doctor-info mb-3 mb-lg-4">
							<div class="doctor-info-name">
								...
								<h6><?= __t('Specialist in Laser Dermatology & Skin Treatments') ?></h6>
							</div>
						...
						<p><strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('is a highly experienced') ?> <strong><?= __t('Specialist in Laser Dermatology') ?></strong> <?= __t('at') ?> <strong><?= __t('Cosmocare Medical Center, Dubai') ?></strong><?= __t('. He specializes in advanced laser treatments for acne scars, pigmentation, wrinkles, hair removal, and skin rejuvenation. Using evidence-based techniques, Dr. Murtuza helps patients achieve smoother, clearer, and healthier-looking skin with precision and safety.') ?></p>
						<p><?= __t('Committed to continuous learning,') ?> <strong><?= __t('Dr. Murtuza') ?></strong> <?= __t('stays updated with the latest advancements in laser dermatology and aesthetic medicine. He believes that effective laser treatments not only improve appearance but also boost confidence and overall well-being. His expertise and compassionate approach make him one of the most trusted laser dermatologists in Dubai.') ?></p>
						<div class="mt-4 mt-lg-6"></div>
						<div class="collapse-wrap d-flex" data-toggle="collapse" data-target="#tab1">
							<h5 class="collapse-title"><?= __t('Advanced Laser Dermatology Treatments by') ?> <span class="theme-color text-nowrap"><?= __t('Dr. Murtuza Bandukwala') ?></span></h5>
						...
						<div id="tab1" class="collapse show">
							<div class="pb-4 pb-lg-6">
								<div class="row row-sm-space pt-2">
									<div class="col-sm-4"> <img src="images/content/laser-dermatology-dubai.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Laser Dermatology in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/laser-dermatology-dubai1.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Laser Dermatology in Dubai at Cosmocare Medical Center"></div>
									<div class="col-sm-4"> <img src="images/content/laser-dermatology-dubai2.jpg" class="img-fluid" alt="Dr. Murtuza Bandukwala - Specialist in Laser Dermatology in Dubai at Cosmocare Medical Center"></div>
								</div>
							</div>
						</div>
						...
						<div id="tab2" class="collapse show">
							<div class="pb-4">
								...
								<p><?= __t('When asked about his approach to laser dermatology,') ?> <strong><?= __t('Dr. Murtuza Bandukwala') ?></strong> <?= __t('said, "The most rewarding part of my work is seeing the visible improvements in my patients\' skin. Even a small enhancement from laser treatments can greatly boost their confidence and overall well-being. Helping people feel comfortable and radiant in their skin motivates me every day."') ?></p>
							</div>
						</div>
